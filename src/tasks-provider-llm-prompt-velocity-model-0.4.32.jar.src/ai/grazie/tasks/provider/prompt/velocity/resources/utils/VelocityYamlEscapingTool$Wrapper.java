...
/*   */ final class Wrapper {
/* 7 */   public Wrapper(@NotNull String content) { this.content = content; } @NotNull private final String content; @NotNull public final String getContent() { return this.content; }
/*   */ 
/*   */   
/*   */   @NotNull
...
/*   */   
/*   */   @NotNull
/*   */   public final Wrapper copy(@NotNull String content) {
...
/*   */     return "Wrapper(content=" + this.content + ")";
/*   */   }
/*   */   
/*   */   public int hashCode() {
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\tasks-provider-llm-prompt-velocity-model-0.4.32.jar!\ai\grazie\tasks\provider\prompt\velocity\resource\\utils\VelocityYamlEscapingTool$Wrapper.class
