...
/* 155 */   } @NotNull public static final JsonObjectSerializer INSTANCE = new JsonObjectSerializer(); @NotNull private static final SerialDescriptor descriptor = JsonObjectDescriptor.INSTANCE; @NotNull public SerialDescriptor getDescriptor() { return descriptor; }
/*     */   
/*     */   public void serialize(@NotNull Encoder encoder, @NotNull JsonObject value) {
/* 158 */     Intrinsics.checkNotNullParameter(encoder, "encoder"); Intrinsics.checkNotNullParameter(value, "value"); JsonElementSerializersKt.access$verify(encoder);
/* 159 */     BuiltinSerializersKt.MapSerializer(BuiltinSerializersKt.serializer(StringCompanionObject.INSTANCE), JsonElementSerializer.INSTANCE).serialize(encoder, value);
/*     */   }
/*     */   @NotNull
/*     */   public JsonObject deserialize(@NotNull Decoder decoder) {
/* 163 */     Intrinsics.checkNotNullParameter(decoder, "decoder"); JsonElementSerializersKt.access$verify(decoder);
/* 164 */     return new JsonObject((Map<String, ? extends JsonElement>)BuiltinSerializersKt.MapSerializer(BuiltinSerializersKt.serializer(StringCompanionObject.INSTANCE), JsonElementSerializer.INSTANCE).deserialize(decoder));
/*     */   }
/*     */ }


/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\kotlinx-serialization-json-jvm-1.8.0.jar!\kotlinx\serialization\json\JsonObjectSerializer.class
