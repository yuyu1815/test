...
/*    */ 
/*    */       
/* 81 */       Map<Object, Object> grouped = destination$iv$iv; return of((Map)grouped); } @NotNull public final TasksRoster of(@NotNull TaskID... tasks) { Intrinsics.checkNotNullParameter(tasks, "tasks"); return of(ArraysKt.toSet((Object[])tasks)); }
/* 82 */     @NotNull public final TasksRoster of(@NotNull Map tasks) { Intrinsics.checkNotNullParameter(tasks, "tasks"); Map $this$flatMap$iv = tasks; int $i$f$flatMap = 0; Map map1 = $this$flatMap$iv; Collection destination$iv$iv = new ArrayList(); int $i$f$flatMapTo = 0;
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\model-task-jvm-0.4.32.jar!\ai\grazie\model\task\roster\TasksRoster.class
