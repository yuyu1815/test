...
public final class null<T> implements FlowCollector {
  ...
  public final Object emit(Object value, @NotNull Continuation $completion) {
    // Byte code:
    //   0: aload_2
    //   1: instanceof ai/grazie/model/task/SuspendableTasksService$execute$suspendImpl$$inlined$map$1$2$1
    //   4: ifeq -> 36
    //   7: aload_2
    //   8: checkcast ai/grazie/model/task/SuspendableTasksService$execute$suspendImpl$$inlined$map$1$2$1
    //   11: astore_3
    //   12: aload_3
    //   13: getfield label : I
    //   16: ldc -2147483648
    ...
    //   30: putfield label : I
    //   33: goto -> 46
    //   36: new ai/grazie/model/task/SuspendableTasksService$execute$suspendImpl$$inlined$map$1$2$1
    //   39: dup
    //   40: aload_0
    //   41: aload_2
    //   42: invokespecial <init> : (Lai/grazie/model/task/SuspendableTasksService$execute$suspendImpl$$inlined$map$1$2;Lkotlin/coroutines/Continuation;)V
    //   45: astore_3
    //   46: aload_3
    ...
    //   111: pop
    //   112: checkcast ai/grazie/model/task/data/v3/TaskStreamData
    //   115: astore #10
    //   117: iconst_0
    //   118: istore #11
    //   120: aload #10
    //   122: invokestatic toTaskStreamData : (Lai/grazie/model/task/data/v3/TaskStreamData;)Lai/grazie/model/task/data/TaskStreamData;
    //   125: aload #9
    //   127: swap
    //   128: aload_3
    //   129: aload_3
    ...
    //   89	9	0	this	Lai/grazie/model/task/SuspendableTasksService$execute$suspendImpl$$inlined$map$1$2;
    ...
    //   117	8	10	it	Lai/grazie/model/task/data/v3/TaskStreamData;
    //   120	5	11	$i$a$-map-SuspendableTasksService$execute$3	I
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\model-task-jvm-0.4.32.jar!\ai\grazie\model\task\SuspendableTasksService$execute$suspendImpl$$inlined$map$1$2.class
