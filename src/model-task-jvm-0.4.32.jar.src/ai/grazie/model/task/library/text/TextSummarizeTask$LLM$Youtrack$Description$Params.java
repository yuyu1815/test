...
/*     */     
/*     */     @NotNull
/*     */     public final KSerializer<TextSummarizeTask.LLM.Youtrack.Description.Params> serializer() {
/* 140 */       return (KSerializer<TextSummarizeTask.LLM.Youtrack.Description.Params>)TaskParameters.Serializer.INSTANCE;
/*     */     }
/* 142 */   } @NotNull public final String getContent() { return this.content; } @NotNull public final String getType() { return this.type; } public Params(@NotNull String content, @NotNull String type, @NotNull String lang) { this.content = content; this.type = type; this.lang = lang;
/* 143 */     this.attributes = Attributes.Companion.build(new TextSummarizeTask$LLM$Youtrack$Description$Params$attributes$1()); } @NotNull public final String getLang() { return this.lang; } @NotNull public Attributes getAttributes() { return this.attributes; } @Metadata(mv = {1, 7, 0}, k = 3, xi = 48, d1 = {"\000\f\n\000\n\002\020\002\n\002\030\002\n\000\020\000\032\0020\001*\0020\002H\n¢\006\002\b\003"}, d2 = {"<anonymous>", "", "Lai/grazie/utils/attributes/AttributesBuilder;", "invoke"})
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\model-task-jvm-0.4.32.jar!\ai\grazie\model\task\library\text\TextSummarizeTask$LLM$Youtrack$Description$Params.class
