...
/*     */ final class TextSummarizeTask$LLM$Youtrack$Article$Params$attributes$1
/*     */   extends Lambda
/*     */   implements Function1<AttributesBuilder, Unit>
/*     */ {
/*     */   public final void invoke(AttributesBuilder $this$build) {
/* 166 */     Intrinsics.checkNotNullParameter($this$build, "$this$build"); $this$build.text("content", TextSummarizeTask.LLM.Youtrack.Article.Params.this.getContent());
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\model-task-jvm-0.4.32.jar!\ai\grazie\model\task\library\text\TextSummarizeTask$LLM$Youtrack$Article$Params$attributes$1.class
