...
/*    */     
/*    */     @NotNull
/*    */     public final KSerializer<TextTranslateTask.LLM.Youtrack.Params> serializer() {
/* 93 */       return (KSerializer<TextTranslateTask.LLM.Youtrack.Params>)TaskParameters.Serializer.INSTANCE;
/*    */     } } @NotNull
/* 95 */   public final String getText() { return this.text; } public Params(@NotNull String text, @NotNull String lang) { this.text = text; this.lang = lang;
/* 96 */     this.attributes = Attributes.Companion.build(new TextTranslateTask$LLM$Youtrack$Params$attributes$1()); } @NotNull public Attributes getAttributes() { return this.attributes; } @NotNull public final String getLang() { return this.lang; } @Metadata(mv = {1, 7, 0}, k = 3, xi = 48, d1 = {"\000\f\n\000\n\002\020\002\n\002\030\002\n\000\020\000\032\0020\001*\0020\002H\n¢\006\002\b\003"}, d2 = {"<anonymous>", "", "Lai/grazie/utils/attributes/AttributesBuilder;", "invoke"}) static final class TextTranslateTask$LLM$Youtrack$Params$attributes$1 extends Lambda implements Function1<AttributesBuilder, Unit> {
/* 97 */     public final void invoke(AttributesBuilder $this$build) { Intrinsics.checkNotNullParameter($this$build, "$this$build"); $this$build.text("text", TextTranslateTask.LLM.Youtrack.Params.this.getText());
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\model-task-jvm-0.4.32.jar!\ai\grazie\model\task\library\text\TextTranslateTask$LLM$Youtrack$Params.class
