...
/*    */     
/*    */     @NotNull
/*    */     public final KSerializer<TextWriteTask.LLM.Youtrack.Comment.Params> serializer() {
/* 74 */       return (KSerializer<TextWriteTask.LLM.Youtrack.Comment.Params>)TaskParameters.Serializer.INSTANCE;
/*    */     }
/* 76 */   } public Params(@NotNull String text) { this.text = text;
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\model-task-jvm-0.4.32.jar!\ai\grazie\model\task\library\text\TextWriteTask$LLM$Youtrack$Comment$Params.class
