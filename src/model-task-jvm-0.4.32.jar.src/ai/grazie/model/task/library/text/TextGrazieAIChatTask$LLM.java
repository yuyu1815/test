...
/*    */ 
/*    */ @Metadata(mv = {1, 7, 0}, k = 1, xi = 48, d1 = {"\000\f\n\002\030\002\n\002\020\000\n\002\b\003\bÆ\002\030\0002\0020\001:\001\003B\007\b\002¢\006\002\020\002¨\006\004"}, d2 = {"Lai/grazie/model/task/library/text/TextGrazieAIChatTask$LLM;", "", "()V", "Basic", "model-task"})
/*    */ public final class LLM {
/*    */   @NotNull
/*    */   public static final LLM INSTANCE = new LLM();
/*    */   
/*    */   @Metadata(mv = {1, 7, 0}, k = 1, xi = 48, d1 = {"\000\024\n\002\030\002\n\002\030\002\n\002\b\002\n\002\030\002\n\002\b\005\bÆ\002\030\0002\0020\001:\002\007\bB\007\b\002¢\006\002\020\002R\024\020\003\032\0020\004X\004¢\006\b\n\000\032\004\b\005\020\006¨\006\t"}, d2 = {"Lai/grazie/model/task/library/text/TextGrazieAIChatTask$LLM$Basic;", "Lai/grazie/model/task/id/TaskTagDescriptor$Stable;", "()V", "tag", "Lai/grazie/model/task/id/TaskTag;", "getTag", "()Lai/grazie/model/task/id/TaskTag;", "Params", "Schema", "model-task"})
/*    */   public static final class Basic implements TaskTagDescriptor.Stable {
/*    */     @NotNull
/* 32 */     public static final Basic INSTANCE = new Basic(); @NotNull private static final TaskTag tag = new TaskTag("llm-basic"); @NotNull public TaskTag getTag() { return tag; }
...
/* 42 */         public final KSerializer<TextGrazieAIChatTask.LLM.Basic.Params> serializer() { return (KSerializer<TextGrazieAIChatTask.LLM.Basic.Params>)TaskParameters.Serializer.INSTANCE; }
/*    */          private Companion() {} } public Params(@NotNull String userPrompt, @Nullable LLMChat history) {
/* 44 */         this.userPrompt = userPrompt; this.history = history;
/* 45 */         this.attributes = Attributes.Companion.build(new TextGrazieAIChatTask$LLM$Basic$Params$attributes$1()); } @NotNull public final String getUserPrompt() { return this.userPrompt; } @Nullable public final LLMChat getHistory() { return this.history; } @NotNull public Attributes getAttributes() { return this.attributes; } @Metadata(mv = {1, 7, 0}, k = 3, xi = 48, d1 = {"\000\f\n\000\n\002\020\002\n\002\030\002\n\000\020\000\032\0020\001*\0020\002H\n¢\006\002\b\003"}, d2 = {"<anonymous>", "", "Lai/grazie/utils/attributes/AttributesBuilder;", "invoke"})
/* 46 */       static final class TextGrazieAIChatTask$LLM$Basic$Params$attributes$1 extends Lambda implements Function1<AttributesBuilder, Unit> { public final void invoke(AttributesBuilder $this$build) { Intrinsics.checkNotNullParameter($this$build, "$this$build"); $this$build.text("userPrompt", TextGrazieAIChatTask.LLM.Basic.Params.this.getUserPrompt());
/*    */           
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\model-task-jvm-0.4.32.jar!\ai\grazie\model\task\library\text\TextGrazieAIChatTask$LLM.class
