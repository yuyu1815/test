...
/*    */ final class TextTranslateTask$LLM$Basic$Params$attributes$1
/*    */   extends Lambda
/*    */   implements Function1<AttributesBuilder, Unit>
/*    */ {
/*    */   public final void invoke(AttributesBuilder $this$build) {
/* 53 */     Intrinsics.checkNotNullParameter($this$build, "$this$build"); $this$build.text("text", TextTranslateTask.LLM.Basic.Params.this.getText());
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\model-task-jvm-0.4.32.jar!\ai\grazie\model\task\library\text\TextTranslateTask$LLM$Basic$Params$attributes$1.class
