...
/* 43 */   private static final AttributeDescriptor.Text snippet = new AttributeDescriptor.Text("snippet"); @NotNull public final AttributeDescriptor.Text getSnippet() { return snippet; } @NotNull
/*    */   private static final List<AttributeDescriptor.Text> all; @NotNull
/*    */   public List<AttributeDescriptor.Text> getAll() {
/* 46 */     return all; } static { AttributeDescriptor.Text[] arrayOfText = new AttributeDescriptor.Text[3]; arrayOfText[0] = sourceLang; arrayOfText[1] = targetLang; arrayOfText[2] = snippet; all = CollectionsKt.listOf((Object[])arrayOfText); }
/*    */ 
/*    */ }


/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\model-task-jvm-0.4.32.jar!\ai\grazie\model\task\library\code\CodeConvertSnippetLangTask$LLM$IJ$Slow$Schema.class
