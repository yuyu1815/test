...
/* 43 */   private static final AttributeDescriptor.Text file = new AttributeDescriptor.Text("file"); @NotNull public final AttributeDescriptor.Text getFile() { return file; } @NotNull
/*    */   private static final List<AttributeDescriptor.Text> all; @NotNull
/*    */   public List<AttributeDescriptor.Text> getAll() {
/* 46 */     return all; } static { AttributeDescriptor.Text[] arrayOfText = new AttributeDescriptor.Text[3]; arrayOfText[0] = sourceLang; arrayOfText[1] = targetLang; arrayOfText[2] = file; all = CollectionsKt.listOf((Object[])arrayOfText); }
/*    */ 
/*    */ }


/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\model-task-jvm-0.4.32.jar!\ai\grazie\model\task\library\code\CodeConvertFileLangTask$LLM$IJ$Slow$Schema.class
