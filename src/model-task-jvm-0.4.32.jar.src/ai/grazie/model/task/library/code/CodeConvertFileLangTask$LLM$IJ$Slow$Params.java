...
/*    */     
/*    */     @NotNull
/*    */     public final KSerializer<CodeConvertFileLangTask.LLM.IJ.Slow.Params> serializer() {
/* 49 */       return (KSerializer<CodeConvertFileLangTask.LLM.IJ.Slow.Params>)TaskParameters.Serializer.INSTANCE;
/*    */     }
/* 51 */   } @NotNull public final String getSourceLang() { return this.sourceLang; } @NotNull public final String getTargetLang() { return this.targetLang; } public Params(@NotNull String sourceLang, @NotNull String targetLang, @NotNull String file) { this.sourceLang = sourceLang; this.targetLang = targetLang; this.file = file;
/* 52 */     this.attributes = Attributes.Companion.build(new CodeConvertFileLangTask$LLM$IJ$Slow$Params$attributes$1()); } @NotNull public final String getFile() { return this.file; } @NotNull public Attributes getAttributes() { return this.attributes; } @Metadata(mv = {1, 7, 0}, k = 3, xi = 48, d1 = {"\000\f\n\000\n\002\020\002\n\002\030\002\n\000\020\000\032\0020\001*\0020\002H\n¢\006\002\b\003"}, d2 = {"<anonymous>", "", "Lai/grazie/utils/attributes/AttributesBuilder;", "invoke"})
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\model-task-jvm-0.4.32.jar!\ai\grazie\model\task\library\code\CodeConvertFileLangTask$LLM$IJ$Slow$Params.class
