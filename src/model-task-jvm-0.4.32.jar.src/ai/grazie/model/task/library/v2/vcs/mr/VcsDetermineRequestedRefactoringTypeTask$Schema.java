...
/* 26 */   private static final AttributeDescriptor.Text codeFragment = new AttributeDescriptor.Text("codeFragment"); @NotNull public final AttributeDescriptor.Text getCodeFragment() { return codeFragment; } @NotNull
/*    */   private static final List<AttributeDescriptor.Text> all; @NotNull
/*    */   public List<AttributeDescriptor.Text> getAll() {
/* 29 */     return all; } static { AttributeDescriptor.Text[] arrayOfText = new AttributeDescriptor.Text[2]; arrayOfText[0] = comment; arrayOfText[1] = codeFragment; all = CollectionsKt.listOf((Object[])arrayOfText); }
/*    */ 
/*    */ }


/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\model-task-jvm-0.4.32.jar!\ai\grazie\model\task\library\v2\vcs\mr\VcsDetermineRequestedRefactoringTypeTask$Schema.class
