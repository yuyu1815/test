...
/*    */ 
/*    */ @Metadata(mv = {1, 7, 0}, k = 1, xi = 48, d1 = {"\000\"\n\002\030\002\n\002\030\002\n\002\b\002\n\002\030\002\n\002\b\003\n\002\030\002\n\000\n\002\020\016\n\002\b\005\bÇ\002\030\0002\0020\001:\001\016B\007\b\002¢\006\002\020\002J*\020\007\032\0020\b2\006\020\t\032\0020\n2\006\020\013\032\0020\n2\006\020\f\032\0020\n2\n\b\002\020\r\032\004\030\0010\nR\024\020\003\032\0020\004X\004¢\006\b\n\000\032\004\b\005\020\006¨\006\017"}, d2 = {"Lai/grazie/model/task/library/v2/code/CodeExplainTask;", "Lai/grazie/model/task/id/TaskNameDescriptor;", "()V", "name", "Lai/grazie/model/task/id/TaskName;", "getName", "()Lai/grazie/model/task/id/TaskName;", "default", "Lai/grazie/model/task/exec/TaskCall;", "selection", "", "prefix", "suffix", "language", "Schema", "model-task"})
/*    */ public final class CodeExplainTask implements TaskNameDescriptor {
/*    */   @NotNull
/* 12 */   public static final CodeExplainTask INSTANCE = new CodeExplainTask(); @NotNull private static final TaskName name = new TaskName("code-explain"); @NotNull public TaskName getName() { return name; }
/*    */ 
/*    */ 
/*    */ 
/*    */ 
...
/* 29 */     Intrinsics.checkNotNullParameter(selection, "selection"); Intrinsics.checkNotNullParameter(prefix, "prefix"); Intrinsics.checkNotNullParameter(suffix, "suffix"); return new TaskCall(getName().tag(Default.INSTANCE.getTag()), TaskParameters.Companion.build(new CodeExplainTask$default$1(selection, prefix, suffix, language))); } @Metadata(mv = {1, 7, 0}, k = 3, xi = 48, d1 = {"\000\f\n\000\n\002\020\002\n\002\030\002\n\000\020\000\032\0020\001*\0020\002H\n¢\006\002\b\003"}, d2 = {"<anonymous>", "", "Lai/grazie/model/task/exec/TaskParametersBuilder;", "invoke"})
/* 30 */   static final class CodeExplainTask$default$1 extends Lambda implements Function1<TaskParametersBuilder, Unit> { public final void invoke(TaskParametersBuilder $this$build) { Intrinsics.checkNotNullParameter($this$build, "$this$build"); $this$build.add((AttributeDescriptor)CodeExplainTask.Schema.INSTANCE.getSelection(), this.$selection);
/* 31 */       $this$build.add((AttributeDescriptor)CodeExplainTask.Schema.INSTANCE.getPrefix(), this.$prefix);
/* 32 */       $this$build.add((AttributeDescriptor)CodeExplainTask.Schema.INSTANCE.getSuffix(), this.$suffix);
/* 33 */       $this$build.add((AttributeDescriptor)CodeExplainTask.Schema.INSTANCE.getLanguage(), this.$language); }
/*    */      CodeExplainTask$default$1(String $selection, String $prefix, String $suffix, String $language) {
/*    */       super(1);
/*    */     } }
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\model-task-jvm-0.4.32.jar!\ai\grazie\model\task\library\v2\code\CodeExplainTask.class
