...
/* 28 */   private static final AttributeDescriptor.Text fileText = new AttributeDescriptor.Text("fileText"); @NotNull public final AttributeDescriptor.Text getFileText() { return fileText; } @NotNull
/*    */   private static final List<AttributeDescriptor.Text> all; @NotNull
/*    */   public List<AttributeDescriptor.Text> getAll() {
/* 31 */     return all; } static { AttributeDescriptor.Text[] arrayOfText = new AttributeDescriptor.Text[3]; arrayOfText[0] = comment; arrayOfText[1] = codeFragment; arrayOfText[2] = fileText; all = CollectionsKt.listOf((Object[])arrayOfText); }
/*    */ 
/*    */ }


/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\model-task-jvm-0.4.32.jar!\ai\grazie\model\task\library\v2\vcs\mr\VcsLocalRefactoringTask$Schema.class
