...
/*    */   implements GeneratedSerializer<TasksChatTaskMessage>
/*    */ {
/*    */   @NotNull
/* 88 */   public static final $serializer INSTANCE = new $serializer(); @NotNull public KSerializer<?>[] typeParametersSerializers() { return (KSerializer<?>[])GeneratedSerializer.DefaultImpls.typeParametersSerializers(this); } @NotNull public SerialDescriptor getDescriptor() { return (SerialDescriptor)descriptor; } @NotNull public KSerializer<?>[] childSerializers() { KSerializer[] arrayOfKSerializer1 = TasksChatTaskMessage.access$get$childSerializers$cp(), arrayOfKSerializer2 = new KSerializer[3]; arrayOfKSerializer2[0] = (KSerializer)TaskID.Serializer.INSTANCE; arrayOfKSerializer2[1] = (KSerializer)TaskParameters.Serializer.INSTANCE; arrayOfKSerializer2[2] = arrayOfKSerializer1[2]; return (KSerializer<?>[])arrayOfKSerializer2; } @NotNull public TasksChatTaskMessage deserialize(@NotNull Decoder decoder) { Intrinsics.checkNotNullParameter(decoder, "decoder"); SerialDescriptor serialDescriptor = getDescriptor(); boolean bool = true; int i = 0; TaskID taskID = null; TaskParameters taskParameters = null; TasksChatRole tasksChatRole = null; CompositeDecoder compositeDecoder = decoder.beginStructure(serialDescriptor); KSerializer[] arrayOfKSerializer = TasksChatTaskMessage.access$get$childSerializers$cp(); if (compositeDecoder.decodeSequentially()) { taskID = (TaskID)compositeDecoder.decodeSerializableElement(serialDescriptor, 0, (DeserializationStrategy)TaskID.Serializer.INSTANCE, taskID); i |= 0x1; taskParameters = (TaskParameters)compositeDecoder.decodeSerializableElement(serialDescriptor, 1, (DeserializationStrategy)TaskParameters.Serializer.INSTANCE, taskParameters); i |= 0x2; tasksChatRole = (TasksChatRole)compositeDecoder.decodeSerializableElement(serialDescriptor, 2, (DeserializationStrategy)arrayOfKSerializer[2], tasksChatRole); i |= 0x4; } else { while (bool) { int j = compositeDecoder.decodeElementIndex(serialDescriptor); switch (j) { case -1: bool = false; continue;case 0: taskID = (TaskID)compositeDecoder.decodeSerializableElement(serialDescriptor, 0, (DeserializationStrategy)TaskID.Serializer.INSTANCE, taskID); i |= 0x1; continue;case 1: taskParameters = (TaskParameters)compositeDecoder.decodeSerializableElement(serialDescriptor, 1, (DeserializationStrategy)TaskParameters.Serializer.INSTANCE, taskParameters); i |= 0x2; continue;case 2: tasksChatRole = (TasksChatRole)compositeDecoder.decodeSerializableElement(serialDescriptor, 2, (DeserializationStrategy)arrayOfKSerializer[2], tasksChatRole); i |= 0x4; continue; }  throw new UnknownFieldException(j); }  }  compositeDecoder.endStructure(serialDescriptor); return new TasksChatTaskMessage(i, taskID, taskParameters, tasksChatRole, null); } public void serialize(@NotNull Encoder encoder, @NotNull TasksChatTaskMessage value) { Intrinsics.checkNotNullParameter(encoder, "encoder"); Intrinsics.checkNotNullParameter(value, "value"); SerialDescriptor serialDescriptor = getDescriptor(); CompositeEncoder compositeEncoder = encoder.beginStructure(serialDescriptor); TasksChatTaskMessage.write$Self$model_task(value, compositeEncoder, serialDescriptor); compositeEncoder.endStructure(serialDescriptor); } static { PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("task_message", INSTANCE, 3); pluginGeneratedSerialDescriptor.addElement("id", false); pluginGeneratedSerialDescriptor.addElement("parameters", false); pluginGeneratedSerialDescriptor.addElement("role", true); descriptor = pluginGeneratedSerialDescriptor; }
/*    */ 
/*    */ }


/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\model-task-jvm-0.4.32.jar!\ai\grazie\model\task\library\v2\chat\TasksChatTaskMessage$$serializer.class
