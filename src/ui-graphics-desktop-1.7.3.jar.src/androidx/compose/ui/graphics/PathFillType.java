...
/*    */     {
/* 51 */       return PathFillType.EvenOdd; } } @NotNull public static final Companion Companion = new Companion(null); private final int value; private static final int NonZero = constructor-impl(0); private static final int EvenOdd = constructor-impl(1);
/*    */   public boolean equals(Object other) { return equals-impl(this.value, other); }
/*    */   public static boolean equals-impl(int arg0, Object other) { if (!(other instanceof PathFillType))
/* 54 */       return false;  int i = ((PathFillType)other).unbox-impl(); return !(arg0 != i); } @NotNull public String toString() { return toString-impl(this.value); } public int hashCode() { return hashCode-impl(this.value); } public static int hashCode-impl(int arg0) { return Integer.hashCode(arg0); } @NotNull public static String toString-impl(int arg0) { int i = arg0;
/* 55 */     return equals-impl0(i, NonZero) ? "NonZero" : (
/* 56 */       equals-impl0(i, EvenOdd) ? "EvenOdd" : 
/* 57 */       "Unknown"); }
/*    */ 
/*    */ }


/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\li\\ui-graphics-desktop-1.7.3.jar!\androidx\compos\\ui\graphics\PathFillType.class
