...
/*     */ final class ComposableSingletons$BuildStepKt$lambda-1$1
...
/*  40 */     Intrinsics.checkNotNullParameter($this$StepCard, "$this$StepCard"); if (($changed & 0x11) != 16 || !$composer.getSkipping()) { if (ComposerKt.isTraceInProgress()) ComposerKt.traceEventStart(-1224048346, $changed, -1, "com.intellij.ml.llm.matterhorn.ej.ui.tasks.ComposableSingletons$BuildStepKt.lambda-1.<anonymous> (BuildStep.kt:39)"); 
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\standalone.jar!\com\intellij\ml\llm\matterhorn\e\\ui\tasks\ComposableSingletons$BuildStepKt$lambda-1$1.class
