...
/*     */ final class LicenseDialogKt$LicenseDialog$2$2
/*     */   implements Function2<Composer, Integer, Unit>
/*     */ {
/*     */   @Composable
/*     */   @ComposableTarget(applier = "androidx.compose.ui.UiComposable")
/*     */   public final void invoke(Composer $composer, int $changed) {
/* 191 */     if (($changed & 0x3) != 2 || !$composer.getSkipping()) { if (ComposerKt.isTraceInProgress()) ComposerKt.traceEventStart(-1325658188, $changed, -1, "com.intellij.ml.llm.matterhorn.ej.ui.components.LicenseDialog.<anonymous>.<anonymous> (LicenseDialog.kt:190)"); 
/* 192 */       int $this$dp$iv = 4, $i$f$getDp = 0; Arrangement.Vertical vertical = (Arrangement.Vertical)Arrangement.INSTANCE.spacedBy-0680j_4(
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */           
/* 221 */           Dp.constructor-impl($this$dp$iv)); LicenseData licenseData = this.$info; String str1 = this.$textString; int $changed$iv = 48, $i$f$Column = 0;
...
/* 258 */       ComposerKt.sourceInformationMarkerStart($composer$iv, -384784025, "C88@4444L9:Column.kt#2w3rfo"); int j = 0x6 | 0x70 & $changed$iv >> 6; Composer composer1 = $composer$iv; ColumnScope $this$invoke_u24lambda_u242 = (ColumnScope)ColumnScopeInstance.INSTANCE; int $i$a$-Column-LicenseDialogKt$LicenseDialog$2$2$1 = 0; String str2 = licenseData.getLicensedTo(); composer1.startReplaceGroup(-1186306253); if (str2 == null) {  }
/* 259 */       else { String it; int $i$a$-let-LicenseDialogKt$LicenseDialog$2$2$1$1 = 0; TextKt.Text-bAzTDeA(it, null, 0L, 0L, null, null, null, 0L, null, 0, 0L, 0, false, 0, null, null, composer1, 0, 0, 65534); }  composer1.endReplaceGroup(); str2 = licenseData.getAccountEmail(); composer1.startReplaceGroup(-1186304802); if (str2 == null) {  } else { String it; int $i$a$-let-LicenseDialogKt$LicenseDialog$2$2$1$2 = 0; TextKt.Text-bAzTDeA(it, null, MatterhornThemeDataKt.getMatterhornTheme(composer1, 0).getInactiveTextColor(composer1, 0), 0L, null, null, null, 0L, null, 0, 0L, 0, false, 0, null, null, composer1, 0, 0, 65530); }
/* 260 */        composer1.endReplaceGroup(); TextKt.Text-bAzTDeA(str1, null, MatterhornThemeDataKt.getMatterhornTheme(composer1, 0).getInactiveTextColor(composer1, 0), 0L, null, null, null, 0L, null, 0, 0L, 0, false, 0, null, null, composer1, 0, 0, 65530); ComposerKt.sourceInformationMarkerEnd($composer$iv); $composer.endNode(); ComposerKt.sourceInformationMarkerEnd($composer);
/* 261 */       ComposerKt.sourceInformationMarkerEnd($composer);
/* 262 */       ComposerKt.sourceInformationMarkerEnd($composer);
/* 263 */       if (ComposerKt.isTraceInProgress()) ComposerKt.traceEventEnd();  }
/*     */     else
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\standalone.jar!\com\intellij\ml\llm\matterhorn\e\\ui\components\LicenseDialogKt$LicenseDialog$2$2.class
