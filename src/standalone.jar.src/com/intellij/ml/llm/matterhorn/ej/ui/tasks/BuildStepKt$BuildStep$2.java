...
/*    */ final class BuildStepKt$BuildStep$2
...
/* 34 */     Intrinsics.checkNotNullParameter($this$StepCard, "$this$StepCard"); if (($changed & 0x11) != 16 || !$composer.getSkipping()) { if (ComposerKt.isTraceInProgress()) ComposerKt.traceEventStart(630820820, $changed, -1, "com.intellij.ml.llm.matterhorn.ej.ui.tasks.BuildStep.<anonymous> (BuildStep.kt:33)"); 
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\standalone.jar!\com\intellij\ml\llm\matterhorn\e\\ui\tasks\BuildStepKt$BuildStep$2.class
