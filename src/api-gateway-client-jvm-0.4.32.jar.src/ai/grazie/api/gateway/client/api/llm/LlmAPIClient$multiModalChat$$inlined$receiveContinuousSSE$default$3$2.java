...
public final class null<T> implements FlowCollector {
  ...
  public final Object emit(Object value, @NotNull Continuation $completion) {
    // Byte code:
    //   0: aload_2
    //   1: instanceof ai/grazie/api/gateway/client/api/llm/LlmAPIClient$multiModalChat$$inlined$receiveContinuousSSE$default$3$2$1
    //   4: ifeq -> 36
    //   7: aload_2
    //   8: checkcast ai/grazie/api/gateway/client/api/llm/LlmAPIClient$multiModalChat$$inlined$receiveContinuousSSE$default$3$2$1
    //   11: astore_3
    //   12: aload_3
    //   13: getfield label : I
    //   16: ldc -2147483648
    ...
    //   30: putfield label : I
    //   33: goto -> 46
    //   36: new ai/grazie/api/gateway/client/api/llm/LlmAPIClient$multiModalChat$$inlined$receiveContinuousSSE$default$3$2$1
    //   39: dup
    //   40: aload_0
    //   41: aload_2
    //   42: invokespecial <init> : (Lai/grazie/api/gateway/client/api/llm/LlmAPIClient$multiModalChat$$inlined$receiveContinuousSSE$default$3$2;Lkotlin/coroutines/Continuation;)V
    //   45: astore_3
    //   46: aload_3
    ...
    //   152: dup
    //   153: ldc 'null cannot be cast to non-null type ai.grazie.api.gateway.api.llm.LlmAPI.MultiModalChat.V1.LLMData'
    //   155: invokespecial <init> : (Ljava/lang/String;)V
    //   158: athrow
    //   159: checkcast ai/grazie/api/gateway/api/llm/LlmAPI$MultiModalChat$V1$LLMData
    ...
    //   89	39	0	this	Lai/grazie/api/gateway/client/api/llm/LlmAPIClient$multiModalChat$$inlined$receiveContinuousSSE$default$3$2;
    ...
    //   120	315	11	$i$f$receiveContinuousSSE$handle	I
    //   123	312	12	$i$a$-map-SuspendableClientExtensionsKt$receiveContinuousSSE$4	I
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\api-gateway-client-jvm-0.4.32.jar!\ai\grazie\api\gateway\client\api\llm\LlmAPIClient$multiModalChat$$inlined$receiveContinuousSSE$default$3$2.class
