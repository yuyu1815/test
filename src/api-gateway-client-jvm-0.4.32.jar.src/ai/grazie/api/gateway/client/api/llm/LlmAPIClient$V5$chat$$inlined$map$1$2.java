...
public final class null<T> implements FlowCollector {
  ...
  public final Object emit(Object value, @NotNull Continuation $completion) {
    // Byte code:
    //   0: aload_2
    //   1: instanceof ai/grazie/api/gateway/client/api/llm/LlmAPIClient$V5$chat$$inlined$map$1$2$1
    //   4: ifeq -> 36
    //   7: aload_2
    //   8: checkcast ai/grazie/api/gateway/client/api/llm/LlmAPIClient$V5$chat$$inlined$map$1$2$1
    //   11: astore_3
    //   12: aload_3
    //   13: getfield label : I
    //   16: ldc -2147483648
    ...
    //   30: putfield label : I
    //   33: goto -> 46
    //   36: new ai/grazie/api/gateway/client/api/llm/LlmAPIClient$V5$chat$$inlined$map$1$2$1
    //   39: dup
    //   40: aload_0
    //   41: aload_2
    //   42: invokespecial <init> : (Lai/grazie/api/gateway/client/api/llm/LlmAPIClient$V5$chat$$inlined$map$1$2;Lkotlin/coroutines/Continuation;)V
    //   45: astore_3
    //   46: aload_3
    ...
    //   57: aload_3
    //   58: getfield label : I
    //   61: tableswitch default -> 247, 0 -> 84, 1 -> 232
    //   84: aload #4
    ...
    //   111: pop
    //   112: checkcast ai/grazie/api/gateway/api/llm/LlmAPI$Chat$Stream$V5$LLMData
    //   115: astore #10
    //   117: iconst_0
    //   118: istore #11
    //   120: aload #10
    //   122: astore #12
    //   124: aload #12
    //   126: instanceof ai/grazie/api/gateway/api/llm/LlmAPI$Chat$Stream$V5$LLMData$Content
    //   129: ifeq -> 158
    ...
    //   141: aload #10
    //   143: checkcast ai/grazie/api/gateway/api/llm/LlmAPI$Chat$Stream$V5$LLMData$Content
    ...
    //   155: goto -> 208
    //   158: aload #12
    //   160: instanceof ai/grazie/api/gateway/api/llm/LlmAPI$Chat$Stream$V5$LLMData$FunctionCall
    //   163: ifeq -> 200
    //   166: new ai/grazie/model/llm/data/stream/LLMStreamFunctionCall
    //   169: dup
    //   170: aload #10
    //   172: checkcast ai/grazie/api/gateway/api/llm/LlmAPI$Chat$Stream$V5$LLMData$FunctionCall
    //   175: invokevirtual getName : ()Ljava/lang/String;
    //   178: aload #10
    //   180: invokevirtual getContent : ()Ljava/lang/String;
    //   183: aload #10
    //   185: checkcast ai/grazie/api/gateway/api/llm/LlmAPI$Chat$Stream$V5$LLMData$FunctionCall
    ...
    //   197: goto -> 208
    //   200: new kotlin/NoWhenBranchMatchedException
    //   203: dup
    ...
    //   218: invokeinterface emit : (Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    //   223: dup
    //   224: aload #5
    //   226: if_acmpne -> 242
    //   229: aload #5
    ...
    //   89	9	0	this	Lai/grazie/api/gateway/client/api/llm/LlmAPIClient$V5$chat$$inlined$map$1$2;
    ...
    //   117	41	10	it	Lai/grazie/api/gateway/api/llm/LlmAPI$Chat$Stream$V5$LLMData;
    //   158	42	10	it	Lai/grazie/api/gateway/api/llm/LlmAPI$Chat$Stream$V5$LLMData;
    //   120	89	11	$i$a$-map-LlmAPIClient$V5$chat$4	I
    //   0	257	2	$completion	Lkotlin/coroutines/Continuation;
    //   101	131	8	$i$a$-unsafeTransform-FlowKt__TransformKt$map$1	I
    //   46	201	3	$continuation	Lkotlin/coroutines/Continuation;
    //   52	195	4	$result	Ljava/lang/Object;
    //   235	8	8	$i$a$-unsafeTransform-FlowKt__TransformKt$map$1	I
  }
}


/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\api-gateway-client-jvm-0.4.32.jar!\ai\grazie\api\gateway\client\api\llm\LlmAPIClient$V5$chat$$inlined$map$1$2.class
