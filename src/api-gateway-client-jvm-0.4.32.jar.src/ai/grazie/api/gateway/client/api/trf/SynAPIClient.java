...
/*    */ 
/*    */ @Metadata(mv = {1, 7, 0}, k = 1, xi = 48, d1 = {"\000@\n\002\030\002\n\002\030\002\n\000\n\002\020\016\n\000\n\002\030\002\n\000\n\002\030\002\n\000\n\002\030\002\n\000\n\002\030\002\n\002\b\006\n\002\020 \n\002\b\002\n\002\030\002\n\000\n\002\030\002\n\002\b\002\030\0002\0020\001B/\b\000\022\006\020\002\032\0020\003\022\006\020\004\032\0020\005\022\006\020\006\032\0020\007\022\006\020\b\032\0020\t\022\006\020\n\032\0020\013¢\006\002\020\fJ,\020\021\032\b\022\004\022\0020\0030\0222\006\020\023\032\0020\0032\006\020\024\032\0020\0252\006\020\026\032\0020\027H@¢\006\002\020\030R\032\020\n\032\0020\013X\016¢\006\016\n\000\032\004\b\r\020\016\"\004\b\017\020\020¨\006\031"}, d2 = {"Lai/grazie/api/gateway/client/api/trf/SynAPIClient;", "Lai/grazie/client/common/cloud/SuspendableCloudClient;", "server", "", "authType", "Lai/grazie/model/cloud/AuthType;", "httpClient", "Lai/grazie/client/common/SuspendableHTTPClient;", "json", "Lai/grazie/utils/json/JSON;", "annotationLogger", "Lai/grazie/client/common/logging/AnnotationLogger;", "(Ljava/lang/String;Lai/grazie/model/cloud/AuthType;Lai/grazie/client/common/SuspendableHTTPClient;Lai/grazie/utils/json/JSON;Lai/grazie/client/common/logging/AnnotationLogger;)V", "getAnnotationLogger", "()Lai/grazie/client/common/logging/AnnotationLogger;", "setAnnotationLogger", "(Lai/grazie/client/common/logging/AnnotationLogger;)V", "synonymize", "", "text", "range", "Lai/grazie/text/TextRange;", "language", "Lai/grazie/nlp/langs/Language;", "(Ljava/lang/String;Lai/grazie/text/TextRange;Lai/grazie/nlp/langs/Language;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "api-gateway-client"})
/*    */ @SourceDebugExtension({"SMAP\nSynAPIClient.kt\nKotlin\n*S Kotlin\n*F\n+ 1 SynAPIClient.kt\nai/grazie/api/gateway/client/api/trf/SynAPIClient\n+ 2 SuspendableCloudClient.kt\nai/grazie/client/common/cloud/SuspendableCloudClient\n+ 3 HTTPResponseExtensions.kt\nai/grazie/client/common/model/HTTPResponseExtensionsKt\n*L\n1#1,23:1\n62#2,6:24\n7#3,2:30\n*S KotlinDebug\n*F\n+ 1 SynAPIClient.kt\nai/grazie/api/gateway/client/api/trf/SynAPIClient\n*L\n19#1:24,6\n19#1:30,2\n*E\n"})
/*    */ public final class SynAPIClient extends SuspendableCloudClient {
/*    */   @NotNull
/* 15 */   public AnnotationLogger getAnnotationLogger() { return this.annotationLogger; } @NotNull private AnnotationLogger annotationLogger; public void setAnnotationLogger(@NotNull AnnotationLogger <set-?>) { Intrinsics.checkNotNullParameter(<set-?>, "<set-?>"); this.annotationLogger = <set-?>; } public SynAPIClient(@NotNull String server, @NotNull AuthType authType, @NotNull SuspendableHTTPClient httpClient, @NotNull JSON json, @NotNull AnnotationLogger annotationLogger) {
/* 16 */     super(server, authType, httpClient, json, new ai.grazie.model.cloud.AuthVersion[0]);
/*    */     this.annotationLogger = annotationLogger;
/*    */   }
/*    */   
/*    */   @Nullable
/*    */   public final Object synonymize(@NotNull String text, @NotNull TextRange range, @NotNull Language language, @NotNull Continuation $completion) {
/*    */     // Byte code:
/*    */     //   0: aload #4
/*    */     //   2: instanceof ai/grazie/api/gateway/client/api/trf/SynAPIClient$synonymize$1
/*    */     //   5: ifeq -> 41
/*    */     //   8: aload #4
/*    */     //   10: checkcast ai/grazie/api/gateway/client/api/trf/SynAPIClient$synonymize$1
/*    */     //   13: astore #12
/*    */     //   15: aload #12
/*    */     //   17: getfield label : I
/*    */     //   20: ldc -2147483648
...
/*    */     //   35: putfield label : I
/*    */     //   38: goto -> 53
/*    */     //   41: new ai/grazie/api/gateway/client/api/trf/SynAPIClient$synonymize$1
/*    */     //   44: dup
/*    */     //   45: aload_0
/*    */     //   46: aload #4
/*    */     //   48: invokespecial <init> : (Lai/grazie/api/gateway/client/api/trf/SynAPIClient;Lkotlin/coroutines/Continuation;)V
/*    */     //   51: astore #12
/*    */     //   53: aload #12
...
/*    */     //   97: getstatic ai/grazie/api/gateway/api/trf/SynAPI$Synonymize$V2.INSTANCE : Lai/grazie/api/gateway/api/trf/SynAPI$Synonymize$V2;
/*    */     //   100: checkcast ai/grazie/model/cloud/API
/*    */     //   103: astore #6
/*    */     //   105: new ai/grazie/api/gateway/api/trf/SynAPI$Synonymize$V2$Request
/*    */     //   108: dup
/*    */     //   109: aload_1
/*    */     //   110: aload_2
/*    */     //   111: aload_3
...
/*    */     //   146: new ai/grazie/api/gateway/client/api/trf/SynAPIClient$synonymize$$inlined$sendAndGet$default$1
/*    */     //   149: dup
/*    */     //   150: aload #6
/*    */     //   152: aload #9
/*    */     //   154: aload #7
...
/*    */     //   199: astore #6
/*    */     //   201: nop
/*    */     //   202: getstatic ai/grazie/api/gateway/api/trf/SynAPI$Synonymize$V2$Response.Companion : Lai/grazie/api/gateway/api/trf/SynAPI$Synonymize$V2$Response$Companion;
...
/*    */     //   240: checkcast ai/grazie/api/gateway/api/trf/SynAPI$Synonymize$V2$Response
/*    */     //   243: astore #5
/*    */     //   245: aload #5
/*    */     //   247: invokevirtual getSynonyms : ()Ljava/util/List;
/*    */     //   250: areturn
...
/*    */     //   97	79	0	this	Lai/grazie/api/gateway/client/api/trf/SynAPIClient;
/*    */     //   97	20	1	text	Ljava/lang/String;
/*    */     //   97	20	2	range	Lai/grazie/text/TextRange;
/*    */     //   97	20	3	language	Lai/grazie/nlp/langs/Language;
/*    */     //   245	6	5	synonyms	Lai/grazie/api/gateway/api/trf/SynAPI$Synonymize$V2$Response;
...
/*    */   }
/*    */   
/*    */   @DebugMetadata(f = "SynAPIClient.kt", l = {29}, i = {}, s = {}, n = {}, m = "synonymize", c = "ai.grazie.api.gateway.client.api.trf.SynAPIClient")
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\api-gateway-client-jvm-0.4.32.jar!\ai\grazie\api\gateway\client\api\trf\SynAPIClient.class
