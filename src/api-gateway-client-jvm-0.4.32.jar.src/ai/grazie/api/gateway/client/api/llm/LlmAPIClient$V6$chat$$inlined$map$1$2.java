...
public final class null<T> implements FlowCollector {
  ...
  public final Object emit(Object value, @NotNull Continuation $completion) {
    // Byte code:
    //   0: aload_2
    //   1: instanceof ai/grazie/api/gateway/client/api/llm/LlmAPIClient$V6$chat$$inlined$map$1$2$1
    //   4: ifeq -> 36
    //   7: aload_2
    //   8: checkcast ai/grazie/api/gateway/client/api/llm/LlmAPIClient$V6$chat$$inlined$map$1$2$1
    //   11: astore_3
    //   12: aload_3
    //   13: getfield label : I
    //   16: ldc -2147483648
    ...
    //   30: putfield label : I
    //   33: goto -> 46
    //   36: new ai/grazie/api/gateway/client/api/llm/LlmAPIClient$V6$chat$$inlined$map$1$2$1
    //   39: dup
    //   40: aload_0
    //   41: aload_2
    //   42: invokespecial <init> : (Lai/grazie/api/gateway/client/api/llm/LlmAPIClient$V6$chat$$inlined$map$1$2;Lkotlin/coroutines/Continuation;)V
    //   45: astore_3
    //   46: aload_3
    ...
    //   57: aload_3
    //   58: getfield label : I
    //   61: tableswitch default -> 284, 0 -> 84, 1 -> 269
    //   84: aload #4
    ...
    //   111: pop
    //   112: checkcast ai/grazie/api/gateway/api/llm/LlmAPI$Chat$Stream$V6$LLMData
    //   115: astore #10
    //   117: iconst_0
    //   118: istore #11
    //   120: aload #10
    //   122: astore #12
    //   124: aload #12
    //   126: instanceof ai/grazie/api/gateway/api/llm/LlmAPI$Chat$Stream$V6$LLMData$Content
    //   129: ifeq -> 158
    ...
    //   141: aload #10
    //   143: checkcast ai/grazie/api/gateway/api/llm/LlmAPI$Chat$Stream$V6$LLMData$Content
    ...
    //   155: goto -> 245
    //   158: aload #12
    //   160: instanceof ai/grazie/api/gateway/api/llm/LlmAPI$Chat$Stream$V6$LLMData$FunctionCall
    //   163: ifeq -> 200
    //   166: new ai/grazie/model/llm/data/stream/LLMStreamFunctionCall
    //   169: dup
    //   170: aload #10
    //   172: checkcast ai/grazie/api/gateway/api/llm/LlmAPI$Chat$Stream$V6$LLMData$FunctionCall
    //   175: invokevirtual getName : ()Ljava/lang/String;
    //   178: aload #10
    //   180: invokevirtual getContent : ()Ljava/lang/String;
    //   183: aload #10
    //   185: checkcast ai/grazie/api/gateway/api/llm/LlmAPI$Chat$Stream$V6$LLMData$FunctionCall
    ...
    //   197: goto -> 245
    //   200: aload #12
    //   202: instanceof ai/grazie/api/gateway/api/llm/LlmAPI$Chat$Stream$V6$LLMData$QuotaMetadata
    //   205: ifeq -> 237
    //   208: new ai/grazie/model/llm/data/stream/LLMStreamQuotaMetaData
    //   211: dup
    //   212: aload #10
    //   214: checkcast ai/grazie/api/gateway/api/llm/LlmAPI$Chat$Stream$V6$LLMData$QuotaMetadata
    //   217: invokevirtual getUpdated : ()Lai/grazie/quota/Quota;
    //   220: aload #10
    //   222: checkcast ai/grazie/api/gateway/api/llm/LlmAPI$Chat$Stream$V6$LLMData$QuotaMetadata
    ...
    //   234: goto -> 245
    //   237: new kotlin/NoWhenBranchMatchedException
    //   240: dup
    ...
    //   255: invokeinterface emit : (Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    //   260: dup
    //   261: aload #5
    //   263: if_acmpne -> 279
    //   266: aload #5
    ...
    //   89	9	0	this	Lai/grazie/api/gateway/client/api/llm/LlmAPIClient$V6$chat$$inlined$map$1$2;
    ...
    //   117	41	10	it	Lai/grazie/api/gateway/api/llm/LlmAPI$Chat$Stream$V6$LLMData;
    //   158	42	10	it	Lai/grazie/api/gateway/api/llm/LlmAPI$Chat$Stream$V6$LLMData;
    //   200	37	10	it	Lai/grazie/api/gateway/api/llm/LlmAPI$Chat$Stream$V6$LLMData;
    //   120	126	11	$i$a$-map-LlmAPIClient$V6$chat$4	I
    //   0	294	2	$completion	Lkotlin/coroutines/Continuation;
    //   101	168	8	$i$a$-unsafeTransform-FlowKt__TransformKt$map$1	I
    //   46	238	3	$continuation	Lkotlin/coroutines/Continuation;
    //   52	232	4	$result	Ljava/lang/Object;
    //   272	8	8	$i$a$-unsafeTransform-FlowKt__TransformKt$map$1	I
  }
}


/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\api-gateway-client-jvm-0.4.32.jar!\ai\grazie\api\gateway\client\api\llm\LlmAPIClient$V6$chat$$inlined$map$1$2.class
