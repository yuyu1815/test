...
/*     */ final class TextAreaKt$NoTextAreaDecorator$1$Decoration$1
...
/* 122 */     if (($changed & 0x3) != 2 || !$composer.getSkipping()) { if (ComposerKt.isTraceInProgress()) ComposerKt.traceEventStart(-1314689209, $changed, -1, "org.jetbrains.jewel.ui.component.NoTextAreaDecorator.<no name provided>.Decoration.<anonymous> (TextArea.kt:121)");  Modifier modifier1 = PaddingKt.padding((Modifier)Modifier.Companion, this.$contentPadding); Function2<Composer, Integer, Unit> function2 = this.$innerTextField; int $changed$iv = 0, $i$f$Box = 0;
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\jewel-ui-243-0.27.0.jar!\org\jetbrains\jewe\\ui\component\TextAreaKt$NoTextAreaDecorator$1$Decoration$1.class
