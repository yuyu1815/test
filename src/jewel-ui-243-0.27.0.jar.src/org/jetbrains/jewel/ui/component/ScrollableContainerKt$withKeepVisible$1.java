...
/*     */ final class ScrollableContainerKt$withKeepVisible$1
...
/* 394 */     Object object = IntrinsicsKt.getCOROUTINE_SUSPENDED(); switch (this.label) { case 0: ResultKt.throwOnFailure(SYNTHETIC_LOCAL_VARIABLE_1); $this$pointerInput = (PointerInputScope)this.L$0;
/* 395 */         delayJob = new Ref.ObjectRef();
/* 396 */         this.label = 1; if (ForEachGestureKt.awaitEachGesture($this$pointerInput, new Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object>(delayJob, this.$onKeepVisibleChange, this.$scope, this.$lingerDuration, null) { int label; public final Object invokeSuspend(Object $result) { // Byte code:
...
/*     */ 
/*     */         
/* 408 */         return Unit.INSTANCE;case 1: ResultKt.throwOnFailure(SYNTHETIC_LOCAL_VARIABLE_1); return Unit.INSTANCE; }
/*     */     
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\jewel-ui-243-0.27.0.jar!\org\jetbrains\jewe\\ui\component\ScrollableContainerKt$withKeepVisible$1.class
