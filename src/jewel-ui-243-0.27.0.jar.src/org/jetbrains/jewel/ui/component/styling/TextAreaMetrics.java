...
/*    */   
/*    */   private TextAreaMetrics(float borderWidth, PaddingValues contentPadding, CornerSize cornerSize, long minSize) {
...
/*    */     if (this == other)
/*    */       return true; 
/*    */     if (!(other instanceof TextAreaMetrics))
/*    */       return false; 
/*    */     TextAreaMetrics textAreaMetrics = (TextAreaMetrics)other;
/*    */     return !Dp.equals-impl0(this.borderWidth, textAreaMetrics.borderWidth) ? false : (!Intrinsics.areEqual(this.contentPadding, textAreaMetrics.contentPadding) ? false : (!Intrinsics.areEqual(this.cornerSize, textAreaMetrics.cornerSize) ? false : (!!DpSize.equals-impl0(this.minSize, textAreaMetrics.minSize))));
/*    */   }
/*    */   
/*    */   public int hashCode() {
...
/*    */     return "TextAreaMetrics(borderWidth=" + Dp.toString-impl(this.borderWidth) + ", contentPadding=" + this.contentPadding + ", cornerSize=" + this.cornerSize + ", minSize=" + DpSize.toString-impl(this.minSize) + ")";
/*    */   }
/*    */   
/*    */   @Metadata(mv = {2, 0, 0}, k = 1, xi = 48, d1 = {"\000\f\n\002\030\002\n\002\020\000\n\002\b\003\b\003\030\0002\0020\001B\t\b\002¢\006\004\b\002\020\003¨\006\004"}, d2 = {"Lorg/jetbrains/jewel/ui/component/styling/TextAreaMetrics$Companion;", "", "<init>", "()V", "ui"})
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\jewel-ui-243-0.27.0.jar!\org\jetbrains\jewe\\ui\component\styling\TextAreaMetrics.class
