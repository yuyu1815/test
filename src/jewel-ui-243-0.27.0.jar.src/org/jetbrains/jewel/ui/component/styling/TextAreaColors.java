...
/*    */     if (this == other)
/*    */       return true; 
/*    */     if (!(other instanceof TextAreaColors))
/*    */       return false; 
/*    */     TextAreaColors textAreaColors = (TextAreaColors)other;
/*    */     return !Color.equals-impl0(this.background, textAreaColors.background) ? false : (!Color.equals-impl0(this.backgroundDisabled, textAreaColors.backgroundDisabled) ? false : (!Color.equals-impl0(this.backgroundFocused, textAreaColors.backgroundFocused) ? false : (!Color.equals-impl0(this.backgroundPressed, textAreaColors.backgroundPressed) ? false : (!Color.equals-impl0(this.backgroundHovered, textAreaColors.backgroundHovered) ? false : (!Color.equals-impl0(this.content, textAreaColors.content) ? false : (!Color.equals-impl0(this.contentDisabled, textAreaColors.contentDisabled) ? false : (!Color.equals-impl0(this.contentFocused, textAreaColors.contentFocused) ? false : (!Color.equals-impl0(this.contentPressed, textAreaColors.contentPressed) ? false : (!Color.equals-impl0(this.contentHovered, textAreaColors.contentHovered) ? false : (!Color.equals-impl0(this.border, textAreaColors.border) ? false : (!Color.equals-impl0(this.borderDisabled, textAreaColors.borderDisabled) ? false : (!Color.equals-impl0(this.borderFocused, textAreaColors.borderFocused) ? false : (!Color.equals-impl0(this.borderPressed, textAreaColors.borderPressed) ? false : (!Color.equals-impl0(this.borderHovered, textAreaColors.borderHovered) ? false : (!Color.equals-impl0(this.caret, textAreaColors.caret) ? false : (!Color.equals-impl0(this.caretDisabled, textAreaColors.caretDisabled) ? false : (!Color.equals-impl0(this.caretFocused, textAreaColors.caretFocused) ? false : (!Color.equals-impl0(this.caretPressed, textAreaColors.caretPressed) ? false : (!Color.equals-impl0(this.caretHovered, textAreaColors.caretHovered) ? false : (!!Color.equals-impl0(this.placeholder, textAreaColors.placeholder)))))))))))))))))))));
/*    */   }
/*    */   
/*    */   public int hashCode() {
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\jewel-ui-243-0.27.0.jar!\org\jetbrains\jewe\\ui\component\styling\TextAreaColors.class
