...
/*     */ 
/*     */   
/* 129 */   public static boolean isEnabled-impl(long arg0) { return (ULong.constructor-impl(arg0 & CommonStateBitMask.INSTANCE.getEnabled-s-VKNKU()) != 0L); } public boolean isEnabled() { return isEnabled-impl(this.state); }
/*     */ 
/*     */   
/* 132 */   public static boolean isFocused-impl(long arg0) { return (ULong.constructor-impl(arg0 & CommonStateBitMask.INSTANCE.getFocused-s-VKNKU()) != 0L); } public boolean isFocused() { return isFocused-impl(this.state); }
/*     */ 
/*     */   
...
/*     */ 
/*     */   
/*     */   public static final long copy-bhrFvog(long arg0, boolean enabled, boolean focused, boolean pressed, boolean hovered, boolean active) {
/* 147 */     return Companion.of-bhrFvog(enabled, focused, pressed, hovered, active);
/*     */   }
...
/* 150 */   public static boolean equals-impl(long arg0, Object other) { if (!(other instanceof SegmentedControlState)) return false;  long l = ((SegmentedControlState)other).unbox-impl(); return !(arg0 != l); } @NotNull public static String toString-impl(long arg0) { return box-impl(arg0).getClass().getSimpleName() + "(isEnabled=" + box-impl(arg0).getClass().getSimpleName() + ", isFocused=" + isEnabled-impl(arg0) + ", isHovered=" + isFocused-impl(arg0) + ", isPressed=" + isHovered-impl(arg0) + ", isActive=" + 
/* 151 */       isPressed-impl(arg0) + ")"; }
...
/*     */   public static final class Companion { public final long of-bhrFvog(boolean enabled, boolean focused, boolean pressed, boolean hovered, boolean active) {
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\jewel-ui-243-0.27.0.jar!\org\jetbrains\jewe\\ui\component\SegmentedControlState.class
