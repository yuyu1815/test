...
/*     */ final class EditableComboBoxKt$detectPressAndCancel$2
...
/* 386 */     Object object = IntrinsicsKt.getCOROUTINE_SUSPENDED(); switch (this.label) { case 0: ResultKt.throwOnFailure(SYNTHETIC_LOCAL_VARIABLE_1);
/* 387 */         this.label = 1; if (ForEachGestureKt.awaitEachGesture(this.$this_detectPressAndCancel, new Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object>(this.$onPress, this.$onCancel, null) { int label; public final Object invokeSuspend(Object $result) { // Byte code:
...
/* 387 */                 //   40	142	1	$result	Ljava/lang/Object; } public final Continuation<Unit> create(Object value, Continuation<? super null> $completion) { Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object> function2 = new Function2<>(this.$onPress, this.$onCancel, $completion); function2.L$0 = value; return (Continuation)function2; } public final Object invoke(AwaitPointerEventScope p1, Continuation<?> p2) { return ((null)create(p1, p2)).invokeSuspend(Unit.INSTANCE); } }(Continuation)this) == object) return object;  ForEachGestureKt.awaitEachGesture(this.$this_detectPressAndCancel, new Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object>(this.$onPress, this.$onCancel, null) { int label; public final Object invokeSuspend(Object $result) { // Byte code:
/*     */                 //   0: invokestatic getCOROUTINE_SUSPENDED : ()Ljava/lang/Object;
/*     */                 //   3: astore #6
/*     */                 //   5: aload_0
/*     */                 //   6: getfield label : I
...
/*     */ 
/*     */         
/* 398 */         return Unit.INSTANCE;case 1: ResultKt.throwOnFailure(SYNTHETIC_LOCAL_VARIABLE_1); return Unit.INSTANCE; }
/*     */     
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\jewel-ui-243-0.27.0.jar!\org\jetbrains\jewe\\ui\component\EditableComboBoxKt$detectPressAndCancel$2.class
