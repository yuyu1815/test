...
/*     */ final class TextAreaKt$TextAreaDecorator$1
/*     */   implements TextFieldDecorator
/*     */ {
/*     */   TextAreaKt$TextAreaDecorator$1(ScrollbarStyle $scrollbarStyle, TextAreaStyle $style, ScrollState $scrollState, TextStyle $textStyle, Modifier $decorationBoxModifier, long $minSize, TextFieldState $state, Function2<Composer, Integer, Unit> $placeholder) {}
/*     */   
/*     */   @Composable
...
/* 140 */     Intrinsics.checkNotNullParameter(innerTextField, "innerTextField"); $composer.startReplaceGroup(-852752594); if (ComposerKt.isTraceInProgress()) ComposerKt.traceEventStart(-852752594, $changed, -1, "org.jetbrains.jewel.ui.component.TextAreaDecorator.<no name provided>.Decoration (TextArea.kt:139)"); 
/* 141 */     CompositionLocal compositionLocal = (CompositionLocal)CompositionLocalsKt.getLocalLayoutDirection(); int $changed$iv = 0, $i$f$getCurrent = 0;
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\jewel-ui-243-0.27.0.jar!\org\jetbrains\jewe\\ui\component\TextAreaKt$TextAreaDecorator$1.class
