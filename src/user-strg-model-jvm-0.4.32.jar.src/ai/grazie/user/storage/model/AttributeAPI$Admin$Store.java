...
/*    */ public final class Store implements TypedApi<AttributeAPI.Admin.Store.Request, AttributeAPI.Admin.Store.Response> {
/*    */   @NotNull
/* 37 */   public static final Store INSTANCE = new Store(); @NotNull private static final TypeInfo<Request> requestType; @NotNull private static final String path = "/admin/attribute/store"; @NotNull private static final TypeInfo<Response> responseType; @NotNull public String getPath() { return path; } @NotNull
...
/*    */         arrayOfKSerializer[1] = (KSerializer)Attributes$.serializer.INSTANCE;
/*    */         return (KSerializer<?>[])arrayOfKSerializer;
/*    */       }
/*    */       
/*    */       @NotNull
/*    */       public AttributeAPI.Admin.Store.Request deserialize(@NotNull Decoder decoder) {
...
/*    */         return new AttributeAPI.Admin.Store.Request(i, uUID, attributes, null);
/*    */       }
/*    */       
/*    */       public void serialize(@NotNull Encoder encoder, @NotNull AttributeAPI.Admin.Store.Request value) {
/*    */         Intrinsics.checkNotNullParameter(encoder, "encoder");
/*    */         Intrinsics.checkNotNullParameter(value, "value");
/*    */         SerialDescriptor serialDescriptor = getDescriptor();
/*    */         CompositeEncoder compositeEncoder = encoder.beginStructure(serialDescriptor);
/*    */         AttributeAPI.Admin.Store.Request.write$Self$user_strg_model(value, compositeEncoder, serialDescriptor);
/*    */         compositeEncoder.endStructure(serialDescriptor);
/*    */       }
/*    */       
/*    */       static {
/*    */         PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("ai.grazie.user.storage.model.AttributeAPI.Admin.Store.Request", INSTANCE, 2);
...
/*    */     }
/*    */     
/*    */     @Metadata(mv = {1, 7, 0}, k = 1, xi = 48, d1 = {"\000\026\n\002\030\002\n\002\020\000\n\002\b\002\n\002\030\002\n\002\030\002\n\000\b\003\030\0002\0020\001B\007\b\002¢\006\002\020\002J\017\020\003\032\b\022\004\022\0020\0050\004HÆ\001¨\006\006"}, d2 = {"Lai/grazie/user/storage/model/AttributeAPI$Admin$Store$Request$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lai/grazie/user/storage/model/AttributeAPI$Admin$Store$Request;", "user-strg-model"})
/*    */     public static final class Companion {
/*    */       private Companion() {}
/*    */       
/*    */       @NotNull
/*    */       public final KSerializer<AttributeAPI.Admin.Store.Request> serializer() {
/*    */         return (KSerializer<AttributeAPI.Admin.Store.Request>)AttributeAPI.Admin.Store.Request.$serializer.INSTANCE;
/*    */       }
/*    */     }
/*    */     
/*    */     @NotNull
...
/*    */     
/*    */     public Response(@NotNull UUID user, @NotNull Set<Attributes.Key> keys) {
/*    */       this.user = user;
/*    */       this.keys = keys;
/*    */     }
/*    */     
...
/*    */       @NotNull
/*    */       public KSerializer<?>[] childSerializers() {
/*    */         KSerializer[] arrayOfKSerializer1 = (KSerializer[])AttributeAPI.Admin.Store.Response.$childSerializers, arrayOfKSerializer2 = new KSerializer[2];
...
/*    */       
/*    */       @NotNull
/*    */       public AttributeAPI.Admin.Store.Response deserialize(@NotNull Decoder decoder) {
/*    */         Intrinsics.checkNotNullParameter(decoder, "decoder");
/*    */         SerialDescriptor serialDescriptor = getDescriptor();
/*    */         boolean bool = true;
/*    */         int i = 0;
...
/*    */         Set set = null;
/*    */         CompositeDecoder compositeDecoder = decoder.beginStructure(serialDescriptor);
/*    */         KSerializer[] arrayOfKSerializer = (KSerializer[])AttributeAPI.Admin.Store.Response.$childSerializers;
/*    */         if (compositeDecoder.decodeSequentially()) {
/*    */           uUID = (UUID)compositeDecoder.decodeSerializableElement(serialDescriptor, 0, (DeserializationStrategy)UUID.Serializer.INSTANCE, uUID);
/*    */           i |= 0x1;
...
/*    */         } 
/*    */         compositeDecoder.endStructure(serialDescriptor);
/*    */         return new AttributeAPI.Admin.Store.Response(i, uUID, set, null);
/*    */       }
/*    */       
/*    */       public void serialize(@NotNull Encoder encoder, @NotNull AttributeAPI.Admin.Store.Response value) {
/*    */         Intrinsics.checkNotNullParameter(encoder, "encoder");
/*    */         Intrinsics.checkNotNullParameter(value, "value");
/*    */         SerialDescriptor serialDescriptor = getDescriptor();
/*    */         CompositeEncoder compositeEncoder = encoder.beginStructure(serialDescriptor);
/*    */         AttributeAPI.Admin.Store.Response.write$Self$user_strg_model(value, compositeEncoder, serialDescriptor);
/*    */         compositeEncoder.endStructure(serialDescriptor);
/*    */       }
/*    */       
/*    */       static {
/*    */         PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("ai.grazie.user.storage.model.AttributeAPI.Admin.Store.Response", INSTANCE, 2);
/*    */         pluginGeneratedSerialDescriptor.addElement("user", false);
...
/*    */     }
/*    */     
/*    */     @Metadata(mv = {1, 7, 0}, k = 1, xi = 48, d1 = {"\000\026\n\002\030\002\n\002\020\000\n\002\b\002\n\002\030\002\n\002\030\002\n\000\b\003\030\0002\0020\001B\007\b\002¢\006\002\020\002J\017\020\003\032\b\022\004\022\0020\0050\004HÆ\001¨\006\006"}, d2 = {"Lai/grazie/user/storage/model/AttributeAPI$Admin$Store$Response$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lai/grazie/user/storage/model/AttributeAPI$Admin$Store$Response;", "user-strg-model"})
/*    */     public static final class Companion {
/*    */       private Companion() {}
/*    */       
/*    */       @NotNull
/*    */       public final KSerializer<AttributeAPI.Admin.Store.Response> serializer() {
/*    */         return (KSerializer<AttributeAPI.Admin.Store.Response>)AttributeAPI.Admin.Store.Response.$serializer.INSTANCE;
/*    */       }
/*    */     }
/*    */     
/*    */     @NotNull
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\li\\user-strg-model-jvm-0.4.32.jar!\ai\grazi\\user\storage\model\AttributeAPI$Admin$Store.class
