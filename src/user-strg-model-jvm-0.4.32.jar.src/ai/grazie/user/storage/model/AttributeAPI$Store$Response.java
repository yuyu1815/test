...
/*    */   @NotNull
/* 18 */   public static final Companion Companion = new Companion(null); @NotNull private final Set<Attributes.Key> keys; @JvmField @NotNull
/* 19 */   private static final KSerializer<Object>[] $childSerializers; public Response(@NotNull Set<Attributes.Key> keys) { this.keys = keys; } static { KSerializer[] arrayOfKSerializer = new KSerializer[1]; arrayOfKSerializer[0] = (KSerializer)new LinkedHashSetSerializer(Attributes.Key.Companion.serializer()); $childSerializers = (KSerializer<Object>[])arrayOfKSerializer; } @NotNull public final Set<Attributes.Key> getKeys() { return this.keys; }
/*    */ 
/*    */   
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\li\\user-strg-model-jvm-0.4.32.jar!\ai\grazi\\user\storage\model\AttributeAPI$Store$Response.class
