...
/*    */   @NotNull
/* 28 */   public static final Companion Companion = new Companion(null); @NotNull
/* 29 */   private final Set<Attributes.Key> keys; public Request(@NotNull Set<Attributes.Key> keys) { this.keys = keys; } @JvmField @NotNull private static final KSerializer<Object>[] $childSerializers; @NotNull public final Set<Attributes.Key> getKeys() { return this.keys; }
/*    */ 
/*    */   
/*    */   static {
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\li\\user-strg-model-jvm-0.4.32.jar!\ai\grazi\\user\storage\model\AttributeAPI$Get$Request.class
