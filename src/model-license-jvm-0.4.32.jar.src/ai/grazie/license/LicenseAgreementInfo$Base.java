...
/*    */ public final class Base extends LicenseAgreementInfo {
/*    */   @NotNull
...
/*    */   public static final class $serializer implements GeneratedSerializer<Base> { @NotNull
...
/* 24 */   public String getVersion() { return this.version; } public Base(@NotNull String id, @NotNull String version) {
/* 25 */     super(null);
/*    */     this.id = id;
...
/*    */   
/*    */   @NotNull
/*    */   public final Base copy(@NotNull String id, @NotNull String version) {
/*    */     Intrinsics.checkNotNullParameter(id, "id");
/*    */     Intrinsics.checkNotNullParameter(version, "version");
/*    */     return new Base(id, version);
/*    */   }
/*    */   
/*    */   @NotNull
/*    */   public String toString() {
/*    */     return "Base(id=" + this.id + ", version=" + this.version + ")";
/*    */   }
/*    */   
/*    */   public int hashCode() {
...
/*    */     return !Intrinsics.areEqual(this.id, base.id) ? false : (!!Intrinsics.areEqual(this.version, base.version));
/*    */   }
/*    */ }


/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\model-license-jvm-0.4.32.jar!\ai\grazie\license\LicenseAgreementInfo$Base.class
