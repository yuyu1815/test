...
/*      */ 
/*      */ 
/*      */ @Metadata(mv = {1, 8, 0}, k = 1, xi = 48, d1 = {"\000J\n\002\030\002\n\002\030\002\n\000\n\002\020\b\n\002\b\003\n\002\020\002\n\002\b\005\n\002\020\t\n\002\b\002\n\002\030\002\n\002\b\006\n\002\030\002\n\002\030\002\n\002\020\026\n\002\b\007\n\002\020\013\n\002\b\002\n\002\030\002\n\002\b\b\030\0002\0020\001B\017\022\b\b\002\020\002\032\0020\003¢\006\002\020\004J\b\020\006\032\0020\007H\002J\006\020\b\032\0020\007J\020\020\t\032\0020\0032\006\020\n\032\0020\003H\002J\020\020\013\032\0020\0032\006\020\f\032\0020\rH\002J\"\020\016\032\0020\0032\006\020\f\032\0020\r2\f\020\017\032\b\022\004\022\0020\0030\020H\bø\001\000J\b\020\021\032\0020\007H\002J\020\020\022\032\0020\0072\006\020\023\032\0020\003H\002J\020\020\024\032\0020\0072\006\020\002\032\0020\003H\002J\021\020\025\032\0020\0072\006\020\026\032\0020\027H\nJ\021\020\025\032\0020\0072\006\020\026\032\0020\030H\nJ\021\020\025\032\0020\0072\006\020\f\032\0020\rH\nJ\021\020\025\032\0020\0072\006\020\026\032\0020\031H\nJ\021\020\032\032\0020\0072\006\020\033\032\0020\001H\nJ\026\020\034\032\0020\0072\006\020\f\032\0020\r2\006\020\035\032\0020\003J\036\020\034\032\0020\0032\006\020\f\032\0020\r2\006\020\035\032\0020\0032\006\020\036\032\0020\003J\016\020\037\032\0020\0072\006\020\033\032\0020\001J\016\020 \032\0020\0072\006\020\f\032\0020\rJ\026\020 \032\0020!2\006\020\f\032\0020\r2\006\020\035\032\0020\003J&\020\"\032\0020\0072\030\020#\032\024\022\004\022\0020\r\022\004\022\0020\003\022\004\022\0020!0$H\bø\001\000J\020\020%\032\0020\0072\006\020&\032\0020\003H\001J\020\020'\032\0020\0072\006\020(\032\0020\003H\002J\031\020)\032\0020\0072\006\020\f\032\0020\r2\006\020\035\032\0020\003H\002J\006\020*\032\0020\003J\031\020+\032\0020\0072\006\020&\032\0020\0032\006\020\035\032\0020\rH\bR\016\020\005\032\0020\003X\016¢\006\002\n\000\002\007\n\005\b20\001¨\006,"}, d2 = {"Landroidx/collection/MutableLongIntMap;", "Landroidx/collection/LongIntMap;", "initialCapacity", "", "(I)V", "growthLimit", "adjustStorage", "", "clear", "findFirstAvailableSlot", "hash1", "findInsertIndex", "key", "", "getOrPut", "defaultValue", "Lkotlin/Function0;", "initializeGrowth", "initializeMetadata", "capacity", "initializeStorage", "minusAssign", "keys", "Landroidx/collection/LongList;", "Landroidx/collection/LongSet;", "", "plusAssign", "from", "put", "value", "default", "putAll", "remove", "", "removeIf", "predicate", "Lkotlin/Function2;", "removeValueAt", "index", "resizeStorage", "newCapacity", "set", "trim", "writeMetadata", "collection"})
...
/*      */ 
/*      */       
/* 1032 */       int $i$a$-require-MutableLongIntMap$1 = 0; String str = "Capacity must be a positive value."; throw new IllegalArgumentException(str.toString()); }  initializeStorage(ScatterMapKt.unloadedCapacity(initialCapacity));
/* 1033 */   } private final void initializeStorage(int initialCapacity) { int newCapacity = (initialCapacity > 0) ? Math.max(7, ScatterMapKt.normalizeCapacity(initialCapacity)) : 0; this._capacity = newCapacity; initializeMetadata(newCapacity); this.keys = new long[newCapacity]; this.values = new int[newCapacity]; } private final void initializeGrowth() { this.growthLimit = ScatterMapKt.loadedCapacity(getCapacity()) - this._size; } public final int getOrPut(long key, @NotNull Function0 defaultValue) { Intrinsics.checkNotNullParameter(defaultValue, "defaultValue"); int $i$f$getOrPut = 0, index = findKeyIndex(key); int defValue = ((Number)defaultValue.invoke()).intValue(); put(key, defValue); return (index < 0) ? defValue : this.values[index]; } public final void set(long key, int value) { int index = findInsertIndex(key); if (index < 0) index ^= 0xFFFFFFFF;  this.keys[index] = key; this.values[index] = value; } private final void initializeMetadata(int capacity) { int size = (capacity + 1 + 7 + 7 & 0xFFFFFFF8) >> 3; long[] arrayOfLong2 = new long[size], arrayOfLong3 = arrayOfLong2; MutableLongIntMap mutableLongIntMap = this; int $i$a$-apply-MutableLongIntMap$initializeMetadata$1 = 0; ArraysKt.fill$default(arrayOfLong3, -9187201950435737472L, 0, 0, 6, null); mutableLongIntMap.metadata = (capacity == 0) ? ScatterMapKt.EmptyGroup : arrayOfLong2; long arrayOfLong1[] = this.metadata, value$iv = 255L; int $i$f$writeRawMetadata = 0; int i$iv = capacity >> 3;
...
/*      */   public final void put(long key, int value) { set(key, value); }
/* 1039 */   public final int put(long key, int value, int default) { int index = findInsertIndex(key); int previous = default; if (index < 0) { index ^= 0xFFFFFFFF; } else { previous = this.values[index]; }  this.keys[index] = key; this.values[index] = value; return previous; } public final void putAll(@NotNull LongIntMap from) { Intrinsics.checkNotNullParameter(from, "from"); LongIntMap this_$iv = from; int $i$f$forEach = 0; long[] k$iv = this_$iv.keys;
/* 1040 */     int[] v$iv = this_$iv.values;
/*      */     
/* 1042 */     LongIntMap this_$iv$iv = this_$iv; int $i$f$forEachIndexed = 0;
...
/*      */             continue;  break; }  continue; if (i$iv$iv != lastIndex$iv$iv) { i$iv$iv++; continue; }  // Byte code: goto -> 220 }  } else {  }  } public final void plusAssign(@NotNull LongIntMap from) { Intrinsics.checkNotNullParameter(from, "from"); int $i$f$plusAssign = 0; putAll(from); }
/*      */   public final void remove(long key) { int index = findKeyIndex(key); if (index >= 0)
/*      */       removeValueAt(index);  }
/*      */   public final boolean remove(long key, int value) { int index = findKeyIndex(key); if (index >= 0 && this.values[index] == value) { removeValueAt(index); return true; }  return false; }
/* 1065 */   public final void removeIf(@NotNull Function2 predicate) { Intrinsics.checkNotNullParameter(predicate, "predicate"); int $i$f$removeIf = 0; LongIntMap this_$iv = this; int $i$f$forEachIndexed = 0; long[] m$iv = this_$iv.metadata;
...
/* 1115 */       long key = content$iv[i$iv]; int $i$a$-forEach-MutableLongIntMap$minusAssign$2 = 0; remove(key);
/*      */     }  } @PublishedApi public final void removeValueAt(int index) { this._size--; MutableLongIntMap mutableLongIntMap = this; long value$iv = 254L;
/*      */     int $i$f$writeMetadata = 0;
/* 1118 */     long[] m$iv = mutableLongIntMap.metadata;
...
/*      */     
/* 1126 */     int c$iv = mutableLongIntMap._capacity;
...
/* 1156 */       metadata$iv[index >> 3] >> (index & 0x7) << 3 & 0xFFL) == 128L)) ? 1 : 0; MutableLongIntMap mutableLongIntMap = this; long value$iv = hash2; int $i$f$writeMetadata = 0;
/* 1157 */     long[] m$iv = mutableLongIntMap.metadata;
...
/*      */     
/* 1165 */     int c$iv = mutableLongIntMap._capacity;
...
/* 1175 */   private final void resizeStorage(int newCapacity) { long[] previousMetadata = this.metadata; long[] previousKeys = this.keys; int[] previousValues = this.values; int previousCapacity = this._capacity; initializeStorage(newCapacity); long[] newKeys = this.keys; int[] newValues = this.values; for (int i = 0; i < previousCapacity; i++) { int $i$f$isFull = 0; int $i$f$readRawMetadata = 0; if (((
...
/* 1180 */         int $i$f$h1 = 0, index = findFirstAvailableSlot(hash >>> 7); MutableLongIntMap mutableLongIntMap = this; int $i$f$h2 = 0;
/* 1181 */         long value$iv = (hash & 0x7F); int $i$f$writeMetadata = 0;
/* 1182 */         long[] m$iv = mutableLongIntMap.metadata;
...
/*      */         
/* 1190 */         int c$iv = mutableLongIntMap._capacity;
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\collection-jvm-1.4.0.jar!\androidx\collection\MutableLongIntMap.class
