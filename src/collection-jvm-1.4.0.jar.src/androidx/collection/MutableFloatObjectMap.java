...
/*      */ public final class MutableFloatObjectMap<V>
/*      */   extends FloatObjectMap<V>
/*      */ {
...
/*      */ 
/*      */       
/* 1019 */       int $i$a$-require-MutableFloatObjectMap$1 = 0; String str = "Capacity must be a positive value."; throw new IllegalArgumentException(str.toString()); }  initializeStorage(ScatterMapKt.unloadedCapacity(initialCapacity));
/* 1020 */   } private final void initializeStorage(int initialCapacity) { int newCapacity = (initialCapacity > 0) ? Math.max(7, ScatterMapKt.normalizeCapacity(initialCapacity)) : 0; this._capacity = newCapacity; initializeMetadata(newCapacity); this.keys = new float[newCapacity]; this.values = new Object[newCapacity]; } private final void initializeMetadata(int capacity) { int size = (capacity + 1 + 7 + 7 & 0xFFFFFFF8) >> 3; long[] arrayOfLong2 = new long[size], arrayOfLong3 = arrayOfLong2; MutableFloatObjectMap mutableFloatObjectMap = this; int $i$a$-apply-MutableFloatObjectMap$initializeMetadata$1 = 0; ArraysKt.fill$default(arrayOfLong3, -9187201950435737472L, 0, 0, 6, null); mutableFloatObjectMap.metadata = (capacity == 0) ? ScatterMapKt.EmptyGroup : arrayOfLong2; long arrayOfLong1[] = this.metadata, value$iv = 255L; int $i$f$writeRawMetadata = 0; int i$iv = capacity >> 3;
...
/*      */   public final V getOrPut(float key, @NotNull Function0 defaultValue) { Intrinsics.checkNotNullParameter(defaultValue, "defaultValue"); int $i$f$getOrPut = 0; if (get(key) == null) { get(key); Object object1 = defaultValue.invoke(), it = object1; int $i$a$-also-MutableFloatObjectMap$getOrPut$1 = 0; set(key, (V)it); }  return (V)object1; }
/* 1026 */   public final void putAll(@NotNull FloatObjectMap from) { Intrinsics.checkNotNullParameter(from, "from"); FloatObjectMap this_$iv = from; int $i$f$forEach = 0; float[] k$iv = this_$iv.keys;
/* 1027 */     Object[] v$iv = this_$iv.values;
/*      */     
/* 1029 */     FloatObjectMap this_$iv$iv = this_$iv; int $i$f$forEachIndexed = 0;
...
/*      */ 
/*      */   
/*      */   public final void set(float key, Object value) {
...
/*      */   
/*      */   @Nullable
/*      */   public final V put(float key, Object value) {
/*      */     int index = findAbsoluteInsertIndex(key);
...
/*      */     // Byte code:
/*      */     //   0: aload_0
/*      */     //   1: checkcast androidx/collection/FloatObjectMap
/*      */     //   4: astore_3
/*      */     //   5: iconst_0
/*      */     //   6: istore #4
/*      */     //   8: iconst_0
...
/*      */     //   307: aload_0
/*      */     //   308: iload_2
/*      */     //   309: invokevirtual removeValueAt : (I)Ljava/lang/Object;
/*      */     //   312: areturn
/*      */     //   313: aconst_null
/*      */     //   314: areturn
/*      */     // Line number table:
...
/*      */     //   119	179	14	g$iv	J
/*      */     //   157	141	21	m$iv	J
/*      */     //   8	294	4	$i$f$findKeyIndex$collection	I
/*      */     //   30	272	7	hash$iv	I
/*      */     //   40	262	5	hash2$iv	I
/*      */     //   46	256	6	probeMask$iv	I
/*      */     //   59	243	9	probeOffset$iv	I
/*      */     //   62	240	8	probeIndex$iv	I
/*      */     //   5	297	3	this_$iv	Landroidx/collection/FloatObjectMap;
/*      */     //   303	12	2	index	I
/*      */     //   0	315	0	this	Landroidx/collection/MutableFloatObjectMap;
/*      */     //   0	315	1	key	F
/*      */   }
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/*      */   public final boolean remove(float key, Object value) {
/*      */     // Byte code:
/*      */     //   0: aload_0
/*      */     //   1: checkcast androidx/collection/FloatObjectMap
/*      */     //   4: astore #4
...
/*      */     //   324: aload_0
/*      */     //   325: iload_3
/*      */     //   326: invokevirtual removeValueAt : (I)Ljava/lang/Object;
/*      */     //   329: pop
/*      */     //   330: iconst_1
/*      */     //   331: ireturn
/*      */     //   332: iconst_0
...
/*      */     //   212	42	13	index$iv	I
/*      */     //   264	16	19	$i$f$maskEmpty	I
/*      */     //   261	19	17	$this$maskEmpty$iv$iv	J
/*      */     //   122	180	15	g$iv	J
/*      */     //   160	142	22	m$iv	J
/*      */     //   9	297	5	$i$f$findKeyIndex$collection	I
/*      */     //   31	275	8	hash$iv	I
/*      */     //   41	265	6	hash2$iv	I
/*      */     //   48	258	7	probeMask$iv	I
/*      */     //   61	245	10	probeOffset$iv	I
/*      */     //   64	242	9	probeIndex$iv	I
/*      */     //   6	300	4	this_$iv	Landroidx/collection/FloatObjectMap;
/*      */     //   307	27	3	index	I
/*      */     //   0	334	0	this	Landroidx/collection/MutableFloatObjectMap;
/*      */     //   0	334	1	key	F
/*      */     //   0	334	2	value	Ljava/lang/Object;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */   
/*      */   } public final void minusAssign(float key) { int $i$f$minusAssign = 0; remove(key); } public final void minusAssign(@NotNull float[] keys) { Intrinsics.checkNotNullParameter(keys, "keys"); int $i$f$minusAssign; byte b; int i; for ($i$f$minusAssign = 0, b = 0, i = keys.length; b < i; ) { float key = keys[b]; remove(key); b++; }
/*      */      }
/* 1153 */   public final void minusAssign(@NotNull FloatSet keys) { Intrinsics.checkNotNullParameter(keys, "keys"); int $i$f$minusAssign = 0; FloatSet this_$iv = keys; int $i$f$forEach = 0; float[] k$iv = this_$iv.elements;
/*      */     
/* 1155 */     FloatSet this_$iv$iv = this_$iv; int $i$f$forEachIndex = 0;
/*      */     
...
/*      */       }  }
/*      */     else {  }
/* 1182 */      } public final void minusAssign(@NotNull FloatList keys) { Intrinsics.checkNotNullParameter(keys, "keys"); int $i$f$minusAssign = 0; FloatList this_$iv = keys; int $i$f$forEach = 0; float[] content$iv = this_$iv.content;
/* 1183 */     int i$iv = 0, i = this_$iv._size; if (i$iv < i) {
/* 1184 */       float key = content$iv[i$iv]; int $i$a$-forEach-MutableFloatObjectMap$minusAssign$2 = 0; MutableFloatObjectMap mutableFloatObjectMap = this; int j = 0;
/* 1185 */       mutableFloatObjectMap.remove(key);
/*      */     }  } @PublishedApi @Nullable public final V removeValueAt(int index) { this._size--; MutableFloatObjectMap mutableFloatObjectMap = this; long value$iv = 254L;
/*      */     int $i$f$writeMetadata = 0;
/* 1188 */     long[] m$iv = mutableFloatObjectMap.metadata;
...
/*      */     
/* 1196 */     int c$iv = mutableFloatObjectMap._capacity;
...
/*      */     }  ArraysKt.fill(this.values, null, 0, this._capacity); initializeGrowth(); } private final int findAbsoluteInsertIndex(float key) { int $i$f$hash = 0;
/* 1207 */     int hash$iv = Float.hashCode(key) * -862048943;
/*      */     
...
/* 1226 */       metadata$iv[index >> 3] >> (index & 0x7) << 3 & 0xFFL) == 128L)) ? 1 : 0; MutableFloatObjectMap mutableFloatObjectMap = this; long value$iv = hash2; int $i$f$writeMetadata = 0;
/* 1227 */     long[] m$iv = mutableFloatObjectMap.metadata;
...
/*      */     
/* 1235 */     int c$iv = mutableFloatObjectMap._capacity;
...
/* 1245 */   public final int trim() { int previousCapacity = this._capacity; int newCapacity = ScatterMapKt.normalizeCapacity(ScatterMapKt.unloadedCapacity(this._size)); if (newCapacity < previousCapacity) { resizeStorage(newCapacity); return previousCapacity - this._capacity; }  return 0; } private final void resizeStorage(int newCapacity) { long[] previousMetadata = this.metadata; float[] previousKeys = this.keys; Object[] previousValues = this.values; int previousCapacity = this._capacity; initializeStorage(newCapacity); float[] newKeys = this.keys; Object[] newValues = this.values; for (int i = 0; i < previousCapacity; i++) { int $i$f$isFull = 0; int $i$f$readRawMetadata = 0; if (((
/* 1246 */         previousMetadata[i >> 3] >> (i & 0x7) << 3 & 0xFFL) < 128L))
/* 1247 */       { float previousKey = previousKeys[i]; int $i$f$hash = 0; int hash$iv = Float.hashCode(previousKey) * -862048943;
/*      */         
/* 1249 */         int hash = hash$iv ^ hash$iv << 16;
/* 1250 */         int $i$f$h1 = 0, index = findFirstAvailableSlot(hash >>> 7); MutableFloatObjectMap mutableFloatObjectMap = this; int $i$f$h2 = 0;
/* 1251 */         long value$iv = (hash & 0x7F); int $i$f$writeMetadata = 0;
/* 1252 */         long[] m$iv = mutableFloatObjectMap.metadata;
...
/*      */         
/* 1260 */         int c$iv = mutableFloatObjectMap._capacity;
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\collection-jvm-1.4.0.jar!\androidx\collection\MutableFloatObjectMap.class
