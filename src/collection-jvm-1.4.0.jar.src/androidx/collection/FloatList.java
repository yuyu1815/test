...
/*   49 */       FloatSetKt.getEmptyFloatArray() : 
/*      */       
/*   51 */       new float[initialCapacity];
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*   96 */     FloatList this_$iv = this; int $i$f$forEach = 0;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */     
/*  971 */     float[] content$iv = this_$iv.content;
/*  972 */     int i$iv = 0, i = this_$iv._size; if (i$iv < i) {
/*  973 */       float it = content$iv[i$iv]; int $i$a$-forEach-FloatList$any$2 = 0; if (((Boolean)predicate.invoke(Float.valueOf(it))).booleanValue())
/*      */         return true; 
/*      */     }  return false; } public final boolean reversedAny(@NotNull Function1 predicate) { Intrinsics.checkNotNullParameter(predicate, "predicate"); int $i$f$reversedAny = 0; FloatList this_$iv = this;
/*      */     int $i$f$forEachReversed = 0;
/*  977 */     float[] content$iv = this_$iv.content;
/*  978 */     int i$iv = this_$iv._size - 1; if (-1 < i$iv) {
/*  979 */       float it = content$iv[i$iv]; int $i$a$-forEachReversed-FloatList$reversedAny$2 = 0; if (((Boolean)predicate.invoke(Float.valueOf(it))).booleanValue())
/*      */         return true; 
/*      */     }  return false; } public final boolean contains(float element) { FloatList this_$iv = this;
/*      */     int $i$f$forEach = 0;
/*  983 */     float[] content$iv = this_$iv.content;
/*  984 */     int i$iv = 0, i = this_$iv._size; if (i$iv < i) {
/*  985 */       float it = content$iv[i$iv]; int $i$a$-forEach-FloatList$contains$1 = 0; if ((it == element))
/*      */         return true; 
/*      */     }  return false; } public final boolean containsAll(@NotNull FloatList elements) { Intrinsics.checkNotNullParameter(elements, "elements"); FloatList this_$iv = elements; int $i$f$getIndices = 0;
...
/*  990 */   public final int count(@NotNull Function1 predicate) { Intrinsics.checkNotNullParameter(predicate, "predicate"); int $i$f$count = 0; int count = 0; FloatList this_$iv = this; int $i$f$forEach = 0; float[] content$iv = this_$iv.content;
/*  991 */     int i$iv = 0, i = this_$iv._size; if (i$iv < i) {
/*  992 */       float it = content$iv[i$iv]; int $i$a$-forEach-FloatList$count$2 = 0; if (((Boolean)predicate.invoke(Float.valueOf(it))).booleanValue())
/*      */         count++; 
/*      */     }  return count; } public final float first() { if (isEmpty())
/*      */       throw new NoSuchElementException("FloatList is empty.");  return this.content[0]; }
/*  996 */   public final float first(@NotNull Function1 predicate) { Intrinsics.checkNotNullParameter(predicate, "predicate"); int $i$f$first = 0; FloatList this_$iv = this; int $i$f$forEach = 0; float[] content$iv = this_$iv.content;
/*  997 */     int i$iv = 0, i = this_$iv._size; if (i$iv < i) {
/*  998 */       float item = content$iv[i$iv]; int $i$a$-forEach-FloatList$first$2 = 0; if (((Boolean)predicate.invoke(Float.valueOf(item))).booleanValue())
/*      */         return item; 
/*      */     }  throw new NoSuchElementException("FloatList contains no element matching the predicate."); } public final <R> R fold(Object initial, @NotNull Function2 operation) { Intrinsics.checkNotNullParameter(operation, "operation"); int $i$f$fold = 0; Object acc = null; acc = initial; FloatList this_$iv = this;
/*      */     int $i$f$forEach = 0;
/* 1002 */     float[] content$iv = this_$iv.content;
/* 1003 */     int i$iv = 0, i = this_$iv._size; if (i$iv < i) {
/* 1004 */       float item = content$iv[i$iv]; int $i$a$-forEach-FloatList$fold$2 = 0; acc = operation.invoke(acc, Float.valueOf(item));
...
/* 1008 */     float[] content$iv = this_$iv.content;
/* 1009 */     int i$iv = 0, i = this_$iv._size; if (i$iv < i) {
/* 1010 */       float f = content$iv[i$iv]; int j = i$iv, $i$a$-forEachIndexed-FloatList$foldIndexed$2 = 0; acc = operation.invoke(Integer.valueOf(j), acc, Float.valueOf(f));
...
/*      */     FloatList this_$iv = this;
/*      */     int $i$f$forEachReversed = 0;
/* 1014 */     float[] content$iv = this_$iv.content;
/* 1015 */     int i$iv = this_$iv._size - 1; if (-1 < i$iv) {
/* 1016 */       float item = content$iv[i$iv]; int $i$a$-forEachReversed-FloatList$foldRight$2 = 0; acc = operation.invoke(Float.valueOf(item), acc);
...
/* 1020 */     float[] content$iv = this_$iv.content;
/* 1021 */     int i$iv = this_$iv._size - 1; if (-1 < i$iv)
/* 1022 */     { float f = content$iv[i$iv]; int i = i$iv, $i$a$-forEachReversedIndexed-FloatList$foldRightIndexed$2 = 0; acc = operation.invoke(Integer.valueOf(i), Float.valueOf(f), acc); }  return (R)acc; }
/*      */   public final void forEach(@NotNull Function1 block) { Intrinsics.checkNotNullParameter(block, "block"); int $i$f$forEach = 0; float[] content = this.content; for (int i = 0, j = this._size; i < j; i++) block.invoke(Float.valueOf(content[i]));  }
/*      */   public final void forEachIndexed(@NotNull Function2 block) { Intrinsics.checkNotNullParameter(block, "block"); int $i$f$forEachIndexed = 0; float[] content = this.content; for (int i = 0, j = this._size; i < j; i++)
/* 1025 */       block.invoke(Integer.valueOf(i), Float.valueOf(content[i]));  } public final float get(@IntRange(from = 0L) int index) { if (!((0 <= index) ? ((index < this._size) ? 1 : 0) : 0)) { FloatList this_$iv = this; int $i$f$getLastIndex = 0; throw new IndexOutOfBoundsException("Index " + index + " must be in 0.." + (this_$iv._size - 1)); }  return this.content[index]; }
/* 1026 */   public final void forEachReversed(@NotNull Function1 block) { Intrinsics.checkNotNullParameter(block, "block"); int $i$f$forEachReversed = 0; float[] content = this.content; for (int i = this._size - 1; -1 < i; i--) block.invoke(Float.valueOf(content[i]));  } public final void forEachReversedIndexed(@NotNull Function2 block) { Intrinsics.checkNotNullParameter(block, "block"); int $i$f$forEachReversedIndexed = 0; float[] content = this.content; for (int i = this._size - 1; -1 < i; i--) block.invoke(Integer.valueOf(i), Float.valueOf(content[i]));  } public final float elementAt(@IntRange(from = 0L) int index) { if (!((0 <= index) ? ((index < this._size) ? 1 : 0) : 0)) { FloatList this_$iv = this; int $i$f$getLastIndex = 0; throw new IndexOutOfBoundsException("Index " + index + " must be in 0.." + (this_$iv._size - 1)); }  return this.content[index]; } public final float elementAtOrElse(@IntRange(from = 0L) int index, @NotNull Function1 defaultValue) { Intrinsics.checkNotNullParameter(defaultValue, "defaultValue"); int $i$f$elementAtOrElse = 0; if (!((0 <= index) ? ((index < this._size) ? 1 : 0) : 0))
/*      */       return ((Number)defaultValue.invoke(Integer.valueOf(index))).floatValue();  return this.content[index]; }
/* 1028 */   public final int indexOf(float element) { FloatList this_$iv = this; int $i$f$forEachIndexed = 0; float[] content$iv = this_$iv.content;
/* 1029 */     int i$iv = 0, i = this_$iv._size; if (i$iv < i) {
/* 1030 */       float f = content$iv[i$iv]; int j = i$iv, $i$a$-forEachIndexed-FloatList$indexOf$1 = 0; if ((element == f))
/*      */         return j; 
/*      */     }  return -1; } public final int indexOfFirst(@NotNull Function1 predicate) { Intrinsics.checkNotNullParameter(predicate, "predicate"); int $i$f$indexOfFirst = 0; FloatList this_$iv = this;
/*      */     int $i$f$forEachIndexed = 0;
/* 1034 */     float[] content$iv = this_$iv.content;
/* 1035 */     int i$iv = 0, i = this_$iv._size; if (i$iv < i) {
/* 1036 */       float f = content$iv[i$iv]; int j = i$iv, $i$a$-forEachIndexed-FloatList$indexOfFirst$2 = 0; if (((Boolean)predicate.invoke(Float.valueOf(f))).booleanValue())
/*      */         return j; 
/*      */     }  return -1; } public final int indexOfLast(@NotNull Function1 predicate) { Intrinsics.checkNotNullParameter(predicate, "predicate"); int $i$f$indexOfLast = 0; FloatList this_$iv = this;
/*      */     int $i$f$forEachReversedIndexed = 0;
/* 1040 */     float[] content$iv = this_$iv.content;
/* 1041 */     int i$iv = this_$iv._size - 1; if (-1 < i$iv)
/* 1042 */     { float f = content$iv[i$iv]; int i = i$iv, $i$a$-forEachReversedIndexed-FloatList$indexOfLast$2 = 0; if (((Boolean)predicate.invoke(Float.valueOf(f))).booleanValue()) return i;  }  return -1; } public final boolean isEmpty() { return (this._size == 0); }
/*      */   public final boolean isNotEmpty() { return (this._size != 0); }
/*      */   public final float last() { if (isEmpty())
/* 1045 */       throw new NoSuchElementException("FloatList is empty.");  FloatList this_$iv = this; int $i$f$getLastIndex = 0; return this.content[this_$iv._size - 1]; } public final float last(@NotNull Function1 predicate) { Intrinsics.checkNotNullParameter(predicate, "predicate"); int $i$f$last = 0; FloatList this_$iv = this;
/*      */     int $i$f$forEachReversed = 0;
/* 1047 */     float[] content$iv = this_$iv.content;
/* 1048 */     int i$iv = this_$iv._size - 1; if (-1 < i$iv) {
/* 1049 */       float item = content$iv[i$iv]; int $i$a$-forEachReversed-FloatList$last$2 = 0; if (((Boolean)predicate.invoke(Float.valueOf(item))).booleanValue())
/*      */         return item; 
/*      */     }  throw new NoSuchElementException("FloatList contains no element matching the predicate."); } public final int lastIndexOf(float element) { FloatList this_$iv = this;
/*      */     int $i$f$forEachReversedIndexed = 0;
/* 1053 */     float[] content$iv = this_$iv.content;
/* 1054 */     int i$iv = this_$iv._size - 1; if (-1 < i$iv) {
/* 1055 */       float f = content$iv[i$iv]; int i = i$iv, $i$a$-forEachReversedIndexed-FloatList$lastIndexOf$1 = 0; if ((f == element))
/*      */         return i; 
/*      */     }  return -1; } @JvmOverloads @NotNull public final String joinToString(@NotNull CharSequence separator, @NotNull CharSequence prefix, @NotNull CharSequence postfix, int limit, @NotNull CharSequence truncated) { Intrinsics.checkNotNullParameter(separator, "separator"); Intrinsics.checkNotNullParameter(prefix, "prefix"); Intrinsics.checkNotNullParameter(postfix, "postfix"); Intrinsics.checkNotNullParameter(truncated, "truncated"); StringBuilder stringBuilder1 = new StringBuilder(), $this$joinToString_u24lambda_u2430 = stringBuilder1; int $i$a$-buildString-FloatList$joinToString$1 = 0; $this$joinToString_u24lambda_u2430.append(prefix); FloatList this_$iv = this;
/*      */     int $i$f$forEachIndexed = 0;
/* 1059 */     float[] content$iv = this_$iv.content;
...
/*      */     int $i$a$-buildString-FloatList$joinToString$2 = 0;
/*      */     $this$joinToString_u24lambda_u2432.append(prefix);
/*      */     FloatList this_$iv = this;
/*      */     int $i$f$forEachIndexed = 0;
/* 1065 */     float[] content$iv = this_$iv.content;
...
/*      */     FloatList this_$iv = this;
/*      */     int $i$f$forEach = 0;
/* 1071 */     float[] content$iv = this_$iv.content;
/* 1072 */     int i$iv = 0, i = this_$iv._size; if (i$iv < i) {
/* 1073 */       float element = content$iv[i$iv]; int $i$a$-forEach-FloatList$hashCode$1 = 0; hashCode += 31 * Float.hashCode(element);
/*      */     }  return hashCode; } public boolean equals(@Nullable Object other) { if (!(other instanceof FloatList) || ((FloatList)other)._size != this._size)
/*      */       return false;  float[] content = this.content; float[] otherContent = ((FloatList)other).content; FloatList this_$iv = this; int $i$f$getIndices = 0;
/* 1076 */     IntRange intRange = RangesKt.until(0, this_$iv._size); int i = intRange.getFirst(); $i$f$getIndices = intRange.getLast(); if (i <= $i$f$getIndices) while (true) { if (!((content[i] == otherContent[i]) ? 1 : 0)) return false;  if (i != $i$f$getIndices) { i++; continue; }  break; }   return true; } @NotNull public String toString() { return joinToString$default(this, null, "[", "]", 0, null, 25, null); }
...
/*      */     int i = 0;
/* 1084 */     StringBuilder stringBuilder1 = new StringBuilder(), $this$joinToString_u24lambda_u2432$iv = stringBuilder1; int $i$a$-buildString-FloatList$joinToString$2$iv = 0;
/* 1085 */     $this$joinToString_u24lambda_u2432$iv.append(prefix);
/* 1086 */     FloatList this_$iv$iv = this; int $i$f$forEachIndexed = 0;
/*      */     
/* 1088 */     float[] content$iv$iv = this_$iv$iv.content;
/* 1089 */     int i$iv$iv = 0, j = this_$iv$iv._size; if (i$iv$iv < j) {
/* 1090 */       float f = content$iv$iv[i$iv$iv]; int index$iv = i$iv$iv, $i$a$-forEachIndexed-FloatList$joinToString$2$1$iv = 0;
...
/*      */         }
/* 1098 */         $this$joinToString_u24lambda_u2432$iv.append((CharSequence)transform.invoke(Float.valueOf(f)));
/*      */       } 
/*      */     } else {
...
/*      */     int i = 0;
/* 1110 */     StringBuilder stringBuilder1 = new StringBuilder(), $this$joinToString_u24lambda_u2432$iv = stringBuilder1; int $i$a$-buildString-FloatList$joinToString$2$iv = 0;
/* 1111 */     $this$joinToString_u24lambda_u2432$iv.append(prefix);
/* 1112 */     FloatList this_$iv$iv = this; int $i$f$forEachIndexed = 0;
/*      */     
/* 1114 */     float[] content$iv$iv = this_$iv$iv.content;
/* 1115 */     int i$iv$iv = 0, j = this_$iv$iv._size; if (i$iv$iv < j) {
/* 1116 */       float f = content$iv$iv[i$iv$iv]; int index$iv = i$iv$iv, $i$a$-forEachIndexed-FloatList$joinToString$2$1$iv = 0;
...
/*      */         }
/* 1124 */         $this$joinToString_u24lambda_u2432$iv.append((CharSequence)transform.invoke(Float.valueOf(f)));
/*      */       } 
/*      */     } else {
...
/*      */     int i = 0;
/* 1136 */     StringBuilder stringBuilder1 = new StringBuilder(), $this$joinToString_u24lambda_u2432$iv = stringBuilder1; int $i$a$-buildString-FloatList$joinToString$2$iv = 0;
/* 1137 */     $this$joinToString_u24lambda_u2432$iv.append(prefix);
/* 1138 */     FloatList this_$iv$iv = this; int $i$f$forEachIndexed = 0;
/*      */     
/* 1140 */     float[] content$iv$iv = this_$iv$iv.content;
/* 1141 */     int i$iv$iv = 0, j = this_$iv$iv._size; if (i$iv$iv < j) {
/* 1142 */       float f = content$iv$iv[i$iv$iv]; int index$iv = i$iv$iv, $i$a$-forEachIndexed-FloatList$joinToString$2$1$iv = 0;
...
/*      */         }
/* 1150 */         $this$joinToString_u24lambda_u2432$iv.append((CharSequence)transform.invoke(Float.valueOf(f)));
/*      */       } 
/*      */     } else {
...
/*      */     int i = 0;
/* 1162 */     StringBuilder stringBuilder1 = new StringBuilder(), $this$joinToString_u24lambda_u2432$iv = stringBuilder1; int $i$a$-buildString-FloatList$joinToString$2$iv = 0;
/* 1163 */     $this$joinToString_u24lambda_u2432$iv.append(prefix$iv);
/* 1164 */     FloatList this_$iv$iv = this; int $i$f$forEachIndexed = 0;
/*      */     
/* 1166 */     float[] content$iv$iv = this_$iv$iv.content;
/* 1167 */     int i$iv$iv = 0, j = this_$iv$iv._size; if (i$iv$iv < j) {
/* 1168 */       float f = content$iv$iv[i$iv$iv]; int index$iv = i$iv$iv, $i$a$-forEachIndexed-FloatList$joinToString$2$1$iv = 0;
...
/*      */         }
/* 1176 */         $this$joinToString_u24lambda_u2432$iv.append((CharSequence)transform.invoke(Float.valueOf(f)));
/*      */       } 
/*      */     } else {
...
/*      */     int i = 0;
/* 1188 */     StringBuilder stringBuilder1 = new StringBuilder(), $this$joinToString_u24lambda_u2432$iv = stringBuilder1; int $i$a$-buildString-FloatList$joinToString$2$iv = 0;
/* 1189 */     $this$joinToString_u24lambda_u2432$iv.append(prefix$iv);
/* 1190 */     FloatList this_$iv$iv = this; int $i$f$forEachIndexed = 0;
/*      */     
/* 1192 */     float[] content$iv$iv = this_$iv$iv.content;
/* 1193 */     int i$iv$iv = 0, j = this_$iv$iv._size; if (i$iv$iv < j) {
/* 1194 */       float f = content$iv$iv[i$iv$iv]; int index$iv = i$iv$iv, $i$a$-forEachIndexed-FloatList$joinToString$2$1$iv = 0;
...
/*      */         }
/* 1202 */         $this$joinToString_u24lambda_u2432$iv.append((CharSequence)transform.invoke(Float.valueOf(f)));
/*      */       } 
/*      */     } else {
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\collection-jvm-1.4.0.jar!\androidx\collection\FloatList.class
