...
/*      */ 
/*      */ 
/*      */ @Metadata(mv = {1, 8, 0}, k = 1, xi = 48, d1 = {"\000.\n\002\030\002\n\002\030\002\n\000\n\002\020\b\n\002\b\003\n\002\020\013\n\002\b\003\n\002\020\025\n\000\n\002\020\002\n\002\b\023\n\002\020\t\n\000\030\0002\0020\001B\017\022\b\b\002\020\002\032\0020\003¢\006\002\020\004J\016\020\006\032\0020\0072\006\020\b\032\0020\003J\016\020\t\032\0020\0072\006\020\n\032\0020\001J\016\020\t\032\0020\0072\006\020\n\032\0020\013J\b\020\f\032\0020\rH\002J\006\020\016\032\0020\rJ\020\020\017\032\0020\0032\006\020\b\032\0020\003H\002J\020\020\020\032\0020\0032\006\020\021\032\0020\003H\002J\b\020\022\032\0020\rH\002J\020\020\023\032\0020\r2\006\020\024\032\0020\003H\002J\020\020\025\032\0020\r2\006\020\002\032\0020\003H\002J\021\020\026\032\0020\r2\006\020\n\032\0020\001H\002J\021\020\026\032\0020\r2\006\020\b\032\0020\003H\002J\021\020\026\032\0020\r2\006\020\n\032\0020\013H\002J\021\020\027\032\0020\r2\006\020\n\032\0020\001H\002J\021\020\027\032\0020\r2\006\020\b\032\0020\003H\002J\021\020\027\032\0020\r2\006\020\n\032\0020\013H\002J\016\020\030\032\0020\0072\006\020\b\032\0020\003J\016\020\031\032\0020\0072\006\020\n\032\0020\001J\016\020\031\032\0020\0072\006\020\n\032\0020\013J\020\020\032\032\0020\r2\006\020\033\032\0020\003H\002J\020\020\034\032\0020\r2\006\020\035\032\0020\003H\002J\b\020\036\032\0020\003H\007J\031\020\037\032\0020\r2\006\020\033\032\0020\0032\006\020 \032\0020!H\bR\016\020\005\032\0020\003X\016¢\006\002\n\000¨\006\""}, d2 = {"Landroidx/collection/MutableIntSet;", "Landroidx/collection/IntSet;", "initialCapacity", "", "(I)V", "growthLimit", "add", "", "element", "addAll", "elements", "", "adjustStorage", "", "clear", "findAbsoluteInsertIndex", "findFirstAvailableSlot", "hash1", "initializeGrowth", "initializeMetadata", "capacity", "initializeStorage", "minusAssign", "plusAssign", "remove", "removeAll", "removeElementAt", "index", "resizeStorage", "newCapacity", "trim", "writeMetadata", "value", "", "collection"})
...
/*      */ 
/*      */       
/*  838 */       int $i$a$-require-MutableIntSet$1 = 0; String str = "Capacity must be a positive value."; throw new IllegalArgumentException(str.toString()); }  initializeStorage(ScatterMapKt.unloadedCapacity(initialCapacity));
/*  839 */   } private final void initializeStorage(int initialCapacity) { int newCapacity = (initialCapacity > 0) ? Math.max(7, ScatterMapKt.normalizeCapacity(initialCapacity)) : 0; this._capacity = newCapacity; initializeMetadata(newCapacity); this.elements = new int[newCapacity]; } private final void initializeMetadata(int capacity) { int size = (capacity + 1 + 7 + 7 & 0xFFFFFFF8) >> 3; long[] arrayOfLong2 = new long[size], arrayOfLong3 = arrayOfLong2; MutableIntSet mutableIntSet = this; int $i$a$-apply-MutableIntSet$initializeMetadata$1 = 0; ArraysKt.fill$default(arrayOfLong3, -9187201950435737472L, 0, 0, 6, null); mutableIntSet.metadata = (capacity == 0) ? ScatterMapKt.EmptyGroup : arrayOfLong2; long arrayOfLong1[] = this.metadata, value$iv = 255L; int $i$f$writeRawMetadata = 0; int i$iv = capacity >> 3;
/*  840 */     int b$iv = (capacity & 0x7) << 3;
/*      */ 
/*      */     
/*  843 */     arrayOfLong1[i$iv] = arrayOfLong1[i$iv] & (255L << b$iv ^ 0xFFFFFFFFFFFFFFFFL) | value$iv << b$iv; initializeGrowth(); } private final void initializeGrowth() { this.growthLimit = ScatterMapKt.loadedCapacity(getCapacity()) - this._size; } public final boolean add(int element) { int oldSize = this._size; int index = findAbsoluteInsertIndex(element); this.elements[index] = element; return (this._size != oldSize); } public final void plusAssign(int element) { int index = findAbsoluteInsertIndex(element); this.elements[index] = element; }
/*      */   public final boolean addAll(@NotNull int[] elements) { Intrinsics.checkNotNullParameter(elements, "elements"); int oldSize = this._size; plusAssign(elements); return (oldSize != this._size); }
/*  845 */   public final void plusAssign(@NotNull int[] elements) { Intrinsics.checkNotNullParameter(elements, "elements"); int $this$forEach$iv[] = elements, $i$f$forEach = 0; byte b = 0; int i = $this$forEach$iv.length; if (b < i) { int element$iv = $this$forEach$iv[b], element = element$iv, $i$a$-forEach-MutableIntSet$plusAssign$1 = 0; plusAssign(element); }
/*      */      } public final boolean addAll(@NotNull IntSet elements) { Intrinsics.checkNotNullParameter(elements, "elements"); int oldSize = this._size; plusAssign(elements); return (oldSize != this._size); }
/*      */   public final void plusAssign(@NotNull IntSet elements) { Intrinsics.checkNotNullParameter(elements, "elements"); IntSet this_$iv = elements; int $i$f$forEach = 0;
/*  848 */     int[] k$iv = this_$iv.elements;
/*      */     
/*  850 */     IntSet this_$iv$iv = this_$iv; int $i$f$forEachIndex = 0;
/*      */     
...
/*      */     // Byte code:
/*      */     //   0: aload_0
/*      */     //   1: checkcast androidx/collection/IntSet
/*      */     //   4: astore_3
/*      */     //   5: iconst_0
/*      */     //   6: istore #4
/*      */     //   8: iconst_0
...
/*      */     //   308: aload_0
/*      */     //   309: iload_2
/*      */     //   310: invokespecial removeElementAt : (I)V
/*      */     //   313: iload_3
/*      */     //   314: ireturn
/*      */     // Line number table:
...
/*      */     //   119	170	14	g$iv	J
/*      */     //   157	132	21	m$iv	J
/*      */     //   8	285	4	$i$f$findElementIndex$collection	I
/*      */     //   30	263	7	hash$iv	I
/*      */     //   40	253	5	hash2$iv	I
/*      */     //   46	247	6	probeMask$iv	I
/*      */     //   59	234	9	probeOffset$iv	I
/*      */     //   62	231	8	probeIndex$iv	I
/*      */     //   5	288	3	this_$iv	Landroidx/collection/IntSet;
/*      */     //   294	21	2	index	I
/*      */     //   304	11	3	exists	Z
/*      */     //   0	315	0	this	Landroidx/collection/MutableIntSet;
/*      */     //   0	315	1	element	I
/*      */   }
/*      */ 
/*      */ 
...
/*      */     //   298: aload_0
/*      */     //   299: iload_2
/*      */     //   300: invokespecial removeElementAt : (I)V
/*      */     //   303: return
/*      */     // Line number table:
/*      */     //   Java source line number -> byte code offset
/*      */     //   #620	-> 0
...
/*      */     //   5	288	3	this_$iv	Landroidx/collection/IntSet;
/*      */     //   294	10	2	index	I
/*      */     //   0	304	0	this	Landroidx/collection/MutableIntSet;
/*      */     //   0	304	1	element	I
/*      */   }
/*      */ 
/*      */ 
...
/*      */     Intrinsics.checkNotNullParameter(elements, "elements");
/*      */     int $this$forEach$iv[] = elements, $i$f$forEach = 0;
/*  952 */     byte b = 0; int i = $this$forEach$iv.length; if (b < i) { int element$iv = $this$forEach$iv[b], element = element$iv, $i$a$-forEach-MutableIntSet$minusAssign$1 = 0; minusAssign(element); }
/*      */   
/*      */   } public final boolean removeAll(@NotNull IntSet elements) { Intrinsics.checkNotNullParameter(elements, "elements"); int oldSize = this._size; minusAssign(elements); return (oldSize != this._size); } public final void minusAssign(@NotNull IntSet elements) { Intrinsics.checkNotNullParameter(elements, "elements"); IntSet this_$iv = elements; int $i$f$forEach = 0;
/*  955 */     int[] k$iv = this_$iv.elements;
/*      */     
/*  957 */     IntSet this_$iv$iv = this_$iv; int $i$f$forEachIndex = 0;
/*      */     
...
/*      */       }  }
/*      */     else {  }
/*  981 */      } private final void removeElementAt(int index) { this._size--; MutableIntSet mutableIntSet = this; long value$iv = 254L; int $i$f$writeMetadata = 0; long[] m$iv = mutableIntSet.metadata;
...
/*      */     
/*  989 */     int c$iv = mutableIntSet._capacity;
...
/*      */     }  initializeGrowth(); } private final int findAbsoluteInsertIndex(int element) { int $i$f$hash = 0;
/* 1000 */     int hash$iv = Integer.hashCode(element) * -862048943;
/*      */     
...
/* 1019 */       metadata$iv[index >> 3] >> (index & 0x7) << 3 & 0xFFL) == 128L)) ? 1 : 0; MutableIntSet mutableIntSet = this; long value$iv = hash2; int $i$f$writeMetadata = 0;
/* 1020 */     long[] m$iv = mutableIntSet.metadata;
...
/*      */     
/* 1028 */     int c$iv = mutableIntSet._capacity;
...
/* 1038 */   @IntRange(from = 0L) public final int trim() { int previousCapacity = this._capacity; int newCapacity = ScatterMapKt.normalizeCapacity(ScatterMapKt.unloadedCapacity(this._size)); if (newCapacity < previousCapacity) { resizeStorage(newCapacity); return previousCapacity - this._capacity; }  return 0; } private final void resizeStorage(int newCapacity) { long[] previousMetadata = this.metadata; int[] previousElements = this.elements; int previousCapacity = this._capacity; initializeStorage(newCapacity); int[] newElements = this.elements; for (int i = 0; i < previousCapacity; i++) { int $i$f$isFull = 0; int $i$f$readRawMetadata = 0; if (((
/* 1039 */         previousMetadata[i >> 3] >> (i & 0x7) << 3 & 0xFFL) < 128L))
/* 1040 */       { int previousElement = previousElements[i]; int $i$f$hash = 0; int hash$iv = Integer.hashCode(previousElement) * -862048943;
/*      */         
/* 1042 */         int hash = hash$iv ^ hash$iv << 16;
/* 1043 */         int $i$f$h1 = 0, index = findFirstAvailableSlot(hash >>> 7); MutableIntSet mutableIntSet = this; int $i$f$h2 = 0;
/* 1044 */         long value$iv = (hash & 0x7F); int $i$f$writeMetadata = 0;
/* 1045 */         long[] m$iv = mutableIntSet.metadata;
...
/*      */         
/* 1053 */         int c$iv = mutableIntSet._capacity;
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\collection-jvm-1.4.0.jar!\androidx\collection\MutableIntSet.class
