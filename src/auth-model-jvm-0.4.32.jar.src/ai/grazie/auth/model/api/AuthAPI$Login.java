...
/*     */ public final class Login implements UnitTypedApi<Unit> {
/*     */   @NotNull
/*  13 */   public static final Login INSTANCE = new Login(); @NotNull private static final TypeInfo<Unit> responseType; @NotNull private static final String path = "/auth/login"; @NotNull public String getPath() { return path; } @NotNull
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\auth-model-jvm-0.4.32.jar!\ai\grazie\auth\model\api\AuthAPI$Login.class
