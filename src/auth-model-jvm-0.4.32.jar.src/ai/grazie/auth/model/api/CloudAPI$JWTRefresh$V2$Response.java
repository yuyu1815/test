...
/*    */   
/* 28 */   public Response(@NotNull String token) { this.token = token; } @NotNull private final String token; @NotNull public final String getToken() { return this.token; }
/*    */ 
/*    */   
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\auth-model-jvm-0.4.32.jar!\ai\grazie\auth\model\api\CloudAPI$JWTRefresh$V2$Response.class
