...
/*     */   {
/*     */     @NotNull
/* 244 */     public static final Auth INSTANCE = new Auth(); @NotNull private static final String path = "/auth/browser-extension/login/auth"; @NotNull public String getPath() { return path; } @NotNull
/* 245 */     private static final HttpMethod httpMethod = HttpMethod.Get; @NotNull private static final TypeInfo<Unit> responseType; @NotNull public HttpMethod getHttpMethod() { return httpMethod; } @NotNull
