...
/*     */ {
/*     */   @NotNull
/* 250 */   public static final Token INSTANCE = new Token(); @NotNull private static final String path = "/auth/browser-extension/login/token"; @NotNull public String getPath() { return path; } @NotNull private static final TypeInfo<Unit> responseType; @NotNull
/* 251 */   private static final HttpMethod httpMethod = HttpMethod.Get; @NotNull public HttpMethod getHttpMethod() { return httpMethod; } @NotNull
/* 252 */   public TypeInfo<Unit> getResponseType() { return responseType; } static { int $i$f$typeInfo = 0;
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\auth-model-jvm-0.4.32.jar!\ai\grazie\auth\model\api\AuthAPI$Extension$Login$Token.class
