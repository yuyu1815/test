...
/*     */ {
/*     */   @NotNull
/* 262 */   public static final Error INSTANCE = new Error(); @NotNull private static final String path = "/auth/browser-extension/login/error"; @NotNull public String getPath() { return path; } @NotNull private static final TypeInfo<Unit> responseType; @NotNull
/* 263 */   private static final HttpMethod httpMethod = HttpMethod.Get; @NotNull public HttpMethod getHttpMethod() { return httpMethod; } @NotNull
/* 264 */   public TypeInfo<Unit> getResponseType() { return responseType; } static { int $i$f$typeInfo = 0;
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\auth-model-jvm-0.4.32.jar!\ai\grazie\auth\model\api\AuthAPI$Extension$Login$Error.class
