...
/*     */ 
/*     */ 
/*     */ @Deprecated(message = "Invite mechanism is deprecated")
...
/*     */   implements TypedApi<AuthAPI.JetBrainsJWT.Invite.Request, AuthAPI.JetBrainsJWT.Invite.Response>
/*     */ {
/*     */   @NotNull
/* 125 */   public static final Invite INSTANCE = new Invite(); @NotNull private static final TypeInfo<Request> requestType; @NotNull private static final String path = "/auth/jetbrains-jwt/invite"; @NotNull private static final TypeInfo<Response> responseType; @NotNull public String getPath() { return path; } @NotNull
/* 126 */   public TypeInfo<Request> getRequestType() { return requestType; } static { int $i$f$typeInfo = 0;
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */     
/*     */     public Request(@NotNull String inviteCode) {
...
/*     */       
/*     */       @NotNull
/*     */       public AuthAPI.JetBrainsJWT.Invite.Request deserialize(@NotNull Decoder decoder) {
...
/*     */         return new AuthAPI.JetBrainsJWT.Invite.Request(i, str, null);
/*     */       }
/*     */       
/*     */       public void serialize(@NotNull Encoder encoder, @NotNull AuthAPI.JetBrainsJWT.Invite.Request value) {
/*     */         Intrinsics.checkNotNullParameter(encoder, "encoder");
/*     */         Intrinsics.checkNotNullParameter(value, "value");
/*     */         SerialDescriptor serialDescriptor = getDescriptor();
/*     */         CompositeEncoder compositeEncoder = encoder.beginStructure(serialDescriptor);
/*     */         AuthAPI.JetBrainsJWT.Invite.Request.write$Self$auth_model(value, compositeEncoder, serialDescriptor);
/*     */         compositeEncoder.endStructure(serialDescriptor);
/*     */       }
/*     */       
/*     */       static {
/*     */         PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("ai.grazie.auth.model.api.AuthAPI.JetBrainsJWT.Invite.Request", INSTANCE, 1);
/*     */         pluginGeneratedSerialDescriptor.addElement("inviteCode", false);
...
/*     */       
/*     */       @NotNull
/*     */       public final KSerializer<AuthAPI.JetBrainsJWT.Invite.Request> serializer() {
/*     */         return (KSerializer<AuthAPI.JetBrainsJWT.Invite.Request>)AuthAPI.JetBrainsJWT.Invite.Request.$serializer.INSTANCE;
/*     */       }
/*     */     }
/*     */     
/*     */     @NotNull
...
/*     */     
/*     */     @NotNull
/*     */     public final Request copy(@NotNull String inviteCode) {
/*     */       Intrinsics.checkNotNullParameter(inviteCode, "inviteCode");
/*     */       return new Request(inviteCode);
/*     */     }
/*     */     
/*     */     @NotNull
/*     */     public String toString() {
/*     */       return "Request(inviteCode=" + this.inviteCode + ")";
/*     */     }
/*     */     
/*     */     public int hashCode() {
...
/*     */       return !!Intrinsics.areEqual(this.inviteCode, request.inviteCode);
/*     */     }
/*     */   }
/*     */   
/*     */   @Serializable
...
/*     */       @NotNull
/*     */       public KSerializer<?>[] childSerializers() {
/*     */         KSerializer[] arrayOfKSerializer1 = (KSerializer[])AuthAPI.JetBrainsJWT.Invite.Response.$childSerializers, arrayOfKSerializer2 = new KSerializer[1];
/*     */         arrayOfKSerializer2[0] = arrayOfKSerializer1[0];
/*     */         return (KSerializer<?>[])arrayOfKSerializer2;
/*     */       }
/*     */       
/*     */       @NotNull
/*     */       public AuthAPI.JetBrainsJWT.Invite.Response deserialize(@NotNull Decoder decoder) {
/*     */         Intrinsics.checkNotNullParameter(decoder, "decoder");
/*     */         SerialDescriptor serialDescriptor = getDescriptor();
/*     */         boolean bool = true;
/*     */         int i = 0;
...
/*     */         CompositeDecoder compositeDecoder = decoder.beginStructure(serialDescriptor);
/*     */         KSerializer[] arrayOfKSerializer = (KSerializer[])AuthAPI.JetBrainsJWT.Invite.Response.$childSerializers;
/*     */         if (compositeDecoder.decodeSequentially()) {
...
/*     */         } 
/*     */         compositeDecoder.endStructure(serialDescriptor);
/*     */         return new AuthAPI.JetBrainsJWT.Invite.Response(i, grazieUserState, null);
/*     */       }
/*     */       
/*     */       public void serialize(@NotNull Encoder encoder, @NotNull AuthAPI.JetBrainsJWT.Invite.Response value) {
/*     */         Intrinsics.checkNotNullParameter(encoder, "encoder");
/*     */         Intrinsics.checkNotNullParameter(value, "value");
/*     */         SerialDescriptor serialDescriptor = getDescriptor();
/*     */         CompositeEncoder compositeEncoder = encoder.beginStructure(serialDescriptor);
/*     */         AuthAPI.JetBrainsJWT.Invite.Response.write$Self$auth_model(value, compositeEncoder, serialDescriptor);
/*     */         compositeEncoder.endStructure(serialDescriptor);
/*     */       }
/*     */       
/*     */       static {
/*     */         PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("ai.grazie.auth.model.api.AuthAPI.JetBrainsJWT.Invite.Response", INSTANCE, 1);
/*     */         pluginGeneratedSerialDescriptor.addElement("state", false);
/*     */         descriptor = pluginGeneratedSerialDescriptor;
/*     */       }
/*     */     }
/*     */     
/*     */     @Metadata(mv = {1, 7, 0}, k = 1, xi = 48, d1 = {"\000\026\n\002\030\002\n\002\020\000\n\002\b\002\n\002\030\002\n\002\030\002\n\000\b\003\030\0002\0020\001B\007\b\002¢\006\002\020\002J\017\020\003\032\b\022\004\022\0020\0050\004HÆ\001¨\006\006"}, d2 = {"Lai/grazie/auth/model/api/AuthAPI$JetBrainsJWT$Invite$Response$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lai/grazie/auth/model/api/AuthAPI$JetBrainsJWT$Invite$Response;", "auth-model"})
/*     */     public static final class Companion {
/*     */       private Companion() {}
/*     */       
/*     */       @NotNull
/*     */       public final KSerializer<AuthAPI.JetBrainsJWT.Invite.Response> serializer() {
/*     */         return (KSerializer<AuthAPI.JetBrainsJWT.Invite.Response>)AuthAPI.JetBrainsJWT.Invite.Response.$serializer.INSTANCE;
/*     */       }
/*     */     }
/*     */     
/*     */     @NotNull
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\auth-model-jvm-0.4.32.jar!\ai\grazie\auth\model\api\AuthAPI$JetBrainsJWT$Invite.class
