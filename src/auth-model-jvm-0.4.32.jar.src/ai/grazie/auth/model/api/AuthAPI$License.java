...
/*     */   {
/*     */     @NotNull
/* 187 */     public static final Declined INSTANCE = new Declined(); @NotNull private static final String path = "/auth/license/declined"; @NotNull private static final TypeInfo<Unit> responseType; @NotNull public String getPath() { return path; } @NotNull
/* 188 */     public TypeInfo<Unit> getResponseType() { return responseType; } @NotNull private static final HttpMethod httpMethod = HttpMethod.Get; static { int $i$f$typeInfo = 0;
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 284 */       responseType = new TypeInfo(kType$iv, Reflection.getOrCreateKotlinClass(Unit.class)); } @NotNull public HttpMethod getHttpMethod() { return httpMethod; } } @Metadata(mv = {1, 7, 0}, k = 1, xi = 48, d1 = {"\000(\n\002\030\002\n\002\030\002\n\002\020\002\n\002\b\002\n\002\030\002\n\002\b\003\n\002\020\016\n\002\b\003\n\002\030\002\n\002\b\003\bÆ\002\030\0002\b\022\004\022\0020\0020\001B\007\b\002¢\006\002\020\003R\024\020\004\032\0020\005X\004¢\006\b\n\000\032\004\b\006\020\007R\024\020\b\032\0020\tXD¢\006\b\n\000\032\004\b\n\020\013R\032\020\f\032\b\022\004\022\0020\0020\rX\004¢\006\b\n\000\032\004\b\016\020\017¨\006\020"}, d2 = {"Lai/grazie/auth/model/api/AuthAPI$License$Failure;", "Lai/grazie/model/cloud/UnitTypedApi;", "", "()V", "httpMethod", "Lai/grazie/model/cloud/HttpMethod;", "getHttpMethod", "()Lai/grazie/model/cloud/HttpMethod;", "path", "", "getPath", "()Ljava/lang/String;", "responseType", "Lai/grazie/model/cloud/TypeInfo;", "getResponseType", "()Lai/grazie/model/cloud/TypeInfo;", "auth-model"}) @SourceDebugExtension({"SMAP\nAuthAPI.kt\nKotlin\n*S Kotlin\n*F\n+ 1 AuthAPI.kt\nai/grazie/auth/model/api/AuthAPI$License$Failure\n+ 2 TypedApi.kt\nai/grazie/model/cloud/TypedApiKt\n*L\n1#1,282:1\n19#2,2:283\n*S KotlinDebug\n*F\n+ 1 AuthAPI.kt\nai/grazie/auth/model/api/AuthAPI$License$Failure\n*L\n194#1:283,2\n*E\n"}) public static final class Failure implements UnitTypedApi<Unit> { static { int $i$f$typeInfo = 0; KType kType$iv = Reflection.typeOf(Unit.class); responseType = new TypeInfo(kType$iv, Reflection.getOrCreateKotlinClass(Unit.class)); }
/*     */ 
/*     */     
/*     */     @NotNull
/*     */     public static final Failure INSTANCE = new Failure();
/*     */     @NotNull
/*     */     private static final String path = "/auth/license/failure";
/*     */     @NotNull
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\auth-model-jvm-0.4.32.jar!\ai\grazie\auth\model\api\AuthAPI$License.class
