...
/* 34 */   public GrazieAiChatTaskParams(@NotNull TasksChat history, @NotNull List<String> functions) { this.history = history;
/*    */ 
/*    */ 
/*    */     
...
/*    */   public static final class $serializer implements GeneratedSerializer<GrazieAiChatTaskParams> {
/*    */     @NotNull
...
/*    */       KSerializer[] arrayOfKSerializer1 = (KSerializer[])GrazieAiChatTaskParams.$childSerializers, arrayOfKSerializer2 = new KSerializer[2];
...
/*    */     
/*    */     @NotNull
/*    */     public GrazieAiChatTaskParams deserialize(@NotNull Decoder decoder) {
...
/*    */       KSerializer[] arrayOfKSerializer = (KSerializer[])GrazieAiChatTaskParams.$childSerializers;
...
/*    */       return new GrazieAiChatTaskParams(i, tasksChat, list, null);
/*    */     }
/*    */     
/*    */     public void serialize(@NotNull Encoder encoder, @NotNull GrazieAiChatTaskParams value) {
/*    */       Intrinsics.checkNotNullParameter(encoder, "encoder");
/*    */       Intrinsics.checkNotNullParameter(value, "value");
/*    */       SerialDescriptor serialDescriptor = getDescriptor();
/*    */       CompositeEncoder compositeEncoder = encoder.beginStructure(serialDescriptor);
/*    */       GrazieAiChatTaskParams.write$Self$tasks_provider_llm_prompt_velocity_resources(value, compositeEncoder, serialDescriptor);
/*    */       compositeEncoder.endStructure(serialDescriptor);
/*    */     }
/*    */     
/*    */     static {
/*    */       PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("ai.grazie.gen.chatTasks.grazieAiChat.GrazieAiChatTaskParams", INSTANCE, 2);
...
/*    */   }
/*    */   
/*    */   @Metadata(mv = {1, 7, 0}, k = 1, xi = 48, d1 = {"\000\026\n\002\030\002\n\002\020\000\n\002\b\002\n\002\030\002\n\002\030\002\n\000\b\003\030\0002\0020\001B\007\b\002¢\006\002\020\002J\017\020\003\032\b\022\004\022\0020\0050\004HÆ\001¨\006\006"}, d2 = {"Lai/grazie/gen/chatTasks/grazieAiChat/GrazieAiChatTaskParams$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lai/grazie/gen/chatTasks/grazieAiChat/GrazieAiChatTaskParams;", "tasks-provider-llm-prompt-velocity-resources"})
/*    */   public static final class Companion {
/*    */     private Companion() {}
/*    */     
/*    */     @NotNull
/*    */     public final KSerializer<GrazieAiChatTaskParams> serializer() {
/*    */       return (KSerializer<GrazieAiChatTaskParams>)GrazieAiChatTaskParams.$serializer.INSTANCE;
/*    */     }
/*    */   }
/*    */   
/*    */   @NotNull
...
/*    */   
/*    */   @NotNull
/*    */   public final GrazieAiChatTaskParams copy(@NotNull TasksChat history, @NotNull List<String> functions) {
/*    */     Intrinsics.checkNotNullParameter(history, "history");
/*    */     Intrinsics.checkNotNullParameter(functions, "functions");
/*    */     return new GrazieAiChatTaskParams(history, functions);
/*    */   }
/*    */   
/*    */   @NotNull
/*    */   public String toString() {
/*    */     return "GrazieAiChatTaskParams(history=" + this.history + ", functions=" + this.functions + ")";
/*    */   }
/*    */   
/*    */   public int hashCode() {
...
/*    */     if (this == other)
/*    */       return true; 
/*    */     if (!(other instanceof GrazieAiChatTaskParams))
/*    */       return false; 
/*    */     GrazieAiChatTaskParams grazieAiChatTaskParams = (GrazieAiChatTaskParams)other;
/*    */     return !Intrinsics.areEqual(this.history, grazieAiChatTaskParams.history) ? false : (!!Intrinsics.areEqual(this.functions, grazieAiChatTaskParams.functions));
/*    */   }
/*    */ }


/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\tasks-provider-llm-prompt-velocity-resources-jvm-0.4.32.jar!\ai\grazie\gen\chatTasks\grazieAiChat\GrazieAiChatTaskParams.class
