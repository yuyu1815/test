...
/* 34 */   public ResharperChatTaskTaskParams(@NotNull TasksChat history, @NotNull List<String> functions) { this.history = history;
/*    */ 
/*    */ 
/*    */     
...
/*    */   public static final class $serializer implements GeneratedSerializer<ResharperChatTaskTaskParams> {
/*    */     @NotNull
...
/*    */       KSerializer[] arrayOfKSerializer1 = (KSerializer[])ResharperChatTaskTaskParams.$childSerializers, arrayOfKSerializer2 = new KSerializer[2];
...
/*    */     
/*    */     @NotNull
/*    */     public ResharperChatTaskTaskParams deserialize(@NotNull Decoder decoder) {
...
/*    */       KSerializer[] arrayOfKSerializer = (KSerializer[])ResharperChatTaskTaskParams.$childSerializers;
...
/*    */       return new ResharperChatTaskTaskParams(i, tasksChat, list, null);
/*    */     }
/*    */     
/*    */     public void serialize(@NotNull Encoder encoder, @NotNull ResharperChatTaskTaskParams value) {
/*    */       Intrinsics.checkNotNullParameter(encoder, "encoder");
/*    */       Intrinsics.checkNotNullParameter(value, "value");
/*    */       SerialDescriptor serialDescriptor = getDescriptor();
/*    */       CompositeEncoder compositeEncoder = encoder.beginStructure(serialDescriptor);
/*    */       ResharperChatTaskTaskParams.write$Self$tasks_provider_llm_prompt_velocity_resources(value, compositeEncoder, serialDescriptor);
/*    */       compositeEncoder.endStructure(serialDescriptor);
/*    */     }
/*    */     
/*    */     static {
/*    */       PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("ai.grazie.gen.chatTasks.resharperChatTask.ResharperChatTaskTaskParams", INSTANCE, 2);
...
/*    */   }
/*    */   
/*    */   @Metadata(mv = {1, 7, 0}, k = 1, xi = 48, d1 = {"\000\026\n\002\030\002\n\002\020\000\n\002\b\002\n\002\030\002\n\002\030\002\n\000\b\003\030\0002\0020\001B\007\b\002¢\006\002\020\002J\017\020\003\032\b\022\004\022\0020\0050\004HÆ\001¨\006\006"}, d2 = {"Lai/grazie/gen/chatTasks/resharperChatTask/ResharperChatTaskTaskParams$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lai/grazie/gen/chatTasks/resharperChatTask/ResharperChatTaskTaskParams;", "tasks-provider-llm-prompt-velocity-resources"})
/*    */   public static final class Companion {
/*    */     private Companion() {}
/*    */     
/*    */     @NotNull
/*    */     public final KSerializer<ResharperChatTaskTaskParams> serializer() {
/*    */       return (KSerializer<ResharperChatTaskTaskParams>)ResharperChatTaskTaskParams.$serializer.INSTANCE;
/*    */     }
/*    */   }
/*    */   
/*    */   @NotNull
...
/*    */   
/*    */   @NotNull
/*    */   public final ResharperChatTaskTaskParams copy(@NotNull TasksChat history, @NotNull List<String> functions) {
/*    */     Intrinsics.checkNotNullParameter(history, "history");
/*    */     Intrinsics.checkNotNullParameter(functions, "functions");
/*    */     return new ResharperChatTaskTaskParams(history, functions);
/*    */   }
/*    */   
/*    */   @NotNull
/*    */   public String toString() {
/*    */     return "ResharperChatTaskTaskParams(history=" + this.history + ", functions=" + this.functions + ")";
/*    */   }
/*    */   
/*    */   public int hashCode() {
...
/*    */     if (this == other)
/*    */       return true; 
/*    */     if (!(other instanceof ResharperChatTaskTaskParams))
/*    */       return false; 
/*    */     ResharperChatTaskTaskParams resharperChatTaskTaskParams = (ResharperChatTaskTaskParams)other;
/*    */     return !Intrinsics.areEqual(this.history, resharperChatTaskTaskParams.history) ? false : (!!Intrinsics.areEqual(this.functions, resharperChatTaskTaskParams.functions));
/*    */   }
/*    */ }


/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\tasks-provider-llm-prompt-velocity-resources-jvm-0.4.32.jar!\ai\grazie\gen\chatTasks\resharperChatTask\ResharperChatTaskTaskParams.class
