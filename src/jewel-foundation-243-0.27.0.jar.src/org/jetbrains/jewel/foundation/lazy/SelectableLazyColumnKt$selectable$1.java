...
/*     */ final class SelectableLazyColumnKt$selectable$1
...
/* 225 */     Object object = IntrinsicsKt.getCOROUTINE_SUSPENDED(); switch (this.label) { case 0: ResultKt.throwOnFailure(SYNTHETIC_LOCAL_VARIABLE_1); $this$pointerInput = (PointerInputScope)this.L$0;
/* 226 */         this.label = 1; if ($this$pointerInput.awaitPointerEventScope(new Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object>(this.$requester, this.$actionHandler, this.$keybindings, this.$selectableState, this.$selectionMode, this.$allKeys, this.$itemKey, null) { int label; public final Object invokeSuspend(Object $result) { // Byte code:
...
/* 226 */                 //   36	120	1	$result	Ljava/lang/Object; } public final Continuation<Unit> create(Object value, Continuation<? super null> $completion) { Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object> function2 = new Function2<>(this.$requester, this.$actionHandler, this.$keybindings, this.$selectableState, this.$selectionMode, this.$allKeys, this.$itemKey, $completion); function2.L$0 = value; return (Continuation)function2; } public final Object invoke(AwaitPointerEventScope p1, Continuation<?> p2) { return ((null)create(p1, p2)).invokeSuspend(Unit.INSTANCE); } }(Continuation)this) == object) return object;  $this$pointerInput.awaitPointerEventScope(new Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object>(this.$requester, this.$actionHandler, this.$keybindings, this.$selectableState, this.$selectionMode, this.$allKeys, this.$itemKey, null) { int label; public final Object invokeSuspend(Object $result) { // Byte code:
/*     */                 //   0: invokestatic getCOROUTINE_SUSPENDED : ()Ljava/lang/Object;
/*     */                 //   3: astore #4
/*     */                 //   5: aload_0
/*     */                 //   6: getfield label : I
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\jewel-foundation-243-0.27.0.jar!\org\jetbrains\jewel\foundation\lazy\SelectableLazyColumnKt$selectable$1.class
