...
/*     */ public final class Node<T> implements Tree.Element<T> {
...
/*     */   @NotNull
/*     */   private final Function1<Node<T>, List<Tree.Element<T>>> childrenGenerator;
/*     */   @Nullable
...
/*     */   @Nullable
/*     */   private List<? extends Tree.Element<T>> children;
...
/*     */   }
/*     */   
/*  70 */   public Node(Object data, int depth, int childIndex, @Nullable Tree.Element<T> parent, @NotNull Function1<Node<T>, List<Tree.Element<T>>> childrenGenerator, @Nullable Tree.Element<T> next, @Nullable Tree.Element<T> previous, @NotNull Object id) { this.data = (T)data;
/*  71 */     this.depth = depth;
...
/*  77 */     this.id = id; } @Nullable public Tree.Element<T> getPrevious() { return this.previous; } @NotNull public Object getId() { return this.id; }
/*     */   public void setPrevious(@Nullable Tree.Element<T> <set-?>) { this.previous = <set-?>; } @Nullable
/*  79 */   public final List<Tree.Element<T>> getChildren() { return (List)this.children; }
/*     */ 
/*     */   
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\jewel-foundation-243-0.27.0.jar!\org\jetbrains\jewel\foundation\lazy\tree\Tree$Element$Node.class
