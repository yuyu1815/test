...
/* 26 */     if (!(('Ѐ' <= it) ? ((it < 'Ԁ') ? 1 : 0) : 0)) if (!(('Ԁ' <= it) ? ((it < '԰') ? 1 : 0) : 0)) if (!(('ⷠ' <= it) ? ((it < '⸀') ? 1 : 0) : 0)) { if ((('Ꙁ' <= it) ? ((it < 'ꚠ')) : false) || it == 'ʼ' || it == '\''); return Boolean.valueOf(false); }
/*    */           
/*    */   }
/*    */ }


/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\nlp-langs-jvm-0.4.32.jar!\ai\grazie\nlp\langs\alphabet\Alphabet$Group$7.class
