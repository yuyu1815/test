...
/* 23 */   public static final class BlockingNERAnnotationService$Companion$empty$1 implements BlockingNERAnnotationService { public List<SentenceWithNERAnnotations> annotate(List sentences) { Intrinsics.checkNotNullParameter(sentences, "sentences"); Iterable $this$map$iv = sentences; int $i$f$map = 0;
/*    */ 
/*    */ 
/*    */ 
/*    */ 
