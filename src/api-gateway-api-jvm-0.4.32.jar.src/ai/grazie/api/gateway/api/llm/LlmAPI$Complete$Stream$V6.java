...
/*     */   implements TypedApi<LlmAPI.Complete.Stream.V6.Request, LlmAPI.Complete.Stream.V6.LLMData>
/*     */ {
/*     */   @NotNull
...
/*     */   @NotNull
/* 173 */   public static final V6 INSTANCE = new V6(); @NotNull public TypeInfo<Request> getRequestType() { return requestType; } static { int $i$f$typeInfo = 0;
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */   
/*     */   @NotNull
/*     */   private static final String path = "/llm/complete/stream/v6";
/*     */   
/*     */   @NotNull
...
/*     */       
/*     */       @NotNull
/*     */       public LlmAPI.Complete.Stream.V6.Request deserialize(@NotNull Decoder decoder) {
...
/*     */         return new LlmAPI.Complete.Stream.V6.Request(i, lLMPromptID, str1, str2, lLMProfileID, attributes, null);
/*     */       }
/*     */       
/*     */       public void serialize(@NotNull Encoder encoder, @NotNull LlmAPI.Complete.Stream.V6.Request value) {
/*     */         Intrinsics.checkNotNullParameter(encoder, "encoder");
/*     */         Intrinsics.checkNotNullParameter(value, "value");
/*     */         SerialDescriptor serialDescriptor = getDescriptor();
/*     */         CompositeEncoder compositeEncoder = encoder.beginStructure(serialDescriptor);
/*     */         LlmAPI.Complete.Stream.V6.Request.write$Self$api_gateway_api(value, compositeEncoder, serialDescriptor);
/*     */         compositeEncoder.endStructure(serialDescriptor);
/*     */       }
/*     */       
/*     */       static {
/*     */         PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("ai.grazie.api.gateway.api.llm.LlmAPI.Complete.Stream.V6.Request", INSTANCE, 5);
...
/*     */     }
/*     */     
/*     */     @Metadata(mv = {1, 7, 0}, k = 1, xi = 48, d1 = {"\000\026\n\002\030\002\n\002\020\000\n\002\b\002\n\002\030\002\n\002\030\002\n\000\b\003\030\0002\0020\001B\007\b\002¢\006\002\020\002J\017\020\003\032\b\022\004\022\0020\0050\004HÆ\001¨\006\006"}, d2 = {"Lai/grazie/api/gateway/api/llm/LlmAPI$Complete$Stream$V6$Request$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lai/grazie/api/gateway/api/llm/LlmAPI$Complete$Stream$V6$Request;", "api-gateway-api"})
/*     */     public static final class Companion {
/*     */       private Companion() {}
/*     */       
/*     */       @NotNull
/*     */       public final KSerializer<LlmAPI.Complete.Stream.V6.Request> serializer() {
/*     */         return (KSerializer<LlmAPI.Complete.Stream.V6.Request>)LlmAPI.Complete.Stream.V6.Request.$serializer.INSTANCE;
/*     */       }
/*     */     }
/*     */     
/*     */     @NotNull
...
/*     */         arrayOfKClass[0] = Reflection.getOrCreateKotlinClass(LlmAPI.Complete.Stream.V6.LLMData.Content.class);
/*     */         arrayOfKClass[1] = Reflection.getOrCreateKotlinClass(LlmAPI.Complete.Stream.V6.LLMData.QuotaMetadata.class);
/*     */         KSerializer[] arrayOfKSerializer = new KSerializer[2];
/*     */         arrayOfKSerializer[0] = (KSerializer)LlmAPI.Complete.Stream.V6.LLMData.Content.$serializer.INSTANCE;
/*     */         arrayOfKSerializer[1] = (KSerializer)LlmAPI.Complete.Stream.V6.LLMData.QuotaMetadata.$serializer.INSTANCE;
/*     */         return (KSerializer<Object>)new SealedClassSerializer("ai.grazie.api.gateway.api.llm.LlmAPI.Complete.Stream.V6.LLMData", Reflection.getOrCreateKotlinClass(LlmAPI.Complete.Stream.V6.LLMData.class), arrayOfKClass, arrayOfKSerializer, new java.lang.annotation.Annotation[0]);
/*     */       }
/*     */     }
/*     */     
/*     */     @Metadata(mv = {1, 7, 0}, k = 1, xi = 48, d1 = {"\000\026\n\002\030\002\n\002\020\000\n\002\b\002\n\002\030\002\n\002\030\002\n\000\b\003\030\0002\0020\001B\007\b\002¢\006\002\020\002J\017\020\003\032\b\022\004\022\0020\0050\004HÆ\001¨\006\006"}, d2 = {"Lai/grazie/api/gateway/api/llm/LlmAPI$Complete$Stream$V6$LLMData$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lai/grazie/api/gateway/api/llm/LlmAPI$Complete$Stream$V6$LLMData;", "api-gateway-api"})
/*     */     public static final class Companion {
/*     */       private Companion() {}
/*     */       
/*     */       @NotNull
/*     */       public final KSerializer<LlmAPI.Complete.Stream.V6.LLMData> serializer() {
...
/*     */         @NotNull
/*     */         public KSerializer<?>[] childSerializers() {
/*     */           KSerializer[] arrayOfKSerializer1 = (KSerializer[])LlmAPI.Complete.Stream.V6.LLMData.Content.$childSerializers, arrayOfKSerializer2 = new KSerializer[2];
...
/*     */         
/*     */         @NotNull
/*     */         public LlmAPI.Complete.Stream.V6.LLMData.Content deserialize(@NotNull Decoder decoder) {
/*     */           Intrinsics.checkNotNullParameter(decoder, "decoder");
/*     */           SerialDescriptor serialDescriptor = getDescriptor();
/*     */           boolean bool = true;
/*     */           int i = 0;
...
/*     */           String str = null;
/*     */           CompositeDecoder compositeDecoder = decoder.beginStructure(serialDescriptor);
/*     */           KSerializer[] arrayOfKSerializer = (KSerializer[])LlmAPI.Complete.Stream.V6.LLMData.Content.$childSerializers;
/*     */           if (compositeDecoder.decodeSequentially()) {
...
/*     */           } 
/*     */           compositeDecoder.endStructure(serialDescriptor);
/*     */           return new LlmAPI.Complete.Stream.V6.LLMData.Content(i, continuousSSEEventType, str, null);
/*     */         }
/*     */         
/*     */         public void serialize(@NotNull Encoder encoder, @NotNull LlmAPI.Complete.Stream.V6.LLMData.Content value) {
/*     */           Intrinsics.checkNotNullParameter(encoder, "encoder");
/*     */           Intrinsics.checkNotNullParameter(value, "value");
/*     */           SerialDescriptor serialDescriptor = getDescriptor();
/*     */           CompositeEncoder compositeEncoder = encoder.beginStructure(serialDescriptor);
/*     */           LlmAPI.Complete.Stream.V6.LLMData.Content.write$Self$api_gateway_api(value, compositeEncoder, serialDescriptor);
/*     */           compositeEncoder.endStructure(serialDescriptor);
/*     */         }
/*     */         
/*     */         static {
...
/*     */       }
/*     */       
/*     */       @Metadata(mv = {1, 7, 0}, k = 1, xi = 48, d1 = {"\000\026\n\002\030\002\n\002\020\000\n\002\b\002\n\002\030\002\n\002\030\002\n\000\b\003\030\0002\0020\001B\007\b\002¢\006\002\020\002J\017\020\003\032\b\022\004\022\0020\0050\004HÆ\001¨\006\006"}, d2 = {"Lai/grazie/api/gateway/api/llm/LlmAPI$Complete$Stream$V6$LLMData$Content$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lai/grazie/api/gateway/api/llm/LlmAPI$Complete$Stream$V6$LLMData$Content;", "api-gateway-api"})
/*     */       public static final class Companion {
/*     */         private Companion() {}
/*     */         
/*     */         @NotNull
/*     */         public final KSerializer<LlmAPI.Complete.Stream.V6.LLMData.Content> serializer() {
/*     */           return (KSerializer<LlmAPI.Complete.Stream.V6.LLMData.Content>)LlmAPI.Complete.Stream.V6.LLMData.Content.$serializer.INSTANCE;
/*     */         }
/*     */       }
/*     */       
/*     */       @NotNull
...
/*     */         @NotNull
/*     */         public KSerializer<?>[] childSerializers() {
/*     */           KSerializer[] arrayOfKSerializer1 = (KSerializer[])LlmAPI.Complete.Stream.V6.LLMData.QuotaMetadata.$childSerializers, arrayOfKSerializer2 = new KSerializer[4];
/*     */           arrayOfKSerializer2[0] = arrayOfKSerializer1[0];
...
/*     */         
/*     */         @NotNull
/*     */         public LlmAPI.Complete.Stream.V6.LLMData.QuotaMetadata deserialize(@NotNull Decoder decoder) {
/*     */           Intrinsics.checkNotNullParameter(decoder, "decoder");
/*     */           SerialDescriptor serialDescriptor = getDescriptor();
/*     */           boolean bool = true;
/*     */           int i = 0;
...
/*     */           String str = null;
/*     */           CompositeDecoder compositeDecoder = decoder.beginStructure(serialDescriptor);
/*     */           KSerializer[] arrayOfKSerializer = (KSerializer[])LlmAPI.Complete.Stream.V6.LLMData.QuotaMetadata.$childSerializers;
/*     */           if (compositeDecoder.decodeSequentially()) {
/*     */             continuousSSEEventType = (ContinuousSSEEventType)compositeDecoder.decodeSerializableElement(serialDescriptor, 0, (DeserializationStrategy)arrayOfKSerializer[0], continuousSSEEventType);
/*     */             i |= 0x1;
...
/*     */           } 
/*     */           compositeDecoder.endStructure(serialDescriptor);
/*     */           return new LlmAPI.Complete.Stream.V6.LLMData.QuotaMetadata(i, continuousSSEEventType, quota, credit, str, null);
/*     */         }
/*     */         
/*     */         public void serialize(@NotNull Encoder encoder, @NotNull LlmAPI.Complete.Stream.V6.LLMData.QuotaMetadata value) {
/*     */           Intrinsics.checkNotNullParameter(encoder, "encoder");
/*     */           Intrinsics.checkNotNullParameter(value, "value");
/*     */           SerialDescriptor serialDescriptor = getDescriptor();
/*     */           CompositeEncoder compositeEncoder = encoder.beginStructure(serialDescriptor);
/*     */           LlmAPI.Complete.Stream.V6.LLMData.QuotaMetadata.write$Self$api_gateway_api(value, compositeEncoder, serialDescriptor);
/*     */           compositeEncoder.endStructure(serialDescriptor);
/*     */         }
/*     */         
/*     */         static {
...
/*     */       }
/*     */       
/*     */       @Metadata(mv = {1, 7, 0}, k = 1, xi = 48, d1 = {"\000\026\n\002\030\002\n\002\020\000\n\002\b\002\n\002\030\002\n\002\030\002\n\000\b\003\030\0002\0020\001B\007\b\002¢\006\002\020\002J\017\020\003\032\b\022\004\022\0020\0050\004HÆ\001¨\006\006"}, d2 = {"Lai/grazie/api/gateway/api/llm/LlmAPI$Complete$Stream$V6$LLMData$QuotaMetadata$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lai/grazie/api/gateway/api/llm/LlmAPI$Complete$Stream$V6$LLMData$QuotaMetadata;", "api-gateway-api"})
/*     */       public static final class Companion {
/*     */         private Companion() {}
/*     */         
/*     */         @NotNull
/*     */         public final KSerializer<LlmAPI.Complete.Stream.V6.LLMData.QuotaMetadata> serializer() {
/*     */           return (KSerializer<LlmAPI.Complete.Stream.V6.LLMData.QuotaMetadata>)LlmAPI.Complete.Stream.V6.LLMData.QuotaMetadata.$serializer.INSTANCE;
/*     */         }
/*     */       }
/*     */       
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\api-gateway-api-jvm-0.4.32.jar!\ai\grazie\api\gateway\api\llm\LlmAPI$Complete$Stream$V6.class
