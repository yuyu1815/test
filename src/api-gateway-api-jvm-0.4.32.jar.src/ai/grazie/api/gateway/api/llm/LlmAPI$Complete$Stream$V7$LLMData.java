...
/*     */ {
/*     */   @NotNull
/* 216 */   public static final Companion Companion = new Companion(null); @JvmField @NotNull private static final KSerializer<Object>[] $childSerializers; @NotNull private static final Lazy<KSerializer<Object>> $cachedSerializer$delegate = LazyKt.lazy(LazyThreadSafetyMode.PUBLICATION, Companion.null.INSTANCE); static { KSerializer[] arrayOfKSerializer = new KSerializer[1]; arrayOfKSerializer[0] = ContinuousSSEEventType.Companion.serializer(); $childSerializers = (KSerializer<Object>[])arrayOfKSerializer; } @NotNull public abstract String getContent(); @Metadata(mv = {1, 7, 0}, k = 3, xi = 48) static final class null extends Lambda implements Function0<KSerializer<Object>> { public static final null INSTANCE = (null)new Function0<>(); null() { super(0); } public final KSerializer<Object> invoke() { KClass[] arrayOfKClass = new KClass[4]; arrayOfKClass[0] = Reflection.getOrCreateKotlinClass(LlmAPI.Complete.Stream.V7.LLMData.Content.class); arrayOfKClass[1] = Reflection.getOrCreateKotlinClass(LlmAPI.Complete.Stream.V7.LLMData.FinishMetadata.class); arrayOfKClass[2] = Reflection.getOrCreateKotlinClass(LlmAPI.Complete.Stream.V7.LLMData.QuotaMetadata.class); arrayOfKClass[3] = Reflection.getOrCreateKotlinClass(LlmAPI.Complete.Stream.V7.LLMData.UnknownMetadata.class); KSerializer[] arrayOfKSerializer = new KSerializer[4]; arrayOfKSerializer[0] = (KSerializer)LlmAPI.Complete.Stream.V7.LLMData.Content.$serializer.INSTANCE; arrayOfKSerializer[1] = (KSerializer)LlmAPI.Complete.Stream.V7.LLMData.FinishMetadata.$serializer.INSTANCE; arrayOfKSerializer[2] = (KSerializer)LlmAPI.Complete.Stream.V7.LLMData.QuotaMetadata.$serializer.INSTANCE; arrayOfKSerializer[3] = (KSerializer)new ObjectSerializer("UnknownMetadata", LlmAPI.Complete.Stream.V7.LLMData.UnknownMetadata.INSTANCE, new java.lang.annotation.Annotation[0]); return (KSerializer<Object>)new SealedClassSerializer("ai.grazie.api.gateway.api.llm.LlmAPI.Complete.Stream.V7.LLMData", Reflection.getOrCreateKotlinClass(LlmAPI.Complete.Stream.V7.LLMData.class), arrayOfKClass, arrayOfKSerializer, new java.lang.annotation.Annotation[0]); } } @Metadata(mv = {1, 7, 0}, k = 1, xi = 48, d1 = {"\000\026\n\002\030\002\n\002\020\000\n\002\b\002\n\002\030\002\n\002\030\002\n\000\b\003\030\0002\0020\001B\007\b\002¢\006\002\020\002J\017\020\003\032\b\022\004\022\0020\0050\004HÆ\001¨\006\006"}, d2 = {"Lai/grazie/api/gateway/api/llm/LlmAPI$Complete$Stream$V7$LLMData$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lai/grazie/api/gateway/api/llm/LlmAPI$Complete$Stream$V7$LLMData;", "api-gateway-api"}) public static final class Companion { private Companion() {} @NotNull public final KSerializer<LlmAPI.Complete.Stream.V7.LLMData> serializer() { return get$cachedSerializer(); } } private LLMData() {} @Serializable
/*     */   @SerialName("Content")
...
/* 236 */   @Serializable @SerialName("UnknownMetadata") @Metadata(mv = {1, 7, 0}, k = 1, xi = 48, d1 = {"\000\032\n\002\030\002\n\002\030\002\n\002\b\002\n\002\020\016\n\002\b\003\n\002\030\002\n\000\bÇ\002\030\0002\0020\001B\007\b\002¢\006\002\020\002J\017\020\007\032\b\022\004\022\0020\0000\bHÆ\001R\024\020\003\032\0020\004XD¢\006\b\n\000\032\004\b\005\020\006¨\006\t"}, d2 = {"Lai/grazie/api/gateway/api/llm/LlmAPI$Complete$Stream$V7$LLMData$UnknownMetadata;", "Lai/grazie/api/gateway/api/llm/LlmAPI$Complete$Stream$V7$LLMData;", "()V", "content", "", "getContent", "()Ljava/lang/String;", "serializer", "Lkotlinx/serialization/KSerializer;", "api-gateway-api"}) public static final class UnknownMetadata extends LLMData { @NotNull public final KSerializer<UnknownMetadata> serializer() { return get$cachedSerializer(); }
/*     */     
/* 238 */     private UnknownMetadata() { super(null); } @NotNull
/* 239 */     private static final String content = ""; @NotNull public static final UnknownMetadata INSTANCE = new UnknownMetadata(); @NotNull public String getContent() { return content; }
/*     */      }
/*     */ 
/*     */ }


/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\api-gateway-api-jvm-0.4.32.jar!\ai\grazie\api\gateway\api\llm\LlmAPI$Complete$Stream$V7$LLMData.class
