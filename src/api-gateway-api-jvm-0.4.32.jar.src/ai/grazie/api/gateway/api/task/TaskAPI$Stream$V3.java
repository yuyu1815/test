...
/*     */   implements TypedApi<TaskAPI.Stream.V3.Request, TaskAPI.Stream.V3.TaskData>
/*     */ {
/*     */   @NotNull
/*     */   private static final TypeInfo<Request> requestType;
/*     */   @NotNull
/*     */   private static final TypeInfo<TaskData> responseType;
/*     */   @NotNull
/*  86 */   public static final V3 INSTANCE = new V3(); @NotNull public TypeInfo<Request> getRequestType() { return requestType; } static { int $i$f$typeInfo = 0;
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 221 */     responseType = new TypeInfo(kType$iv, Reflection.getOrCreateKotlinClass(TaskData.class)); }
/*     */ 
/*     */   
/*     */   @NotNull
...
/*     */   
/*     */   @NotNull
/*     */   private static final SseConfig sseConfig = new SseConfig(Reflection.getOrCreateKotlinClass(TaskData.UnknownMetadata.class));
/*     */   
/*     */   @NotNull
...
/*     */   
/*     */   @NotNull
/*     */   private static final String path = "/task/stream/v3";
/*     */   
/*     */   @NotNull
...
/*     */         arrayOfKSerializer[0] = (KSerializer)TaskName.Serializer.INSTANCE;
/*     */         arrayOfKSerializer[1] = (KSerializer)DataHolderSerializer.INSTANCE;
/*     */         return (KSerializer<?>[])arrayOfKSerializer;
/*     */       }
/*     */       
/*     */       @NotNull
/*     */       public TaskAPI.Stream.V3.Request deserialize(@NotNull Decoder decoder) {
...
/*     */           taskName = (TaskName)compositeDecoder.decodeSerializableElement(serialDescriptor, 0, (DeserializationStrategy)TaskName.Serializer.INSTANCE, taskName);
/*     */           i |= 0x1;
...
/*     */         return new TaskAPI.Stream.V3.Request(i, taskName, dataHolder, null);
/*     */       }
/*     */       
/*     */       public void serialize(@NotNull Encoder encoder, @NotNull TaskAPI.Stream.V3.Request value) {
/*     */         Intrinsics.checkNotNullParameter(encoder, "encoder");
/*     */         Intrinsics.checkNotNullParameter(value, "value");
/*     */         SerialDescriptor serialDescriptor = getDescriptor();
/*     */         CompositeEncoder compositeEncoder = encoder.beginStructure(serialDescriptor);
/*     */         TaskAPI.Stream.V3.Request.write$Self$api_gateway_api(value, compositeEncoder, serialDescriptor);
/*     */         compositeEncoder.endStructure(serialDescriptor);
/*     */       }
/*     */       
/*     */       static {
/*     */         PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("ai.grazie.api.gateway.api.task.TaskAPI.Stream.V3.Request", INSTANCE, 2);
...
/*     */       
/*     */       @NotNull
/*     */       public final KSerializer<TaskAPI.Stream.V3.Request> serializer() {
/*     */         return (KSerializer<TaskAPI.Stream.V3.Request>)TaskAPI.Stream.V3.Request.$serializer.INSTANCE;
/*     */       }
/*     */     }
/*     */     
/*     */     @NotNull
/*     */     public final TaskName getTask() {
/*     */       return this.task;
/*     */     }
/*     */     
/*     */     @NotNull
...
/*     */         arrayOfKClass[0] = Reflection.getOrCreateKotlinClass(TaskAPI.Stream.V3.TaskData.Content.class);
/*     */         arrayOfKClass[1] = Reflection.getOrCreateKotlinClass(TaskAPI.Stream.V3.TaskData.ExecutionMetadata.class);
/*     */         arrayOfKClass[2] = Reflection.getOrCreateKotlinClass(TaskAPI.Stream.V3.TaskData.FinishMetadata.class);
/*     */         arrayOfKClass[3] = Reflection.getOrCreateKotlinClass(TaskAPI.Stream.V3.TaskData.FunctionCall.class);
/*     */         arrayOfKClass[4] = Reflection.getOrCreateKotlinClass(TaskAPI.Stream.V3.TaskData.QuotaMetadata.class);
/*     */         arrayOfKClass[5] = Reflection.getOrCreateKotlinClass(TaskAPI.Stream.V3.TaskData.UnknownMetadata.class);
/*     */         KSerializer[] arrayOfKSerializer = new KSerializer[6];
/*     */         arrayOfKSerializer[0] = (KSerializer)TaskAPI.Stream.V3.TaskData.Content.$serializer.INSTANCE;
/*     */         arrayOfKSerializer[1] = (KSerializer)TaskAPI.Stream.V3.TaskData.ExecutionMetadata.$serializer.INSTANCE;
/*     */         arrayOfKSerializer[2] = (KSerializer)TaskAPI.Stream.V3.TaskData.FinishMetadata.$serializer.INSTANCE;
/*     */         arrayOfKSerializer[3] = (KSerializer)TaskAPI.Stream.V3.TaskData.FunctionCall.$serializer.INSTANCE;
/*     */         arrayOfKSerializer[4] = (KSerializer)TaskAPI.Stream.V3.TaskData.QuotaMetadata.$serializer.INSTANCE;
/*     */         arrayOfKSerializer[5] = (KSerializer)new ObjectSerializer("UnknownMetadata", TaskAPI.Stream.V3.TaskData.UnknownMetadata.INSTANCE, new java.lang.annotation.Annotation[0]);
/*     */         return (KSerializer<Object>)new SealedClassSerializer("ai.grazie.api.gateway.api.task.TaskAPI.Stream.V3.TaskData", Reflection.getOrCreateKotlinClass(TaskAPI.Stream.V3.TaskData.class), arrayOfKClass, arrayOfKSerializer, new java.lang.annotation.Annotation[0]);
/*     */       }
/*     */     }
/*     */     
/*     */     @Metadata(mv = {1, 7, 0}, k = 1, xi = 48, d1 = {"\000\026\n\002\030\002\n\002\020\000\n\002\b\002\n\002\030\002\n\002\030\002\n\000\b\003\030\0002\0020\001B\007\b\002¢\006\002\020\002J\017\020\003\032\b\022\004\022\0020\0050\004HÆ\001¨\006\006"}, d2 = {"Lai/grazie/api/gateway/api/task/TaskAPI$Stream$V3$TaskData$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lai/grazie/api/gateway/api/task/TaskAPI$Stream$V3$TaskData;", "api-gateway-api"})
/*     */     public static final class Companion {
/*     */       private Companion() {}
/*     */       
/*     */       @NotNull
/*     */       public final KSerializer<TaskAPI.Stream.V3.TaskData> serializer() {
...
/*     */         @NotNull
/*     */         public KSerializer<?>[] childSerializers() {
/*     */           KSerializer[] arrayOfKSerializer1 = (KSerializer[])TaskAPI.Stream.V3.TaskData.Content.$childSerializers, arrayOfKSerializer2 = new KSerializer[2];
...
/*     */         
/*     */         @NotNull
/*     */         public TaskAPI.Stream.V3.TaskData.Content deserialize(@NotNull Decoder decoder) {
/*     */           Intrinsics.checkNotNullParameter(decoder, "decoder");
/*     */           SerialDescriptor serialDescriptor = getDescriptor();
/*     */           boolean bool = true;
/*     */           int i = 0;
...
/*     */           String str = null;
/*     */           CompositeDecoder compositeDecoder = decoder.beginStructure(serialDescriptor);
/*     */           KSerializer[] arrayOfKSerializer = (KSerializer[])TaskAPI.Stream.V3.TaskData.Content.$childSerializers;
/*     */           if (compositeDecoder.decodeSequentially()) {
...
/*     */           } 
/*     */           compositeDecoder.endStructure(serialDescriptor);
/*     */           return new TaskAPI.Stream.V3.TaskData.Content(i, continuousSSEEventType, str, null);
/*     */         }
/*     */         
/*     */         public void serialize(@NotNull Encoder encoder, @NotNull TaskAPI.Stream.V3.TaskData.Content value) {
/*     */           Intrinsics.checkNotNullParameter(encoder, "encoder");
/*     */           Intrinsics.checkNotNullParameter(value, "value");
/*     */           SerialDescriptor serialDescriptor = getDescriptor();
/*     */           CompositeEncoder compositeEncoder = encoder.beginStructure(serialDescriptor);
/*     */           TaskAPI.Stream.V3.TaskData.Content.write$Self$api_gateway_api(value, compositeEncoder, serialDescriptor);
/*     */           compositeEncoder.endStructure(serialDescriptor);
/*     */         }
/*     */         
/*     */         static {
...
/*     */       }
/*     */       
/*     */       @Metadata(mv = {1, 7, 0}, k = 1, xi = 48, d1 = {"\000\026\n\002\030\002\n\002\020\000\n\002\b\002\n\002\030\002\n\002\030\002\n\000\b\003\030\0002\0020\001B\007\b\002¢\006\002\020\002J\017\020\003\032\b\022\004\022\0020\0050\004HÆ\001¨\006\006"}, d2 = {"Lai/grazie/api/gateway/api/task/TaskAPI$Stream$V3$TaskData$Content$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lai/grazie/api/gateway/api/task/TaskAPI$Stream$V3$TaskData$Content;", "api-gateway-api"})
/*     */       public static final class Companion {
/*     */         private Companion() {}
/*     */         
/*     */         @NotNull
/*     */         public final KSerializer<TaskAPI.Stream.V3.TaskData.Content> serializer() {
/*     */           return (KSerializer<TaskAPI.Stream.V3.TaskData.Content>)TaskAPI.Stream.V3.TaskData.Content.$serializer.INSTANCE;
/*     */         }
/*     */       }
/*     */       
/*     */       @NotNull
...
/*     */         @NotNull
/*     */         public KSerializer<?>[] childSerializers() {
/*     */           KSerializer[] arrayOfKSerializer1 = (KSerializer[])TaskAPI.Stream.V3.TaskData.QuotaMetadata.$childSerializers, arrayOfKSerializer2 = new KSerializer[4];
/*     */           arrayOfKSerializer2[0] = arrayOfKSerializer1[0];
...
/*     */         
/*     */         @NotNull
/*     */         public TaskAPI.Stream.V3.TaskData.QuotaMetadata deserialize(@NotNull Decoder decoder) {
/*     */           Intrinsics.checkNotNullParameter(decoder, "decoder");
/*     */           SerialDescriptor serialDescriptor = getDescriptor();
/*     */           boolean bool = true;
/*     */           int i = 0;
...
/*     */           String str = null;
/*     */           CompositeDecoder compositeDecoder = decoder.beginStructure(serialDescriptor);
/*     */           KSerializer[] arrayOfKSerializer = (KSerializer[])TaskAPI.Stream.V3.TaskData.QuotaMetadata.$childSerializers;
/*     */           if (compositeDecoder.decodeSequentially()) {
/*     */             continuousSSEEventType = (ContinuousSSEEventType)compositeDecoder.decodeSerializableElement(serialDescriptor, 0, (DeserializationStrategy)arrayOfKSerializer[0], continuousSSEEventType);
/*     */             i |= 0x1;
...
/*     */           } 
/*     */           compositeDecoder.endStructure(serialDescriptor);
/*     */           return new TaskAPI.Stream.V3.TaskData.QuotaMetadata(i, continuousSSEEventType, quota, credit, str, null);
/*     */         }
/*     */         
/*     */         public void serialize(@NotNull Encoder encoder, @NotNull TaskAPI.Stream.V3.TaskData.QuotaMetadata value) {
/*     */           Intrinsics.checkNotNullParameter(encoder, "encoder");
/*     */           Intrinsics.checkNotNullParameter(value, "value");
/*     */           SerialDescriptor serialDescriptor = getDescriptor();
/*     */           CompositeEncoder compositeEncoder = encoder.beginStructure(serialDescriptor);
/*     */           TaskAPI.Stream.V3.TaskData.QuotaMetadata.write$Self$api_gateway_api(value, compositeEncoder, serialDescriptor);
/*     */           compositeEncoder.endStructure(serialDescriptor);
/*     */         }
/*     */         
/*     */         static {
...
/*     */         
/*     */         @NotNull
/*     */         public final KSerializer<TaskAPI.Stream.V3.TaskData.QuotaMetadata> serializer() {
/*     */           return (KSerializer<TaskAPI.Stream.V3.TaskData.QuotaMetadata>)TaskAPI.Stream.V3.TaskData.QuotaMetadata.$serializer.INSTANCE;
/*     */         }
/*     */       }
/*     */       
...
/*     */         @NotNull
/*     */         public KSerializer<?>[] childSerializers() {
/*     */           KSerializer[] arrayOfKSerializer1 = (KSerializer[])TaskAPI.Stream.V3.TaskData.FinishMetadata.$childSerializers, arrayOfKSerializer2 = new KSerializer[3];
/*     */           arrayOfKSerializer2[0] = arrayOfKSerializer1[0];
...
/*     */         
/*     */         @NotNull
/*     */         public TaskAPI.Stream.V3.TaskData.FinishMetadata deserialize(@NotNull Decoder decoder) {
/*     */           Intrinsics.checkNotNullParameter(decoder, "decoder");
/*     */           SerialDescriptor serialDescriptor = getDescriptor();
/*     */           boolean bool = true;
/*     */           int i = 0;
...
/*     */           String str = null;
/*     */           CompositeDecoder compositeDecoder = decoder.beginStructure(serialDescriptor);
/*     */           KSerializer[] arrayOfKSerializer = (KSerializer[])TaskAPI.Stream.V3.TaskData.FinishMetadata.$childSerializers;
/*     */           if (compositeDecoder.decodeSequentially()) {
/*     */             continuousSSEEventType = (ContinuousSSEEventType)compositeDecoder.decodeSerializableElement(serialDescriptor, 0, (DeserializationStrategy)arrayOfKSerializer[0], continuousSSEEventType);
/*     */             i |= 0x1;
...
/*     */           } 
/*     */           compositeDecoder.endStructure(serialDescriptor);
/*     */           return new TaskAPI.Stream.V3.TaskData.FinishMetadata(i, continuousSSEEventType, lLMStreamFinishReason, str, null);
/*     */         }
/*     */         
/*     */         public void serialize(@NotNull Encoder encoder, @NotNull TaskAPI.Stream.V3.TaskData.FinishMetadata value) {
/*     */           Intrinsics.checkNotNullParameter(encoder, "encoder");
/*     */           Intrinsics.checkNotNullParameter(value, "value");
/*     */           SerialDescriptor serialDescriptor = getDescriptor();
/*     */           CompositeEncoder compositeEncoder = encoder.beginStructure(serialDescriptor);
/*     */           TaskAPI.Stream.V3.TaskData.FinishMetadata.write$Self$api_gateway_api(value, compositeEncoder, serialDescriptor);
/*     */           compositeEncoder.endStructure(serialDescriptor);
/*     */         }
/*     */         
/*     */         static {
...
/*     */       }
/*     */       
/*     */       @Metadata(mv = {1, 7, 0}, k = 1, xi = 48, d1 = {"\000\026\n\002\030\002\n\002\020\000\n\002\b\002\n\002\030\002\n\002\030\002\n\000\b\003\030\0002\0020\001B\007\b\002¢\006\002\020\002J\017\020\003\032\b\022\004\022\0020\0050\004HÆ\001¨\006\006"}, d2 = {"Lai/grazie/api/gateway/api/task/TaskAPI$Stream$V3$TaskData$FinishMetadata$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lai/grazie/api/gateway/api/task/TaskAPI$Stream$V3$TaskData$FinishMetadata;", "api-gateway-api"})
/*     */       public static final class Companion {
/*     */         private Companion() {}
/*     */         
/*     */         @NotNull
/*     */         public final KSerializer<TaskAPI.Stream.V3.TaskData.FinishMetadata> serializer() {
/*     */           return (KSerializer<TaskAPI.Stream.V3.TaskData.FinishMetadata>)TaskAPI.Stream.V3.TaskData.FinishMetadata.$serializer.INSTANCE;
/*     */         }
/*     */       }
/*     */       
...
/*     */         @NotNull
/*     */         public KSerializer<?>[] childSerializers() {
/*     */           KSerializer[] arrayOfKSerializer1 = (KSerializer[])TaskAPI.Stream.V3.TaskData.ExecutionMetadata.$childSerializers, arrayOfKSerializer2 = new KSerializer[3];
/*     */           arrayOfKSerializer2[0] = arrayOfKSerializer1[0];
...
/*     */         
/*     */         @NotNull
/*     */         public TaskAPI.Stream.V3.TaskData.ExecutionMetadata deserialize(@NotNull Decoder decoder) {
/*     */           Intrinsics.checkNotNullParameter(decoder, "decoder");
/*     */           SerialDescriptor serialDescriptor = getDescriptor();
/*     */           boolean bool = true;
/*     */           int i = 0;
...
/*     */           String str = null;
/*     */           CompositeDecoder compositeDecoder = decoder.beginStructure(serialDescriptor);
/*     */           KSerializer[] arrayOfKSerializer = (KSerializer[])TaskAPI.Stream.V3.TaskData.ExecutionMetadata.$childSerializers;
/*     */           if (compositeDecoder.decodeSequentially()) {
/*     */             continuousSSEEventType = (ContinuousSSEEventType)compositeDecoder.decodeSerializableElement(serialDescriptor, 0, (DeserializationStrategy)arrayOfKSerializer[0], continuousSSEEventType);
/*     */             i |= 0x1;
/*     */             dataHolder = (DataHolder)compositeDecoder.decodeSerializableElement(serialDescriptor, 1, (DeserializationStrategy)DataHolderSerializer.INSTANCE, dataHolder);
...
/*     */           } 
/*     */           compositeDecoder.endStructure(serialDescriptor);
/*     */           return new TaskAPI.Stream.V3.TaskData.ExecutionMetadata(i, continuousSSEEventType, dataHolder, str, null);
/*     */         }
/*     */         
/*     */         public void serialize(@NotNull Encoder encoder, @NotNull TaskAPI.Stream.V3.TaskData.ExecutionMetadata value) {
/*     */           Intrinsics.checkNotNullParameter(encoder, "encoder");
/*     */           Intrinsics.checkNotNullParameter(value, "value");
/*     */           SerialDescriptor serialDescriptor = getDescriptor();
/*     */           CompositeEncoder compositeEncoder = encoder.beginStructure(serialDescriptor);
/*     */           TaskAPI.Stream.V3.TaskData.ExecutionMetadata.write$Self$api_gateway_api(value, compositeEncoder, serialDescriptor);
/*     */           compositeEncoder.endStructure(serialDescriptor);
/*     */         }
/*     */         
/*     */         static {
...
/*     */       }
/*     */       
/*     */       @Metadata(mv = {1, 7, 0}, k = 1, xi = 48, d1 = {"\000\026\n\002\030\002\n\002\020\000\n\002\b\002\n\002\030\002\n\002\030\002\n\000\b\003\030\0002\0020\001B\007\b\002¢\006\002\020\002J\017\020\003\032\b\022\004\022\0020\0050\004HÆ\001¨\006\006"}, d2 = {"Lai/grazie/api/gateway/api/task/TaskAPI$Stream$V3$TaskData$ExecutionMetadata$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lai/grazie/api/gateway/api/task/TaskAPI$Stream$V3$TaskData$ExecutionMetadata;", "api-gateway-api"})
/*     */       public static final class Companion {
/*     */         private Companion() {}
/*     */         
/*     */         @NotNull
/*     */         public final KSerializer<TaskAPI.Stream.V3.TaskData.ExecutionMetadata> serializer() {
/*     */           return (KSerializer<TaskAPI.Stream.V3.TaskData.ExecutionMetadata>)TaskAPI.Stream.V3.TaskData.ExecutionMetadata.$serializer.INSTANCE;
/*     */         }
/*     */       }
/*     */       
...
/*     */         @NotNull
/*     */         public KSerializer<?>[] childSerializers() {
/*     */           KSerializer[] arrayOfKSerializer1 = (KSerializer[])TaskAPI.Stream.V3.TaskData.FunctionCall.$childSerializers, arrayOfKSerializer2 = new KSerializer[3];
/*     */           arrayOfKSerializer2[0] = arrayOfKSerializer1[0];
...
/*     */         
/*     */         @NotNull
/*     */         public TaskAPI.Stream.V3.TaskData.FunctionCall deserialize(@NotNull Decoder decoder) {
/*     */           Intrinsics.checkNotNullParameter(decoder, "decoder");
/*     */           SerialDescriptor serialDescriptor = getDescriptor();
/*     */           boolean bool = true;
/*     */           int i = 0;
...
/*     */           CompositeDecoder compositeDecoder = decoder.beginStructure(serialDescriptor);
/*     */           KSerializer[] arrayOfKSerializer = (KSerializer[])TaskAPI.Stream.V3.TaskData.FunctionCall.$childSerializers;
/*     */           if (compositeDecoder.decodeSequentially()) {
/*     */             continuousSSEEventType = (ContinuousSSEEventType)compositeDecoder.decodeSerializableElement(serialDescriptor, 0, (DeserializationStrategy)arrayOfKSerializer[0], continuousSSEEventType);
/*     */             i |= 0x1;
...
/*     */           } 
/*     */           compositeDecoder.endStructure(serialDescriptor);
/*     */           return new TaskAPI.Stream.V3.TaskData.FunctionCall(i, continuousSSEEventType, str1, str2, null);
/*     */         }
/*     */         
/*     */         public void serialize(@NotNull Encoder encoder, @NotNull TaskAPI.Stream.V3.TaskData.FunctionCall value) {
/*     */           Intrinsics.checkNotNullParameter(encoder, "encoder");
/*     */           Intrinsics.checkNotNullParameter(value, "value");
/*     */           SerialDescriptor serialDescriptor = getDescriptor();
/*     */           CompositeEncoder compositeEncoder = encoder.beginStructure(serialDescriptor);
/*     */           TaskAPI.Stream.V3.TaskData.FunctionCall.write$Self$api_gateway_api(value, compositeEncoder, serialDescriptor);
/*     */           compositeEncoder.endStructure(serialDescriptor);
/*     */         }
/*     */         
/*     */         static {
...
/*     */       }
/*     */       
/*     */       @Metadata(mv = {1, 7, 0}, k = 1, xi = 48, d1 = {"\000\026\n\002\030\002\n\002\020\000\n\002\b\002\n\002\030\002\n\002\030\002\n\000\b\003\030\0002\0020\001B\007\b\002¢\006\002\020\002J\017\020\003\032\b\022\004\022\0020\0050\004HÆ\001¨\006\006"}, d2 = {"Lai/grazie/api/gateway/api/task/TaskAPI$Stream$V3$TaskData$FunctionCall$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lai/grazie/api/gateway/api/task/TaskAPI$Stream$V3$TaskData$FunctionCall;", "api-gateway-api"})
/*     */       public static final class Companion {
/*     */         private Companion() {}
/*     */         
/*     */         @NotNull
/*     */         public final KSerializer<TaskAPI.Stream.V3.TaskData.FunctionCall> serializer() {
/*     */           return (KSerializer<TaskAPI.Stream.V3.TaskData.FunctionCall>)TaskAPI.Stream.V3.TaskData.FunctionCall.$serializer.INSTANCE;
/*     */         }
/*     */       }
/*     */       
/*     */       @NotNull
...
/*     */     @Metadata(mv = {1, 7, 0}, k = 1, xi = 48, d1 = {"\000\032\n\002\030\002\n\002\030\002\n\002\b\002\n\002\020\016\n\002\b\003\n\002\030\002\n\000\bÇ\002\030\0002\0020\001B\007\b\002¢\006\002\020\002J\017\020\007\032\b\022\004\022\0020\0000\bHÆ\001R\024\020\003\032\0020\004XD¢\006\b\n\000\032\004\b\005\020\006¨\006\t"}, d2 = {"Lai/grazie/api/gateway/api/task/TaskAPI$Stream$V3$TaskData$UnknownMetadata;", "Lai/grazie/api/gateway/api/task/TaskAPI$Stream$V3$TaskData;", "()V", "content", "", "getContent", "()Ljava/lang/String;", "serializer", "Lkotlinx/serialization/KSerializer;", "api-gateway-api"})
...
/*     */       super(Reflection.getOrCreateKotlinClass(TaskAPI.Stream.V3.TaskData.class), TaskAPI.Stream.V3.TaskData.Companion.serializer(), TaskAPI.Stream.V3.TaskData.UnknownMetadata.INSTANCE.serializer());
/*     */     }
/*     */   }
/*     */ }


/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\api-gateway-api-jvm-0.4.32.jar!\ai\grazie\api\gateway\api\task\TaskAPI$Stream$V3.class
