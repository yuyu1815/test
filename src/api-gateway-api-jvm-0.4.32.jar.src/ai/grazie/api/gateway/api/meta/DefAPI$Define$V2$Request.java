...
/*    */   
/* 38 */   public Request(@NotNull String text, @NotNull TextRange selection, @NotNull Language lang) { this.text = text;
/* 39 */     this.selection = selection;
/* 40 */     this.lang = lang; } @NotNull private final TextRange selection; @NotNull private final Language lang; @NotNull public final Language getLang() { return this.lang; }
/*    */ 
/*    */   
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\api-gateway-api-jvm-0.4.32.jar!\ai\grazie\api\gateway\api\meta\DefAPI$Define$V2$Request.class
