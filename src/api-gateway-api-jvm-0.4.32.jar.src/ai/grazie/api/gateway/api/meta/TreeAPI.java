/*    */ package ai.grazie.api.gateway.api.meta;@Metadata(mv = {1, 7, 0}, k = 1, xi = 48, d1 = {"\000\f\n\002\030\002\n\002\020\000\n\002\b\003\bÆ\002\030\0002\0020\001:\001\003B\007\b\002¢\006\002\020\002¨\006\004"}, d2 = {"Lai/grazie/api/gateway/api/meta/TreeAPI;", "", "()V", "Tree", "api-gateway-api"})
/*    */ public final class TreeAPI { @NotNull
/*    */   public static final TreeAPI INSTANCE = new TreeAPI();
/*    */   @Metadata(mv = {1, 7, 0}, k = 1, xi = 48, d1 = {"\000\f\n\002\030\002\n\002\020\000\n\002\b\003\bÆ\002\030\0002\0020\001:\001\003B\007\b\002¢\006\002\020\002¨\006\004"}, d2 = {"Lai/grazie/api/gateway/api/meta/TreeAPI$Tree;", "", "()V", "V1", "api-gateway-api"})
/*    */   public static final class Tree { @NotNull
/*    */     public static final Tree INSTANCE = new Tree();
/*    */     
/*    */     @Metadata(mv = {1, 7, 0}, k = 1, xi = 48, d1 = {"\000,\n\002\030\002\n\002\030\002\n\002\030\002\n\002\030\002\n\002\b\002\n\002\030\002\n\002\b\003\n\002\020\016\n\002\b\003\n\002\030\002\n\002\b\007\bÆ\002\030\0002\016\022\004\022\0020\002\022\004\022\0020\0030\001:\002\023\024B\007\b\002¢\006\002\020\004R\024\020\005\032\0020\006X\004¢\006\b\n\000\032\004\b\007\020\bR\024\020\t\032\0020\nXD¢\006\b\n\000\032\004\b\013\020\fR\032\020\r\032\b\022\004\022\0020\0020\016X\004¢\006\b\n\000\032\004\b\017\020\020R\032\020\021\032\b\022\004\022\0020\0030\016X\004¢\006\b\n\000\032\004\b\022\020\020¨\006\025"}, d2 = {"Lai/grazie/api/gateway/api/meta/TreeAPI$Tree$V1;", "Lai/grazie/model/cloud/TypedApi;", "Lai/grazie/api/gateway/api/meta/TreeAPI$Tree$V1$Request;", "Lai/grazie/api/gateway/api/meta/TreeAPI$Tree$V1$Response;", "()V", "httpMethod", "Lai/grazie/model/cloud/HttpMethod;", "getHttpMethod", "()Lai/grazie/model/cloud/HttpMethod;", "path", "", "getPath", "()Ljava/lang/String;", "requestType", "Lai/grazie/model/cloud/TypeInfo;", "getRequestType", "()Lai/grazie/model/cloud/TypeInfo;", "responseType", "getResponseType", "Request", "Response", "api-gateway-api"})
/*    */     @SourceDebugExtension({"SMAP\nTreeAPI.kt\nKotlin\n*S Kotlin\n*F\n+ 1 TreeAPI.kt\nai/grazie/api/gateway/api/meta/TreeAPI$Tree$V1\n+ 2 TypedApi.kt\nai/grazie/model/cloud/TypedApiKt\n*L\n1#1,24:1\n19#2,2:25\n19#2,2:27\n*S KotlinDebug\n*F\n+ 1 TreeAPI.kt\nai/grazie/api/gateway/api/meta/TreeAPI$Tree$V1\n*L\n11#1:25,2\n12#1:27,2\n*E\n"})
...
/*    */       
/*    */       @NotNull
/*    */       private static final String path = "/meta/tree/parse/v1";
/*    */       
/*    */       @NotNull
...
/*    */         
/*    */         public Request(@NotNull Language lang, @NotNull List<String> texts, @Nullable String parser, @Nullable List<String> options) {
/*    */           this.lang = lang;
/*    */           this.texts = texts;
/*    */           this.parser = parser;
...
/*    */             KSerializer[] arrayOfKSerializer1 = (KSerializer[])TreeAPI.Tree.V1.Request.$childSerializers, arrayOfKSerializer2 = new KSerializer[4];
...
/*    */           
/*    */           @NotNull
/*    */           public TreeAPI.Tree.V1.Request deserialize(@NotNull Decoder decoder) {
...
/*    */             KSerializer[] arrayOfKSerializer = (KSerializer[])TreeAPI.Tree.V1.Request.$childSerializers;
...
/*    */               i |= 0x1;
/*    */               list1 = (List)compositeDecoder.decodeSerializableElement(serialDescriptor, 1, (DeserializationStrategy)arrayOfKSerializer[1], list1);
/*    */               i |= 0x2;
/*    */               str = (String)compositeDecoder.decodeNullableSerializableElement(serialDescriptor, 2, (DeserializationStrategy)StringSerializer.INSTANCE, str);
/*    */               i |= 0x4;
...
/*    */             return new TreeAPI.Tree.V1.Request(i, language, list1, str, list2, null);
/*    */           }
/*    */           
/*    */           public void serialize(@NotNull Encoder encoder, @NotNull TreeAPI.Tree.V1.Request value) {
/*    */             Intrinsics.checkNotNullParameter(encoder, "encoder");
/*    */             Intrinsics.checkNotNullParameter(value, "value");
/*    */             SerialDescriptor serialDescriptor = getDescriptor();
/*    */             CompositeEncoder compositeEncoder = encoder.beginStructure(serialDescriptor);
/*    */             TreeAPI.Tree.V1.Request.write$Self$api_gateway_api(value, compositeEncoder, serialDescriptor);
/*    */             compositeEncoder.endStructure(serialDescriptor);
/*    */           }
/*    */           
/*    */           static {
/*    */             PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("ai.grazie.api.gateway.api.meta.TreeAPI.Tree.V1.Request", INSTANCE, 4);
/*    */             pluginGeneratedSerialDescriptor.addElement("lang", false);
/*    */             pluginGeneratedSerialDescriptor.addElement("texts", false);
/*    */             pluginGeneratedSerialDescriptor.addElement("parser", true);
/*    */             pluginGeneratedSerialDescriptor.addElement("options", true);
/*    */             descriptor = pluginGeneratedSerialDescriptor;
/*    */           }
/*    */         }
/*    */         
/*    */         @Metadata(mv = {1, 7, 0}, k = 1, xi = 48, d1 = {"\000\026\n\002\030\002\n\002\020\000\n\002\b\002\n\002\030\002\n\002\030\002\n\000\b\003\030\0002\0020\001B\007\b\002¢\006\002\020\002J\017\020\003\032\b\022\004\022\0020\0050\004HÆ\001¨\006\006"}, d2 = {"Lai/grazie/api/gateway/api/meta/TreeAPI$Tree$V1$Request$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lai/grazie/api/gateway/api/meta/TreeAPI$Tree$V1$Request;", "api-gateway-api"})
/*    */         public static final class Companion {
/*    */           private Companion() {}
/*    */           
/*    */           @NotNull
/*    */           public final KSerializer<TreeAPI.Tree.V1.Request> serializer() {
/*    */             return (KSerializer<TreeAPI.Tree.V1.Request>)TreeAPI.Tree.V1.Request.$serializer.INSTANCE;
/*    */           }
/*    */         }
/*    */         
/*    */         @NotNull
...
/*    */         public static final Companion Companion = new Companion(null);
/*    */         @NotNull
/*    */         private final List<SentenceWithTreeDependencies> trees;
/*    */         @JvmField
/*    */         @NotNull
/*    */         private static final KSerializer<Object>[] $childSerializers;
/*    */         
/*    */         public Response(@NotNull List<SentenceWithTreeDependencies> trees) {
/*    */           this.trees = trees;
/*    */         }
/*    */         
/*    */         static {
...
/*    */         
/*    */         @NotNull
/*    */         public final List<SentenceWithTreeDependencies> getTrees() {
/*    */           return this.trees;
/*    */         }
/*    */         
/*    */         @NotNull
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\api-gateway-api-jvm-0.4.32.jar!\ai\grazie\api\gateway\api\meta\TreeAPI.class
