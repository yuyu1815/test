...
/*    */   @NotNull
/* 21 */   public static final Companion Companion = new Companion(null); @NotNull private final List<DoubleTextEmbedding> embeddings; @JvmField @NotNull
/* 22 */   private static final KSerializer<Object>[] $childSerializers; public Response(@NotNull List<DoubleTextEmbedding> embeddings) { this.embeddings = embeddings; } static { KSerializer[] arrayOfKSerializer = new KSerializer[1]; arrayOfKSerializer[0] = (KSerializer)new ArrayListSerializer((KSerializer)DoubleTextEmbedding$.serializer.INSTANCE); $childSerializers = (KSerializer<Object>[])arrayOfKSerializer; } @NotNull public final List<DoubleTextEmbedding> getEmbeddings() { return this.embeddings; }
/*    */ 
/*    */   
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\api-gateway-api-jvm-0.4.32.jar!\ai\grazie\api\gateway\api\meta\EmbAPI$Embed$V1$Response.class
