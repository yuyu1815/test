...
/*     */   @NotNull
/*  97 */   public static final Companion Companion = new Companion(null); @JvmField
/*     */   @NotNull
/*  99 */   private static final KSerializer<Object>[] $childSerializers; public Request(@NotNull List<String> urls, @Nullable String parametersJson, @Nullable String provider) { this.urls = urls;
/* 100 */     this.parametersJson = parametersJson;
/* 101 */     this.provider = provider; } @Nullable public final String getProvider() { return this.provider; }
/*     */ 
/*     */   
/*     */   static {
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\api-gateway-api-jvm-0.4.32.jar!\ai\grazie\api\gateway\api\meta\QaAPI$ExtractWeb$V1$Request.class
