...
/*    */   @NotNull
/* 19 */   public static final Companion Companion = new Companion(null); @NotNull private final List<SentenceWithNERAnnotations> annotations; @JvmField @NotNull
/* 20 */   private static final KSerializer<Object>[] $childSerializers; public Response(@NotNull List<SentenceWithNERAnnotations> annotations) { this.annotations = annotations; } static { KSerializer[] arrayOfKSerializer = new KSerializer[1]; arrayOfKSerializer[0] = (KSerializer)new ArrayListSerializer((KSerializer)SentenceWithNERAnnotations$.serializer.INSTANCE); $childSerializers = (KSerializer<Object>[])arrayOfKSerializer; } @NotNull public final List<SentenceWithNERAnnotations> getAnnotations() { return this.annotations; }
/*    */ 
/*    */   
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\api-gateway-api-jvm-0.4.32.jar!\ai\grazie\api\gateway\api\meta\NerAPI$Annotate$V1$Response.class
