...
/*    */   
/* 22 */   public Request(@NotNull String query, int size, @NotNull String dataSource, @Nullable LLMProfileID llmProfile, @Nullable String context) { this.query = query; this.size = size;
/* 23 */     this.dataSource = dataSource;
/* 24 */     this.llmProfile = llmProfile;
/* 25 */     this.context = context; } @NotNull private final String dataSource; @Nullable private final LLMProfileID llmProfile; @Nullable private final String context; @Nullable public final String getContext() { return this.context; }
/*    */ 
/*    */   
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\api-gateway-api-jvm-0.4.32.jar!\ai\grazie\api\gateway\api\meta\QaAPI$Answer$V2$Request.class
