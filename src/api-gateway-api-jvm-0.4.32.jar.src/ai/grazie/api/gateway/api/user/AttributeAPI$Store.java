...
/*    */   @NotNull
/*  9 */   public static final Store INSTANCE = new Store(); @NotNull private static final TypeInfo<Request> requestType; @NotNull private static final TypeInfo<Response> responseType; @NotNull public TypeInfo<Request> getRequestType() { return requestType; } static { int $i$f$typeInfo = 0;
/*    */ 
/*    */ 
/*    */ 
/*    */ 
...
/*    */   
/*    */   @NotNull
/*    */   private static final String path = "/user/attribute/store";
/*    */   
/*    */   @NotNull
...
/*    */         AttributeAPI.Store.Request.write$Self$api_gateway_api(value, compositeEncoder, serialDescriptor);
...
/*    */         SerialDescriptor serialDescriptor = getDescriptor();
/*    */         CompositeEncoder compositeEncoder = encoder.beginStructure(serialDescriptor);
/*    */         AttributeAPI.Store.Response.write$Self$api_gateway_api(value, compositeEncoder, serialDescriptor);
/*    */         compositeEncoder.endStructure(serialDescriptor);
/*    */       }
/*    */       
/*    */       static {
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\api-gateway-api-jvm-0.4.32.jar!\ai\grazie\api\gateway\ap\\user\AttributeAPI$Store.class
