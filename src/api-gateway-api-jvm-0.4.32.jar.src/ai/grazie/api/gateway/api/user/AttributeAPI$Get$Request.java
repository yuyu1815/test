...
/*    */   @NotNull
/* 27 */   public static final Companion Companion = new Companion(null); @NotNull private final Set<Attributes.Key> keys; @JvmField @NotNull
/* 28 */   private static final KSerializer<Object>[] $childSerializers; public Request(@NotNull Set<Attributes.Key> keys) { this.keys = keys; } @NotNull public final Set<Attributes.Key> getKeys() { return this.keys; }
/*    */ 
/*    */   
/*    */   static {
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\api-gateway-api-jvm-0.4.32.jar!\ai\grazie\api\gateway\ap\\user\AttributeAPI$Get$Request.class
