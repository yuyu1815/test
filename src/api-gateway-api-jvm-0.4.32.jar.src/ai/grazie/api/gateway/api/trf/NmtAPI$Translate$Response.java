...
/*    */   @NotNull
/* 19 */   public static final Companion Companion = new Companion(null); @NotNull private final List<SentenceWithTranslation> translations; @JvmField @NotNull
/* 20 */   private static final KSerializer<Object>[] $childSerializers; public Response(@NotNull List<SentenceWithTranslation> translations) { this.translations = translations; } static { KSerializer[] arrayOfKSerializer = new KSerializer[1]; arrayOfKSerializer[0] = (KSerializer)new ArrayListSerializer((KSerializer)SentenceWithTranslation$.serializer.INSTANCE); $childSerializers = (KSerializer<Object>[])arrayOfKSerializer; } @NotNull public final List<SentenceWithTranslation> getTranslations() { return this.translations; }
/*    */ 
/*    */   
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\api-gateway-api-jvm-0.4.32.jar!\ai\grazie\api\gateway\api\trf\NmtAPI$Translate$Response.class
