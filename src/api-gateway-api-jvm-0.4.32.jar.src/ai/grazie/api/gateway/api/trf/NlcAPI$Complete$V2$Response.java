...
/*    */   @NotNull
/* 34 */   public static final Companion Companion = new Companion(null); @JvmField @NotNull
/* 35 */   private static final KSerializer<Object>[] $childSerializers; public Response(@NotNull List<String> completions) { this.completions = completions; } @NotNull public final List<String> getCompletions() { return this.completions; }
/*    */ 
/*    */   
/*    */   static {
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\api-gateway-api-jvm-0.4.32.jar!\ai\grazie\api\gateway\api\trf\NlcAPI$Complete$V2$Response.class
