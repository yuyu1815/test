...
/*    */   @NotNull
/* 55 */   public static final Companion Companion = new Companion(null); @JvmField
/*    */   @NotNull
/* 57 */   private static final KSerializer<Object>[] $childSerializers; public Request(@NotNull List<String> texts, @Nullable Format format, @Nullable Integer minimumBPE, @Nullable Integer maximumBPE) { this.texts = texts;
/* 58 */     this.format = format;
/* 59 */     this.minimumBPE = minimumBPE;
/* 60 */     this.maximumBPE = maximumBPE; } @Nullable public Integer getMaximumBPE() { return this.maximumBPE; }
/*    */ 
/*    */   
/*    */   static {
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\api-gateway-api-jvm-0.4.32.jar!\ai\grazie\api\gateway\api\trf\SumAPI$Summarize$WithCache$V1$Request.class
