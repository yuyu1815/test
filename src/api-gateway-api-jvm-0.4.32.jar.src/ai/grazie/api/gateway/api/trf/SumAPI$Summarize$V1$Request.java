...
/*    */   @NotNull
/* 36 */   public static final Companion Companion = new Companion(null); @Nullable private final Integer maximumBPE; @JvmField
/*    */   @NotNull
/* 38 */   private static final KSerializer<Object>[] $childSerializers; public Request(@NotNull List<String> texts, @Nullable Format format, @Nullable Integer minimumBPE, @Nullable Integer maximumBPE) { this.texts = texts;
/* 39 */     this.format = format;
/* 40 */     this.minimumBPE = minimumBPE;
/* 41 */     this.maximumBPE = maximumBPE; } @Nullable public Integer getMaximumBPE() { return this.maximumBPE; }
/*    */ 
/*    */   
/*    */   static {
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\api-gateway-api-jvm-0.4.32.jar!\ai\grazie\api\gateway\api\trf\SumAPI$Summarize$V1$Request.class
