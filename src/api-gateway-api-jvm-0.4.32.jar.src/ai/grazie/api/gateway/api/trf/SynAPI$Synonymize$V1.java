...
/*    */ public final class V1 implements TypedApi<SynAPI.Synonymize.V1.Request, SynAPI.Synonymize.V1.Response> {
/*    */   @NotNull
...
/* 42 */     responseType = new TypeInfo(kType$iv, Reflection.getOrCreateKotlinClass(Response.class)); }
/*    */ 
/*    */   
/*    */   @NotNull
...
/*    */   
/*    */   @NotNull
/*    */   private static final String path = "/trf/syn/synonymize";
/*    */   
/*    */   @NotNull
...
/*    */     
/*    */     public Request(@NotNull List<TextWithHighlight> texts, @NotNull Language lang) {
/*    */       this.texts = texts;
/*    */       this.lang = lang;
/*    */     }
/*    */     
...
/*    */       arrayOfKSerializer[0] = (KSerializer)new ArrayListSerializer((KSerializer)TextWithHighlight$.serializer.INSTANCE);
...
/*    */         KSerializer[] arrayOfKSerializer1 = (KSerializer[])SynAPI.Synonymize.V1.Request.$childSerializers, arrayOfKSerializer2 = new KSerializer[2];
...
/*    */       
/*    */       @NotNull
/*    */       public SynAPI.Synonymize.V1.Request deserialize(@NotNull Decoder decoder) {
...
/*    */         KSerializer[] arrayOfKSerializer = (KSerializer[])SynAPI.Synonymize.V1.Request.$childSerializers;
...
/*    */         return new SynAPI.Synonymize.V1.Request(i, list, language, null);
/*    */       }
/*    */       
/*    */       public void serialize(@NotNull Encoder encoder, @NotNull SynAPI.Synonymize.V1.Request value) {
/*    */         Intrinsics.checkNotNullParameter(encoder, "encoder");
/*    */         Intrinsics.checkNotNullParameter(value, "value");
/*    */         SerialDescriptor serialDescriptor = getDescriptor();
/*    */         CompositeEncoder compositeEncoder = encoder.beginStructure(serialDescriptor);
/*    */         SynAPI.Synonymize.V1.Request.write$Self$api_gateway_api(value, compositeEncoder, serialDescriptor);
/*    */         compositeEncoder.endStructure(serialDescriptor);
/*    */       }
/*    */       
/*    */       static {
/*    */         PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("ai.grazie.api.gateway.api.trf.SynAPI.Synonymize.V1.Request", INSTANCE, 2);
...
/*    */     }
/*    */     
/*    */     @Metadata(mv = {1, 7, 0}, k = 1, xi = 48, d1 = {"\000\026\n\002\030\002\n\002\020\000\n\002\b\002\n\002\030\002\n\002\030\002\n\000\b\003\030\0002\0020\001B\007\b\002¢\006\002\020\002J\017\020\003\032\b\022\004\022\0020\0050\004HÆ\001¨\006\006"}, d2 = {"Lai/grazie/api/gateway/api/trf/SynAPI$Synonymize$V1$Request$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lai/grazie/api/gateway/api/trf/SynAPI$Synonymize$V1$Request;", "api-gateway-api"})
/*    */     public static final class Companion {
/*    */       private Companion() {}
/*    */       
/*    */       @NotNull
/*    */       public final KSerializer<SynAPI.Synonymize.V1.Request> serializer() {
/*    */         return (KSerializer<SynAPI.Synonymize.V1.Request>)SynAPI.Synonymize.V1.Request.$serializer.INSTANCE;
/*    */       }
/*    */     }
/*    */     
/*    */     @NotNull
/*    */     public final List<TextWithHighlight> getTexts() {
/*    */       return this.texts;
/*    */     }
/*    */     
/*    */     @NotNull
...
/*    */     public static final Companion Companion = new Companion(null);
/*    */     @NotNull
/*    */     private final List<List<String>> syn;
/*    */     @JvmField
/*    */     @NotNull
/*    */     private static final KSerializer<Object>[] $childSerializers;
/*    */     
/*    */     public Response(@NotNull List<List<String>> syn) {
/*    */       this.syn = syn;
/*    */     }
/*    */     
/*    */     static {
...
/*    */       @NotNull
/*    */       public KSerializer<?>[] childSerializers() {
/*    */         KSerializer[] arrayOfKSerializer1 = (KSerializer[])SynAPI.Synonymize.V1.Response.$childSerializers, arrayOfKSerializer2 = new KSerializer[1];
/*    */         arrayOfKSerializer2[0] = arrayOfKSerializer1[0];
/*    */         return (KSerializer<?>[])arrayOfKSerializer2;
/*    */       }
/*    */       
...
/*    */         List list = null;
/*    */         CompositeDecoder compositeDecoder = decoder.beginStructure(serialDescriptor);
/*    */         KSerializer[] arrayOfKSerializer = (KSerializer[])SynAPI.Synonymize.V1.Response.$childSerializers;
/*    */         if (compositeDecoder.decodeSequentially()) {
/*    */           list = (List)compositeDecoder.decodeSerializableElement(serialDescriptor, 0, (DeserializationStrategy)arrayOfKSerializer[0], list);
/*    */           i |= 0x1;
/*    */         } else {
...
/*    */         } 
/*    */         compositeDecoder.endStructure(serialDescriptor);
/*    */         return new SynAPI.Synonymize.V1.Response(i, list, null);
/*    */       }
/*    */       
...
/*    */         SerialDescriptor serialDescriptor = getDescriptor();
/*    */         CompositeEncoder compositeEncoder = encoder.beginStructure(serialDescriptor);
/*    */         SynAPI.Synonymize.V1.Response.write$Self$api_gateway_api(value, compositeEncoder, serialDescriptor);
/*    */         compositeEncoder.endStructure(serialDescriptor);
/*    */       }
/*    */       
/*    */       static {
/*    */         PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("ai.grazie.api.gateway.api.trf.SynAPI.Synonymize.V1.Response", INSTANCE, 1);
/*    */         pluginGeneratedSerialDescriptor.addElement("syn", false);
/*    */         descriptor = pluginGeneratedSerialDescriptor;
/*    */       }
/*    */     }
/*    */     
/*    */     @Metadata(mv = {1, 7, 0}, k = 1, xi = 48, d1 = {"\000\026\n\002\030\002\n\002\020\000\n\002\b\002\n\002\030\002\n\002\030\002\n\000\b\003\030\0002\0020\001B\007\b\002¢\006\002\020\002J\017\020\003\032\b\022\004\022\0020\0050\004HÆ\001¨\006\006"}, d2 = {"Lai/grazie/api/gateway/api/trf/SynAPI$Synonymize$V1$Response$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lai/grazie/api/gateway/api/trf/SynAPI$Synonymize$V1$Response;", "api-gateway-api"})
/*    */     public static final class Companion {
/*    */       private Companion() {}
/*    */       
/*    */       @NotNull
...
/*    */     
/*    */     @NotNull
/*    */     public final List<List<String>> getSyn() {
/*    */       return this.syn;
/*    */     }
/*    */     
/*    */     @NotNull
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\api-gateway-api-jvm-0.4.32.jar!\ai\grazie\api\gateway\api\trf\SynAPI$Synonymize$V1.class
