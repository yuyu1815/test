...
/*    */   @NotNull
/* 20 */   public static final Companion Companion = new Companion(null); @NotNull private final List<String> completions; @JvmField @NotNull
/* 21 */   private static final KSerializer<Object>[] $childSerializers; public Response(@NotNull List<String> completions) { this.completions = completions; } static { KSerializer[] arrayOfKSerializer = new KSerializer[1]; arrayOfKSerializer[0] = (KSerializer)new ArrayListSerializer((KSerializer)StringSerializer.INSTANCE); $childSerializers = (KSerializer<Object>[])arrayOfKSerializer; } @NotNull public final List<String> getCompletions() { return this.completions; }
/*    */ 
/*    */   
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\api-gateway-api-jvm-0.4.32.jar!\ai\grazie\api\gateway\api\trf\NlcAPI$Complete$V1$Response.class
