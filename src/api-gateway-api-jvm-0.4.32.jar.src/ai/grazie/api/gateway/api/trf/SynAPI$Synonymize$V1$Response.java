...
/*    */   @NotNull
/* 20 */   public static final Companion Companion = new Companion(null); @NotNull private final List<List<String>> syn; @JvmField @NotNull
/* 21 */   private static final KSerializer<Object>[] $childSerializers; public Response(@NotNull List<List<String>> syn) { this.syn = syn; } static { KSerializer[] arrayOfKSerializer = new KSerializer[1]; arrayOfKSerializer[0] = (KSerializer)new ArrayListSerializer((KSerializer)new ArrayListSerializer((KSerializer)StringSerializer.INSTANCE)); $childSerializers = (KSerializer<Object>[])arrayOfKSerializer; } @NotNull public final List<List<String>> getSyn() { return this.syn; }
/*    */ 
/*    */   
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\api-gateway-api-jvm-0.4.32.jar!\ai\grazie\api\gateway\api\trf\SynAPI$Synonymize$V1$Response.class
