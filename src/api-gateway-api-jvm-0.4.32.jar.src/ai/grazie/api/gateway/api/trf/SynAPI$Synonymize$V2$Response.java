...
/*    */   @NotNull
/* 33 */   public static final Companion Companion = new Companion(null); @JvmField @NotNull
/* 34 */   private static final KSerializer<Object>[] $childSerializers; public Response(@NotNull List<String> synonyms) { this.synonyms = synonyms; } @NotNull public final List<String> getSynonyms() { return this.synonyms; }
/*    */ 
/*    */   
/*    */   static {
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\api-gateway-api-jvm-0.4.32.jar!\ai\grazie\api\gateway\api\trf\SynAPI$Synonymize$V2$Response.class
