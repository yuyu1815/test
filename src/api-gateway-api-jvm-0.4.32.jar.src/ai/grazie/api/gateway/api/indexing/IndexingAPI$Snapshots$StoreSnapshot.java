...
/*     */ public final class StoreSnapshot implements TypedApi<IndexingAPI.Snapshots.StoreSnapshot.Request, Unit> {
/*     */   @NotNull
...
/*     */     
/*     */     public Request(@NotNull Snapshot snapshot, long clusters, @NotNull IndexDescriptor descriptor) {
...
/*     */         arrayOfKSerializer[1] = (KSerializer)LongSerializer.INSTANCE;
/*     */         arrayOfKSerializer[2] = (KSerializer)IndexDescriptor$.serializer.INSTANCE;
/*     */         return (KSerializer<?>[])arrayOfKSerializer;
/*     */       }
/*     */       
/*     */       @NotNull
/*     */       public IndexingAPI.Snapshots.StoreSnapshot.Request deserialize(@NotNull Decoder decoder) {
...
/*     */         return new IndexingAPI.Snapshots.StoreSnapshot.Request(i, snapshot, l, indexDescriptor, null);
/*     */       }
/*     */       
/*     */       public void serialize(@NotNull Encoder encoder, @NotNull IndexingAPI.Snapshots.StoreSnapshot.Request value) {
/*     */         Intrinsics.checkNotNullParameter(encoder, "encoder");
/*     */         Intrinsics.checkNotNullParameter(value, "value");
/*     */         SerialDescriptor serialDescriptor = getDescriptor();
/*     */         CompositeEncoder compositeEncoder = encoder.beginStructure(serialDescriptor);
/*     */         IndexingAPI.Snapshots.StoreSnapshot.Request.write$Self$api_gateway_api(value, compositeEncoder, serialDescriptor);
/*     */         compositeEncoder.endStructure(serialDescriptor);
/*     */       }
/*     */       
/*     */       static {
/*     */         PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("ai.grazie.api.gateway.api.indexing.IndexingAPI.Snapshots.StoreSnapshot.Request", INSTANCE, 3);
...
/*     */     }
/*     */     
/*     */     @Metadata(mv = {1, 7, 0}, k = 1, xi = 48, d1 = {"\000\026\n\002\030\002\n\002\020\000\n\002\b\002\n\002\030\002\n\002\030\002\n\000\b\003\030\0002\0020\001B\007\b\002¢\006\002\020\002J\017\020\003\032\b\022\004\022\0020\0050\004HÆ\001¨\006\006"}, d2 = {"Lai/grazie/api/gateway/api/indexing/IndexingAPI$Snapshots$StoreSnapshot$Request$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lai/grazie/api/gateway/api/indexing/IndexingAPI$Snapshots$StoreSnapshot$Request;", "api-gateway-api"})
/*     */     public static final class Companion {
/*     */       private Companion() {}
/*     */       
/*     */       @NotNull
/*     */       public final KSerializer<IndexingAPI.Snapshots.StoreSnapshot.Request> serializer() {
/*     */         return (KSerializer<IndexingAPI.Snapshots.StoreSnapshot.Request>)IndexingAPI.Snapshots.StoreSnapshot.Request.$serializer.INSTANCE;
/*     */       }
/*     */     }
/*     */     
/*     */     @NotNull
...
/*     */     
/*     */     @NotNull
/*     */     public final Request copy(@NotNull Snapshot snapshot, long clusters, @NotNull IndexDescriptor descriptor) {
/*     */       Intrinsics.checkNotNullParameter(snapshot, "snapshot");
/*     */       Intrinsics.checkNotNullParameter(descriptor, "descriptor");
/*     */       return new Request(snapshot, clusters, descriptor);
/*     */     }
/*     */     
/*     */     @NotNull
/*     */     public String toString() {
/*     */       return "Request(snapshot=" + this.snapshot + ", clusters=" + this.clusters + ", descriptor=" + this.descriptor + ")";
/*     */     }
/*     */     
/*     */     public int hashCode() {
...
/*     */       return !Intrinsics.areEqual(this.snapshot, request.snapshot) ? false : ((this.clusters != request.clusters) ? false : (!!Intrinsics.areEqual(this.descriptor, request.descriptor)));
/*     */     }
/*     */   }
/*     */   
/*     */   @Serializable
...
/*     */     
/*     */     public Response(boolean shouldProcess) {
...
/*     */       
/*     */       @NotNull
/*     */       public IndexingAPI.Snapshots.StoreSnapshot.Response deserialize(@NotNull Decoder decoder) {
/*     */         Intrinsics.checkNotNullParameter(decoder, "decoder");
/*     */         SerialDescriptor serialDescriptor = getDescriptor();
/*     */         boolean bool = true;
/*     */         int i = 0;
...
/*     */         } 
/*     */         compositeDecoder.endStructure(serialDescriptor);
/*     */         return new IndexingAPI.Snapshots.StoreSnapshot.Response(i, bool1, null);
/*     */       }
/*     */       
/*     */       public void serialize(@NotNull Encoder encoder, @NotNull IndexingAPI.Snapshots.StoreSnapshot.Response value) {
/*     */         Intrinsics.checkNotNullParameter(encoder, "encoder");
/*     */         Intrinsics.checkNotNullParameter(value, "value");
/*     */         SerialDescriptor serialDescriptor = getDescriptor();
/*     */         CompositeEncoder compositeEncoder = encoder.beginStructure(serialDescriptor);
/*     */         IndexingAPI.Snapshots.StoreSnapshot.Response.write$Self$api_gateway_api(value, compositeEncoder, serialDescriptor);
/*     */         compositeEncoder.endStructure(serialDescriptor);
/*     */       }
/*     */       
/*     */       static {
/*     */         PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("ai.grazie.api.gateway.api.indexing.IndexingAPI.Snapshots.StoreSnapshot.Response", INSTANCE, 1);
/*     */         pluginGeneratedSerialDescriptor.addElement("shouldProcess", false);
/*     */         descriptor = pluginGeneratedSerialDescriptor;
/*     */       }
/*     */     }
/*     */     
/*     */     @Metadata(mv = {1, 7, 0}, k = 1, xi = 48, d1 = {"\000\026\n\002\030\002\n\002\020\000\n\002\b\002\n\002\030\002\n\002\030\002\n\000\b\003\030\0002\0020\001B\007\b\002¢\006\002\020\002J\017\020\003\032\b\022\004\022\0020\0050\004HÆ\001¨\006\006"}, d2 = {"Lai/grazie/api/gateway/api/indexing/IndexingAPI$Snapshots$StoreSnapshot$Response$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lai/grazie/api/gateway/api/indexing/IndexingAPI$Snapshots$StoreSnapshot$Response;", "api-gateway-api"})
/*     */     public static final class Companion {
/*     */       private Companion() {}
/*     */       
/*     */       @NotNull
/*     */       public final KSerializer<IndexingAPI.Snapshots.StoreSnapshot.Response> serializer() {
/*     */         return (KSerializer<IndexingAPI.Snapshots.StoreSnapshot.Response>)IndexingAPI.Snapshots.StoreSnapshot.Response.$serializer.INSTANCE;
/*     */       }
/*     */     }
/*     */     
...
/*     */     
/*     */     @NotNull
/*     */     public final Response copy(boolean shouldProcess) {
/*     */       return new Response(shouldProcess);
/*     */     }
/*     */     
/*     */     @NotNull
/*     */     public String toString() {
/*     */       return "Response(shouldProcess=" + this.shouldProcess + ")";
/*     */     }
/*     */     
/*     */     public int hashCode() {
/*     */       return Boolean.hashCode(this.shouldProcess);
/*     */     }
/*     */     
/*     */     public boolean equals(@Nullable Object other) {
/*     */       if (this == other)
...
/*     */       return !(this.shouldProcess != response.shouldProcess);
/*     */     }
/*     */   }
/*     */ }


/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\api-gateway-api-jvm-0.4.32.jar!\ai\grazie\api\gateway\api\indexing\IndexingAPI$Snapshots$StoreSnapshot.class
