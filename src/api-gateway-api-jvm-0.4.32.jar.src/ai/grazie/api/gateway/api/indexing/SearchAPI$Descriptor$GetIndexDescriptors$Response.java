...
/*    */   @NotNull
/* 20 */   public static final Companion Companion = new Companion(null); @NotNull private final Set<IndexDescriptor> descriptors; @JvmField
/*    */   @NotNull
/* 22 */   private static final KSerializer<Object>[] $childSerializers; public Response(@NotNull Set<IndexDescriptor> descriptors) { this.descriptors = descriptors; } static { KSerializer[] arrayOfKSerializer = new KSerializer[1]; arrayOfKSerializer[0] = (KSerializer)new LinkedHashSetSerializer((KSerializer)IndexDescriptor$.serializer.INSTANCE); $childSerializers = (KSerializer<Object>[])arrayOfKSerializer; } @NotNull public final Set<IndexDescriptor> getDescriptors() { return this.descriptors; }
/*    */ 
/*    */   
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\api-gateway-api-jvm-0.4.32.jar!\ai\grazie\api\gateway\api\indexing\SearchAPI$Descriptor$GetIndexDescriptors$Response.class
