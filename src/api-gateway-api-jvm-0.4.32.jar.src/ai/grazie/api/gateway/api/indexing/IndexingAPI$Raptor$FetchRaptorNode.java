...
/*     */ public final class FetchRaptorNode
/*     */   implements TypedApi<IndexingAPI.Raptor.FetchRaptorNode.Request, IndexingAPI.Raptor.FetchRaptorNode.Response>
/*     */ {
/*     */   @NotNull
...
/*     */   @NotNull
/* 113 */   public static final FetchRaptorNode INSTANCE = new FetchRaptorNode(); @NotNull public TypeInfo<Request> getRequestType() { return requestType; } static { int $i$f$typeInfo = 0;
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */   
/*     */   @NotNull
/*     */   private static final String path = "/indexing/raptor/fetch";
/*     */   
/*     */   @NotNull
...
/*     */     
/*     */     public Request(@NotNull IndexDescriptor descriptor, @NotNull Snapshot snapshot, @NotNull List<String> paths) {
...
/*     */       @NotNull
/*     */       public KSerializer<?>[] childSerializers() {
/*     */         KSerializer[] arrayOfKSerializer1 = (KSerializer[])IndexingAPI.Raptor.FetchRaptorNode.Response.$childSerializers, arrayOfKSerializer2 = new KSerializer[1];
/*     */         arrayOfKSerializer2[0] = arrayOfKSerializer1[0];
/*     */         return (KSerializer<?>[])arrayOfKSerializer2;
/*     */       }
/*     */       
/*     */       @NotNull
/*     */       public IndexingAPI.Raptor.FetchRaptorNode.Response deserialize(@NotNull Decoder decoder) {
/*     */         Intrinsics.checkNotNullParameter(decoder, "decoder");
/*     */         SerialDescriptor serialDescriptor = getDescriptor();
/*     */         boolean bool = true;
/*     */         int i = 0;
/*     */         List list = null;
/*     */         CompositeDecoder compositeDecoder = decoder.beginStructure(serialDescriptor);
/*     */         KSerializer[] arrayOfKSerializer = (KSerializer[])IndexingAPI.Raptor.FetchRaptorNode.Response.$childSerializers;
/*     */         if (compositeDecoder.decodeSequentially()) {
...
/*     */         } 
/*     */         compositeDecoder.endStructure(serialDescriptor);
/*     */         return new IndexingAPI.Raptor.FetchRaptorNode.Response(i, list, null);
/*     */       }
/*     */       
/*     */       public void serialize(@NotNull Encoder encoder, @NotNull IndexingAPI.Raptor.FetchRaptorNode.Response value) {
/*     */         Intrinsics.checkNotNullParameter(encoder, "encoder");
/*     */         Intrinsics.checkNotNullParameter(value, "value");
/*     */         SerialDescriptor serialDescriptor = getDescriptor();
/*     */         CompositeEncoder compositeEncoder = encoder.beginStructure(serialDescriptor);
/*     */         IndexingAPI.Raptor.FetchRaptorNode.Response.write$Self$api_gateway_api(value, compositeEncoder, serialDescriptor);
/*     */         compositeEncoder.endStructure(serialDescriptor);
/*     */       }
/*     */       
/*     */       static {
/*     */         PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("ai.grazie.api.gateway.api.indexing.IndexingAPI.Raptor.FetchRaptorNode.Response", INSTANCE, 1);
...
/*     */       
/*     */       @NotNull
/*     */       public final KSerializer<IndexingAPI.Raptor.FetchRaptorNode.Response> serializer() {
/*     */         return (KSerializer<IndexingAPI.Raptor.FetchRaptorNode.Response>)IndexingAPI.Raptor.FetchRaptorNode.Response.$serializer.INSTANCE;
/*     */       }
/*     */     }
/*     */     
/*     */     @NotNull
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\api-gateway-api-jvm-0.4.32.jar!\ai\grazie\api\gateway\api\indexing\IndexingAPI$Raptor$FetchRaptorNode.class
