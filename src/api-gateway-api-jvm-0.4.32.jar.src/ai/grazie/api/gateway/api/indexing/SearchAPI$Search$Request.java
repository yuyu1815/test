...
/*     */   @NotNull
/* 121 */   public static final Companion Companion = new Companion(null);
...
/* 126 */     this.revision = revision;
/* 127 */     this.maxResults = maxResults;
/* 128 */     this.minScore = minScore;
/* 129 */     this.pathFilter = pathFilter;
/* 130 */     this.logAllowed = logAllowed; } public final boolean getLogAllowed() { return this.logAllowed; }
/*     */ 
/*     */   
/*     */   static {
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\api-gateway-api-jvm-0.4.32.jar!\ai\grazie\api\gateway\api\indexing\SearchAPI$Search$Request.class
