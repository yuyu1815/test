...
/*     */ public final class FinalizeCluster
/*     */   implements TypedApi<IndexingAPI.Clusters.FinalizeCluster.Request, Unit>
/*     */ {
/*     */   @NotNull
/*  71 */   public static final FinalizeCluster INSTANCE = new FinalizeCluster(); @NotNull private static final HttpMethod httpMethod = HttpMethod.Post; @NotNull public HttpMethod getHttpMethod() { return httpMethod; } @NotNull
/*  72 */   private static final String path = "/indexing/finalize-cluster"; @NotNull private static final TypeInfo<Request> requestType; @NotNull public String getPath() { return path; } @NotNull
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\api-gateway-api-jvm-0.4.32.jar!\ai\grazie\api\gateway\api\indexing\IndexingAPI$Clusters$FinalizeCluster.class
