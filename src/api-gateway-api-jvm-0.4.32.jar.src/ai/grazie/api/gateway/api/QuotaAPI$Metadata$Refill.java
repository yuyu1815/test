...
/*    */ import ai.grazie.quota.QuotaRefill;
/*    */ import ai.grazie.quota.QuotaRefill$;
...
/*    */ public final class Refill implements UnitTypedApi<QuotaAPI.Metadata.Refill.Response> {
/*    */   @NotNull
/* 29 */   public static final Refill INSTANCE = new Refill(); @NotNull private static final TypeInfo<Response> responseType; @NotNull public TypeInfo<Response> getResponseType() { return responseType; } static { int $i$f$typeInfo = 0;
/*    */ 
/*    */ 
/*    */ 
/*    */ 
...
/* 49 */     responseType = new TypeInfo(kType$iv, Reflection.getOrCreateKotlinClass(Response.class)); }
/*    */ 
/*    */   
/*    */   @NotNull
...
/*    */   
/*    */   @NotNull
/*    */   private static final String path = "/quota/metadata/refill";
/*    */   
/*    */   @NotNull
...
/*    */     @NotNull
/*    */     private final QuotaRefill current;
/*    */     
/*    */     public Response(@NotNull QuotaRefill current) {
...
/*    */         arrayOfKSerializer[0] = (KSerializer)QuotaRefill$.serializer.INSTANCE;
/*    */         return (KSerializer<?>[])arrayOfKSerializer;
/*    */       }
/*    */       
/*    */       @NotNull
/*    */       public QuotaAPI.Metadata.Refill.Response deserialize(@NotNull Decoder decoder) {
/*    */         Intrinsics.checkNotNullParameter(decoder, "decoder");
/*    */         SerialDescriptor serialDescriptor = getDescriptor();
/*    */         boolean bool = true;
/*    */         int i = 0;
/*    */         QuotaRefill quotaRefill = null;
/*    */         CompositeDecoder compositeDecoder = decoder.beginStructure(serialDescriptor);
/*    */         if (compositeDecoder.decodeSequentially()) {
/*    */           quotaRefill = (QuotaRefill)compositeDecoder.decodeSerializableElement(serialDescriptor, 0, (DeserializationStrategy)QuotaRefill$.serializer.INSTANCE, quotaRefill);
/*    */           i |= 0x1;
/*    */         } else {
/*    */           while (bool) {
...
/*    */         return new QuotaAPI.Metadata.Refill.Response(i, quotaRefill, null);
/*    */       }
/*    */       
/*    */       public void serialize(@NotNull Encoder encoder, @NotNull QuotaAPI.Metadata.Refill.Response value) {
/*    */         Intrinsics.checkNotNullParameter(encoder, "encoder");
/*    */         Intrinsics.checkNotNullParameter(value, "value");
/*    */         SerialDescriptor serialDescriptor = getDescriptor();
/*    */         CompositeEncoder compositeEncoder = encoder.beginStructure(serialDescriptor);
/*    */         QuotaAPI.Metadata.Refill.Response.write$Self$api_gateway_api(value, compositeEncoder, serialDescriptor);
/*    */         compositeEncoder.endStructure(serialDescriptor);
/*    */       }
/*    */       
/*    */       static {
/*    */         PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("ai.grazie.api.gateway.api.QuotaAPI.Metadata.Refill.Response", INSTANCE, 1);
/*    */         pluginGeneratedSerialDescriptor.addElement("current", false);
/*    */         descriptor = pluginGeneratedSerialDescriptor;
/*    */       }
/*    */     }
/*    */     
/*    */     @Metadata(mv = {1, 7, 0}, k = 1, xi = 48, d1 = {"\000\026\n\002\030\002\n\002\020\000\n\002\b\002\n\002\030\002\n\002\030\002\n\000\b\003\030\0002\0020\001B\007\b\002¢\006\002\020\002J\017\020\003\032\b\022\004\022\0020\0050\004HÆ\001¨\006\006"}, d2 = {"Lai/grazie/api/gateway/api/QuotaAPI$Metadata$Refill$Response$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lai/grazie/api/gateway/api/QuotaAPI$Metadata$Refill$Response;", "api-gateway-api"})
/*    */     public static final class Companion {
/*    */       private Companion() {}
/*    */       
/*    */       @NotNull
/*    */       public final KSerializer<QuotaAPI.Metadata.Refill.Response> serializer() {
/*    */         return (KSerializer<QuotaAPI.Metadata.Refill.Response>)QuotaAPI.Metadata.Refill.Response.$serializer.INSTANCE;
/*    */       }
/*    */     }
/*    */     
/*    */     @NotNull
/*    */     public final QuotaRefill getCurrent() {
/*    */       return this.current;
/*    */     }
/*    */     
/*    */     @NotNull
/*    */     public final QuotaRefill component1() {
/*    */       return this.current;
/*    */     }
/*    */     
/*    */     @NotNull
/*    */     public final Response copy(@NotNull QuotaRefill current) {
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\api-gateway-api-jvm-0.4.32.jar!\ai\grazie\api\gateway\api\QuotaAPI$Metadata$Refill.class
