...
/*    */   @NotNull
/* 27 */   public static final Companion Companion = new Companion(null); @NotNull private final List<SentenceWithCorrections> corrections; @JvmField @NotNull
/* 28 */   private static final KSerializer<Object>[] $childSerializers; public Response(@NotNull List<SentenceWithCorrections> corrections) { this.corrections = corrections; } @NotNull public final List<SentenceWithCorrections> getCorrections() { return this.corrections; }
/*    */ 
/*    */   
/*    */   static {
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\api-gateway-api-jvm-0.4.32.jar!\ai\grazie\api\gateway\api\gec\GecAPI$Correct$V1$Response.class
