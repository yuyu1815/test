...
/*    */   @NotNull
/* 66 */   public static final Companion Companion = new Companion(null); @JvmField
/*    */   @NotNull
/* 68 */   private static final KSerializer<Object>[] $childSerializers; public Request(@NotNull Language lang, @NotNull List<SentenceWithExclusions> sentences, @Nullable Set<CorrectionServiceType> services, @Nullable UserSettings userSettings) { this.lang = lang;
/* 69 */     this.sentences = sentences;
/* 70 */     this.services = services;
/* 71 */     this.userSettings = userSettings; } @Nullable public final UserSettings getUserSettings() { return this.userSettings; }
/*    */ 
/*    */   
/*    */   static {
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\api-gateway-api-jvm-0.4.32.jar!\ai\grazie\api\gateway\api\gec\GecAPI$Correct$V4$Request.class
