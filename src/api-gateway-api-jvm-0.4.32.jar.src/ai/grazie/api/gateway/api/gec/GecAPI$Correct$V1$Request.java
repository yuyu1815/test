...
/*    */   @NotNull
/* 20 */   public static final Companion Companion = new Companion(null); @NotNull private final Language lang; @NotNull private final List<String> texts; @Nullable private final Set<CorrectionServiceType> services; @JvmField
/*    */   @NotNull
/* 22 */   private static final KSerializer<Object>[] $childSerializers; public Request(@NotNull Language lang, @NotNull List<String> texts, @Nullable Set<CorrectionServiceType> services) { this.lang = lang;
/* 23 */     this.texts = texts;
/* 24 */     this.services = services; } static { KSerializer[] arrayOfKSerializer = new KSerializer[3]; arrayOfKSerializer[0] = null; arrayOfKSerializer[1] = (KSerializer)new ArrayListSerializer((KSerializer)StringSerializer.INSTANCE); arrayOfKSerializer[2] = (KSerializer)new LinkedHashSetSerializer((KSerializer)CorrectionServiceType.Serializer.INSTANCE); $childSerializers = (KSerializer<Object>[])arrayOfKSerializer; } @Nullable public final Set<CorrectionServiceType> getServices() { return this.services; }
/*    */ 
/*    */   
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\api-gateway-api-jvm-0.4.32.jar!\ai\grazie\api\gateway\api\gec\GecAPI$Correct$V1$Request.class
