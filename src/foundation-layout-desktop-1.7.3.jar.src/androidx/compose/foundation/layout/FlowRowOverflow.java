...
/*  84 */       return FlowRowOverflow.Visible;
/*     */     }
/*     */ 
/*     */ 
/*     */     
...
/*  92 */       return FlowRowOverflow.Clip;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @ExperimentalLayoutApi
/*     */     @NotNull
/*     */     public final FlowRowOverflow expandIndicator(@NotNull Function3<? super FlowRowOverflowScope, ? super Composer, ? super Integer, Unit> content) {
/* 110 */       Intrinsics.checkNotNullParameter(content, "content"); Function1 seeMoreGetter = new FlowRowOverflow$Companion$expandIndicator$seeMoreGetter$1(content);
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */       
/* 116 */       return new FlowRowOverflow(
/* 117 */           FlowLayoutOverflow.OverflowType.ExpandIndicator, 0, 0, 
/* 118 */           seeMoreGetter, null, 22, null);
/*     */     }
/*     */     
...
/*     */     static final class FlowRowOverflow$Companion$expandIndicator$seeMoreGetter$1
/*     */       extends Lambda
...
/*     */         return (Function2<Composer, Integer, Unit>)ComposableLambdaKt.composableLambdaInstance(263270381, true, new Function2<Composer, Integer, Unit>(state, this.$content)
/*     */             {
/*     */               @Composable
...
/*     */                   FlowRowOverflowScopeImpl scope = new FlowRowOverflowScopeImpl(this.$state);
...
/*     */       }
/*     */       
/*     */       FlowRowOverflow$Companion$expandIndicator$seeMoreGetter$1(Function3<FlowRowOverflowScope, Composer, Integer, Unit> $content) {
/*     */         super(1);
/*     */       }
/*     */     }
/*     */     
...
/*     */     @Composable
/*     */     @NotNull
/*     */     public final FlowRowOverflow expandOrCollapseIndicator--jt2gSs(@NotNull Function3 expandIndicator, @NotNull Function3 collapseIndicator, int minRowsToShowCollapse, float minHeightToShowCollapse, @Nullable Composer $composer, int $changed, int param1Int1) {
/*     */       // Byte code:
/*     */       //   0: aload_1
...
/*     */       //   12: aload #5
/*     */       //   14: ldc -58693346
/*     */       //   16: ldc 'C(expandOrCollapseIndicator)P(1!1,3,2:c#ui.unit.Dp)*155@7080L7,158@7176L1079:FlowLayoutOverflow.kt#2w3rfo'
...
/*     */       //   60: iload #6
/*     */       //   62: iconst_m1
/*     */       //   63: ldc 'androidx.compose.foundation.layout.FlowRowOverflow.Companion.expandOrCollapseIndicator (FlowLayoutOverflow.kt:154)'
...
/*     */       //   308: iconst_0
/*     */       //   309: istore #16
/*     */       //   311: new androidx/compose/foundation/layout/FlowRowOverflow$Companion$expandOrCollapseIndicator$1$seeMoreGetter$1
/*     */       //   314: dup
/*     */       //   315: aload_1
/*     */       //   316: invokespecial <init> : (Lkotlin/jvm/functions/Function3;)V
/*     */       //   319: checkcast kotlin/jvm/functions/Function1
/*     */       //   322: astore #17
/*     */       //   324: new androidx/compose/foundation/layout/FlowRowOverflow$Companion$expandOrCollapseIndicator$1$collapseGetter$1
/*     */       //   327: dup
/*     */       //   328: aload_2
/*     */       //   329: invokespecial <init> : (Lkotlin/jvm/functions/Function3;)V
/*     */       //   332: checkcast kotlin/jvm/functions/Function1
/*     */       //   335: astore #18
/*     */       //   337: new androidx/compose/foundation/layout/FlowRowOverflow
/*     */       //   340: dup
...
/*     */       //   374: nop
/*     */       //   375: nop
/*     */       //   376: checkcast androidx/compose/foundation/layout/FlowRowOverflow
/*     */       //   379: astore #10
/*     */       //   381: aload #5
...
/*     */       //   117	9	11	$i$a$-with-FlowRowOverflow$Companion$expandOrCollapseIndicator$minHeightToShowCollapsePx$1	I
/*     */       //   114	12	10	$this$expandOrCollapseIndicator__jt2gSs_u24lambda_u240	Landroidx/compose/ui/unit/Density;
/*     */       //   311	44	16	$i$a$-cache-FlowRowOverflow$Companion$expandOrCollapseIndicator$1	I
...
/*     */       //   0	407	0	this	Landroidx/compose/foundation/layout/FlowRowOverflow$Companion;
...
/*     */     
/*     */     @Metadata(mv = {1, 9, 0}, k = 3, xi = 48, d1 = {"\000\030\n\000\n\002\030\002\n\002\020\002\n\002\030\002\n\000\n\002\030\002\n\002\b\002\020\000\032\r\022\004\022\0020\0020\001¢\006\002\b\0032\006\020\004\032\0020\005H\n¢\006\004\b\006\020\007"}, d2 = {"<anonymous>", "Lkotlin/Function0;", "", "Landroidx/compose/runtime/Composable;", "state", "Landroidx/compose/foundation/layout/FlowLayoutOverflowState;", "invoke", "(Landroidx/compose/foundation/layout/FlowLayoutOverflowState;)Lkotlin/jvm/functions/Function2;"})
/*     */     static final class FlowRowOverflow$Companion$expandOrCollapseIndicator$1$seeMoreGetter$1
/*     */       extends Lambda
/*     */       implements Function1<FlowLayoutOverflowState, Function2<? super Composer, ? super Integer, ? extends Unit>>
/*     */     {
/*     */       @NotNull
/* 166 */       public final Function2<Composer, Integer, Unit> invoke(@NotNull FlowLayoutOverflowState state) { Intrinsics.checkNotNullParameter(state, "state"); return (Function2<Composer, Integer, Unit>)ComposableLambdaKt.composableLambdaInstance(2094557836, true, new Function2<Composer, Integer, Unit>(state, this.$expandIndicator) { @Composable
/* 167 */               public final void invoke(@Nullable Composer $composer, int $changed) { ComposerKt.sourceInformation($composer, "C167@7555L17:FlowLayoutOverflow.kt#2w3rfo"); if (($changed & 0x3) != 2 || !$composer.getSkipping()) { if (ComposerKt.isTraceInProgress()) ComposerKt.traceEventStart(2094557836, $changed, -1, "androidx.compose.foundation.layout.FlowRowOverflow.Companion.expandOrCollapseIndicator.<anonymous>.<anonymous>.<anonymous> (FlowLayoutOverflow.kt:166)");  FlowRowOverflowScopeImpl scope = new FlowRowOverflowScopeImpl(this.$state);
/* 168 */                   this.$expandIndicator.invoke(scope, $composer, Integer.valueOf(0)); if (ComposerKt.isTraceInProgress()) ComposerKt.traceEventEnd();  } else { $composer.skipToGroupEnd(); }
/*     */                  } }
/*     */           ); } FlowRowOverflow$Companion$expandOrCollapseIndicator$1$seeMoreGetter$1(Function3<FlowRowOverflowScope, Composer, Integer, Unit> $expandIndicator) { super(1); }
/*     */     } @Metadata(mv = {1, 9, 0}, k = 3, xi = 48, d1 = {"\000\030\n\000\n\002\030\002\n\002\020\002\n\002\030\002\n\000\n\002\030\002\n\002\b\002\020\000\032\r\022\004\022\0020\0020\001¢\006\002\b\0032\006\020\004\032\0020\005H\n¢\006\004\b\006\020\007"}, d2 = {"<anonymous>", "Lkotlin/Function0;", "", "Landroidx/compose/runtime/Composable;", "state", "Landroidx/compose/foundation/layout/FlowLayoutOverflowState;", "invoke", "(Landroidx/compose/foundation/layout/FlowLayoutOverflowState;)Lkotlin/jvm/functions/Function2;"})
/*     */     static final class FlowRowOverflow$Companion$expandOrCollapseIndicator$1$collapseGetter$1 extends Lambda implements Function1<FlowLayoutOverflowState, Function2<? super Composer, ? super Integer, ? extends Unit>> { @NotNull
/* 173 */       public final Function2<Composer, Integer, Unit> invoke(@NotNull FlowLayoutOverflowState state) { Intrinsics.checkNotNullParameter(state, "state"); return (Function2<Composer, Integer, Unit>)ComposableLambdaKt.composableLambdaInstance(-972285589, true, new Function2<Composer, Integer, Unit>(state, this.$collapseIndicator) { @Composable
/* 174 */               public final void invoke(@Nullable Composer $composer, int $changed) { ComposerKt.sourceInformation($composer, "C174@7819L19:FlowLayoutOverflow.kt#2w3rfo"); if (($changed & 0x3) != 2 || !$composer.getSkipping()) { if (ComposerKt.isTraceInProgress()) ComposerKt.traceEventStart(-972285589, $changed, -1, "androidx.compose.foundation.layout.FlowRowOverflow.Companion.expandOrCollapseIndicator.<anonymous>.<anonymous>.<anonymous> (FlowLayoutOverflow.kt:173)");  FlowRowOverflowScopeImpl scope = new FlowRowOverflowScopeImpl(this.$state);
/* 175 */                   this.$collapseIndicator.invoke(scope, $composer, Integer.valueOf(0)); if (ComposerKt.isTraceInProgress()) ComposerKt.traceEventEnd();  } else { $composer.skipToGroupEnd(); }
/*     */                  }
/*     */                }
/*     */           ); }
/*     */ 
/*     */       
/*     */       FlowRowOverflow$Companion$expandOrCollapseIndicator$1$collapseGetter$1(Function3<FlowRowOverflowScope, Composer, Integer, Unit> $collapseIndicator) {
/*     */         super(1);
/*     */       } }
/*     */      }
/*     */ 
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\foundation-layout-desktop-1.7.3.jar!\androidx\compose\foundation\layout\FlowRowOverflow.class
