...
/*    */ {
/*    */   @NotNull
/* 50 */   public static final $serializer INSTANCE = new $serializer(); @NotNull public KSerializer<?>[] typeParametersSerializers() { return (KSerializer<?>[])GeneratedSerializer.DefaultImpls.typeParametersSerializers(this); } @NotNull public SerialDescriptor getDescriptor() { return (SerialDescriptor)descriptor; } @NotNull public KSerializer<?>[] childSerializers() { KSerializer[] arrayOfKSerializer = new KSerializer[3]; arrayOfKSerializer[0] = (KSerializer)Keystroke.$serializer.INSTANCE; arrayOfKSerializer[1] = BuiltinSerializersKt.getNullable((KSerializer)Keystroke.$serializer.INSTANCE); arrayOfKSerializer[2] = (KSerializer)IntSerializer.INSTANCE; return (KSerializer<?>[])arrayOfKSerializer; } @NotNull public Shortcut deserialize(@NotNull Decoder decoder) { Intrinsics.checkNotNullParameter(decoder, "decoder"); SerialDescriptor serialDescriptor = getDescriptor(); boolean bool = true; int i = 0; Keystroke keystroke1 = null, keystroke2 = null; int j = 0; CompositeDecoder compositeDecoder = decoder.beginStructure(serialDescriptor); if (compositeDecoder.decodeSequentially()) { keystroke1 = (Keystroke)compositeDecoder.decodeSerializableElement(serialDescriptor, 0, (DeserializationStrategy)Keystroke.$serializer.INSTANCE, keystroke1); i |= 0x1; keystroke2 = (Keystroke)compositeDecoder.decodeNullableSerializableElement(serialDescriptor, 1, (DeserializationStrategy)Keystroke.$serializer.INSTANCE, keystroke2); i |= 0x2; j = compositeDecoder.decodeIntElement(serialDescriptor, 2); i |= 0x4; } else { while (bool) { int k = compositeDecoder.decodeElementIndex(serialDescriptor); switch (k) { case -1: bool = false; continue;case 0: keystroke1 = (Keystroke)compositeDecoder.decodeSerializableElement(serialDescriptor, 0, (DeserializationStrategy)Keystroke.$serializer.INSTANCE, keystroke1); i |= 0x1; continue;case 1: keystroke2 = (Keystroke)compositeDecoder.decodeNullableSerializableElement(serialDescriptor, 1, (DeserializationStrategy)Keystroke.$serializer.INSTANCE, keystroke2); i |= 0x2; continue;case 2: j = compositeDecoder.decodeIntElement(serialDescriptor, 2); i |= 0x4; continue; }  throw new UnknownFieldException(k); }  }  compositeDecoder.endStructure(serialDescriptor); return new Shortcut(i, keystroke1, keystroke2, j, null); } public void serialize(@NotNull Encoder encoder, @NotNull Shortcut value) { Intrinsics.checkNotNullParameter(encoder, "encoder"); Intrinsics.checkNotNullParameter(value, "value"); SerialDescriptor serialDescriptor = getDescriptor(); CompositeEncoder compositeEncoder = encoder.beginStructure(serialDescriptor); Shortcut.write$Self$user_cfg_model(value, compositeEncoder, serialDescriptor); compositeEncoder.endStructure(serialDescriptor); } static { PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("ai.grazie.user.cfg.model.utils.Shortcut", INSTANCE, 3); pluginGeneratedSerialDescriptor.addElement("firstStroke", false); pluginGeneratedSerialDescriptor.addElement("secondStroke", true); pluginGeneratedSerialDescriptor.addElement("os", true); descriptor = pluginGeneratedSerialDescriptor; }
/*    */ 
/*    */ }


/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\li\\user-cfg-model-jvm-0.4.32.jar!\ai\grazi\\user\cfg\mode\\utils\Shortcut$$serializer.class
