...
/* 47 */     if (($changed & 0x3) != 2 || !$composer.getSkipping()) { if (ComposerKt.isTraceInProgress()) ComposerKt.traceEventStart(1452848738, $changed, -1, "org.jetbrains.jewel.bridge.JewelToolWindowComposePanel.<anonymous>.<anonymous>.<anonymous>.<anonymous> (JewelComposePanel.kt:46)");  CompositionLocalKt.CompositionLocalProvider(JewelComposePanelKt.getLocalComponent().provides(this.$this_createJewelComposePanel), (Function2)ComposableLambdaKt.rememberComposableLambda(1432996258, true, new Function2<Composer, Integer, Unit>(this.$jewelPanel, this.$content) { @Composable @ComposableTarget(applier = "androidx.compose.ui.UiComposable")
...
/* 49 */         ComposerKt.traceEventEnd();  } else { $composer.skipToGroupEnd(); }
/*    */   
/*    */   }
/*    */   
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\jewel-ide-laf-bridge-243-0.27.0.jar!\org\jetbrains\jewel\bridge\JewelComposePanelKt$JewelToolWindowComposePanel$2$1$1$1.class
