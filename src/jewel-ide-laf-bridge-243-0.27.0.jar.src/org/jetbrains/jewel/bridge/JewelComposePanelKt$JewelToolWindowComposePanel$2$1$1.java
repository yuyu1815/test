...
/* 46 */     if (($changed & 0x3) != 2 || !$composer.getSkipping()) { if (ComposerKt.isTraceInProgress()) ComposerKt.traceEventStart(29922865, $changed, -1, "org.jetbrains.jewel.bridge.JewelToolWindowComposePanel.<anonymous>.<anonymous>.<anonymous> (JewelComposePanel.kt:45)");  SwingBridgeThemeKt.SwingBridgeTheme((Function2)ComposableLambdaKt.rememberComposableLambda(1452848738, true, new Function2<Composer, Integer, Unit>(this.$this_createJewelComposePanel, this.$jewelPanel, this.$content) { @Composable @ComposableTarget(applier = "androidx.compose.ui.UiComposable")
...
/* 50 */         ComposerKt.traceEventEnd();  } else { $composer.skipToGroupEnd(); }
/*    */   
/*    */   }
/*    */   
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\jewel-ide-laf-bridge-243-0.27.0.jar!\org\jetbrains\jewel\bridge\JewelComposePanelKt$JewelToolWindowComposePanel$2$1$1.class
