...
/*    */ 
/*    */ 
/*    */ @Metadata(mv = {1, 7, 0}, k = 1, xi = 48, d1 = {"\000&\n\002\030\002\n\002\020\000\n\002\b\002\n\002\020\013\n\000\n\002\020\016\n\000\n\002\020 \n\000\n\002\030\002\n\002\b\003\b\003\030\0002\0020\001B\007\b\002¢\006\002\020\002J\016\020\003\032\0020\0042\006\020\005\032\0020\006J\026\020\007\032\b\022\004\022\0020\0060\b2\006\020\005\032\0020\006H\002J\016\020\t\032\0020\n2\006\020\005\032\0020\006J\020\020\013\032\004\030\0010\n2\006\020\f\032\0020\006¨\006\r"}, d2 = {"Lai/grazie/model/cloud/ip/IPv6Address$Companion;", "", "()V", "check", "", "ip", "", "chunks", "", "parse", "Lai/grazie/model/cloud/ip/IPv6Address;", "parseOrNull", "ipAddress", "model-cloud"})
/*    */ @SourceDebugExtension({"SMAP\nIPv6Address.kt\nKotlin\n*S Kotlin\n*F\n+ 1 IPv6Address.kt\nai/grazie/model/cloud/ip/IPv6Address$Companion\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n+ 3 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,81:1\n1#2:82\n1734#3,3:83\n1368#3:86\n1454#3,5:87\n1557#3:92\n1628#3,3:93\n*S KotlinDebug\n*F\n+ 1 IPv6Address.kt\nai/grazie/model/cloud/ip/IPv6Address$Companion\n*L\n29#1:83,3\n40#1:86\n40#1:87,5\n42#1:92\n42#1:93,3\n*E\n"})
/*    */ public final class Companion {
/*    */   private Companion() {}
/*    */   
/*  9 */   private final List<String> chunks(String ip) { String[] arrayOfString = new String[1]; arrayOfString[0] = ":"; List<String> split = StringsKt.split$default(ip, arrayOfString, false, 0, 6, null);
/* 10 */     int zerosIndex = split.indexOf("");
/* 11 */     int zerosCount = 8 - split.size() + 1;
/* 12 */     ArrayList<String> result = new ArrayList();
/* 13 */     for (int i = 0, j = split.size(); i < j; i++)
/* 14 */     { if (i == zerosIndex)
/* 15 */       { ArrayList<String> arrayList1; byte b; ArrayList<String> arrayList2; for (arrayList2 = result, arrayList1 = new ArrayList(zerosCount), b = 0; b < zerosCount; ) { byte b1 = b, b2 = b1;
/*    */ 
/*    */ 
/*    */ 
/*    */ 
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\model-cloud-jvm-0.4.32.jar!\ai\grazie\model\cloud\ip\IPv6Address$Companion.class
