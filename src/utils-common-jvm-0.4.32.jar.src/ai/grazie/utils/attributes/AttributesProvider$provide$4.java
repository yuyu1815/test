...
/* 170 */     Intrinsics.checkNotNullParameter(value, "value"); return (Attributes.Value)this.$set.invoke(id, ((Attributes.Value.Long)value).getValue());
/*     */   }
/*     */   
/*     */   AttributesProvider$provide$4(Function2<Entity, Long, Attributes.Value.Long> $set) {
/*     */     super(2);
/*     */   }
/*     */ }


/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\li\\utils-common-jvm-0.4.32.jar!\ai\grazi\\utils\attributes\AttributesProvider$provide$4.class
