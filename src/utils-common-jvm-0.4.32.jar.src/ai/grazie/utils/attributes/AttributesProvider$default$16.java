...
/*     */ final class AttributesProvider$default$16
/*     */   extends Lambda
...
/* 107 */     Intrinsics.checkNotNullParameter(key, "key"); Intrinsics.checkNotNullParameter(value, "value"); return (Attributes.Value)this.$set.invoke(key, id, ((Attributes.Value.Text)value).getValue());
/*     */   }
/*     */   
/*     */   AttributesProvider$default$16(Function3<Attributes.Key.Text, Entity, String, Attributes.Value.Text> $set) {
/*     */     super(3);
/*     */   }
/*     */ }


/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\li\\utils-common-jvm-0.4.32.jar!\ai\grazi\\utils\attributes\AttributesProvider$default$16.class
