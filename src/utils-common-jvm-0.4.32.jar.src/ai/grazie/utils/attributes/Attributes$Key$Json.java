...
/*     */   {
/*     */     @NotNull
/*  96 */     public static final $serializer INSTANCE = new $serializer(); @NotNull public KSerializer<?>[] typeParametersSerializers() { return (KSerializer<?>[])GeneratedSerializer.DefaultImpls.typeParametersSerializers(this); } @NotNull public SerialDescriptor getDescriptor() { return (SerialDescriptor)descriptor; } @NotNull public KSerializer<?>[] childSerializers() { KSerializer[] arrayOfKSerializer = new KSerializer[1]; arrayOfKSerializer[0] = (KSerializer)StringSerializer.INSTANCE; return (KSerializer<?>[])arrayOfKSerializer; } @NotNull public Attributes.Key.Json deserialize(@NotNull Decoder decoder) { Intrinsics.checkNotNullParameter(decoder, "decoder"); SerialDescriptor serialDescriptor = getDescriptor(); boolean bool = true; int i = 0; String str = null; CompositeDecoder compositeDecoder = decoder.beginStructure(serialDescriptor); if (compositeDecoder.decodeSequentially()) { str = compositeDecoder.decodeStringElement(serialDescriptor, 0); i |= 0x1; } else { while (bool) { int j = compositeDecoder.decodeElementIndex(serialDescriptor); switch (j) { case -1: bool = false; continue;case 0: str = compositeDecoder.decodeStringElement(serialDescriptor, 0); i |= 0x1; continue; }  throw new UnknownFieldException(j); }  }  compositeDecoder.endStructure(serialDescriptor); return new Attributes.Key.Json(i, str, null); } public void serialize(@NotNull Encoder encoder, @NotNull Attributes.Key.Json value) { Intrinsics.checkNotNullParameter(encoder, "encoder"); Intrinsics.checkNotNullParameter(value, "value"); SerialDescriptor serialDescriptor = getDescriptor(); CompositeEncoder compositeEncoder = encoder.beginStructure(serialDescriptor); Attributes.Key.Json.write$Self$utils_common(value, compositeEncoder, serialDescriptor); compositeEncoder.endStructure(serialDescriptor); } static { PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("json", INSTANCE, 1); pluginGeneratedSerialDescriptor.addElement("fqdn", false); descriptor = pluginGeneratedSerialDescriptor; } } @Metadata(mv = {1, 7, 0}, k = 1, xi = 48, d1 = {"\000\026\n\002\030\002\n\002\020\000\n\002\b\002\n\002\030\002\n\002\030\002\n\000\b\003\030\0002\0020\001B\007\b\002¢\006\002\020\002J\017\020\003\032\b\022\004\022\0020\0050\004HÆ\001¨\006\006"}, d2 = {"Lai/grazie/utils/attributes/Attributes$Key$Json$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lai/grazie/utils/attributes/Attributes$Key$Json;", "utils-common"}) public static final class Companion { @NotNull public final KSerializer<Attributes.Key.Json> serializer() { return (KSerializer<Attributes.Key.Json>)Attributes.Key.Json.$serializer.INSTANCE; }
/*     */      private Companion() {} } @NotNull
/*     */   public String getFqdn() {
/*  99 */     return this.fqdn; } @Nullable
/* 100 */   public final Integer getMaxLength() { return this.maxLength; }
/* 101 */   public Json(@NotNull String fqdn, @Nullable Integer maxLength) { super(null); this.fqdn = fqdn;
/* 102 */     this.maxLength = maxLength; } public boolean requiresLimit() { return true; } @Nullable
/* 103 */   public Integer lengthLimit() { return this.maxLength; }
/*     */    @NotNull
/*     */   public String toString() {
/* 106 */     if (this.maxLength != null) { int i = this.maxLength.intValue();
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */       
/* 290 */       String str = getFqdn(); int $i$a$-let-Attributes$Key$Json$toString$1 = 0;
/*     */       return (", maxLength=" + i == null) ? ("Json(fqdn=" + ", maxLength=" + i + "" + ")") : ("Json(fqdn=" + ", maxLength=" + i + ", maxLength=" + i + ")"); }
/*     */     
...
/*     */       return false; 
/*     */     return Intrinsics.areEqual(getFqdn(), ((Json)other).getFqdn());
/*     */   }
/*     */   
/*     */   public int hashCode() {
...
/*     */   
/*     */   @NotNull
/*     */   public final Json copy(@NotNull String fqdn, @Nullable Integer maxLength) {
/*     */     Intrinsics.checkNotNullParameter(fqdn, "fqdn");
/*     */     return new Json(fqdn, maxLength);
/*     */   }
/*     */ }


/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\li\\utils-common-jvm-0.4.32.jar!\ai\grazi\\utils\attributes\Attributes$Key$Json.class
