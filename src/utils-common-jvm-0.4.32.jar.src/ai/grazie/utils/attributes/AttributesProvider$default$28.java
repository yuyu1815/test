...
/*     */ final class AttributesProvider$default$28
/*     */   extends Lambda
...
/* 155 */     Intrinsics.checkNotNullParameter(key, "key"); Intrinsics.checkNotNullParameter(value, "value"); return (Attributes.Value)this.$set.invoke(key, id, ((Attributes.Value.Bytes)value).getValue());
/*     */   }
/*     */   
/*     */   AttributesProvider$default$28(Function3<Attributes.Key.Bytes, Entity, byte[], Attributes.Value.Bytes> $set) {
/*     */     super(3);
/*     */   }
/*     */ }


/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\li\\utils-common-jvm-0.4.32.jar!\ai\grazi\\utils\attributes\AttributesProvider$default$28.class
