...
/*     */ final class AttributesProvider$default$20
/*     */   extends Lambda
...
/* 123 */     Intrinsics.checkNotNullParameter(key, "key"); Intrinsics.checkNotNullParameter(value, "value"); return (Attributes.Value)this.$set.invoke(key, id, ((Attributes.Value.Json)value).getValue());
/*     */   }
/*     */   
/*     */   AttributesProvider$default$20(Function3<Attributes.Key.Json, Entity, String, Attributes.Value.Json> $set) {
/*     */     super(3);
/*     */   }
/*     */ }


/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\li\\utils-common-jvm-0.4.32.jar!\ai\grazi\\utils\attributes\AttributesProvider$default$20.class
