...
/*     */ final class AttributesProvider$default$24
/*     */   extends Lambda
...
/* 139 */     Intrinsics.checkNotNullParameter(key, "key"); Intrinsics.checkNotNullParameter(value, "value"); return (Attributes.Value)this.$set.invoke(key, id, ((Attributes.Value.Bool)value).getValue());
/*     */   }
/*     */   
/*     */   AttributesProvider$default$24(Function3<Attributes.Key.Bool, Entity, Boolean, Attributes.Value.Bool> $set) {
/*     */     super(3);
/*     */   }
/*     */ }


/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\li\\utils-common-jvm-0.4.32.jar!\ai\grazi\\utils\attributes\AttributesProvider$default$24.class
