...
/* 75 */     Intrinsics.checkNotNullParameter(key, "key"); Intrinsics.checkNotNullParameter(value, "value"); return (Attributes.Value)this.$set.invoke(key, id, ((Attributes.Value.Long)value).getValue());
/*    */   }
/*    */   
/*    */   AttributesProvider$default$8(Function3<Attributes.Key.Long, Entity, Long, Attributes.Value.Long> $set) {
/*    */     super(3);
/*    */   }
/*    */ }


/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\li\\utils-common-jvm-0.4.32.jar!\ai\grazi\\utils\attributes\AttributesProvider$default$8.class
