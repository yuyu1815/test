...
/* 88 */     Intrinsics.checkNotNullParameter(key, "key"); return (Attributes.Value)this.$get.invoke(key, id);
/*    */   }
/*    */   
/*    */   AttributesProvider$default$9(Function2<Attributes.Key.Double, Entity, Attributes.Value.Double> $get) {
/*    */     super(2);
/*    */   }
/*    */ }


/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\li\\utils-common-jvm-0.4.32.jar!\ai\grazi\\utils\attributes\AttributesProvider$default$9.class
