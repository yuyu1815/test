...
/*    */ {
/*    */   AttributesProvider$default$4(Function3<Attributes.Key, Entity, Attributes.Value, Attributes.Value> $set) {
/*    */     super(3);
/*    */   }
/*    */   
/*    */   public final Attributes.Value invoke(Attributes.Key key, Object id, Attributes.Value value) {
/* 46 */     Intrinsics.checkNotNullParameter(key, "key"); Intrinsics.checkNotNullParameter(value, "value"); return (Attributes.Value)this.$set.invoke(key, id, value);
/*    */   }
/*    */ }


/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\li\\utils-common-jvm-0.4.32.jar!\ai\grazi\\utils\attributes\AttributesProvider$default$4.class
