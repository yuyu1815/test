...
/*     */ final class AttributesProvider$default$18
/*     */   extends Lambda
...
/* 121 */     Intrinsics.checkNotNullParameter(key, "key"); Intrinsics.checkNotNullParameter(ids, "ids"); return (Map<Entity, Attributes.Value>)this.$getBulk.invoke(key, ids);
/*     */   }
/*     */   
/*     */   AttributesProvider$default$18(Function2<Attributes.Key.Json, List<? extends Entity>, Map<Entity, Attributes.Value.Json>> $getBulk) {
/*     */     super(2);
/*     */   }
/*     */ }


/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\li\\utils-common-jvm-0.4.32.jar!\ai\grazi\\utils\attributes\AttributesProvider$default$18.class
