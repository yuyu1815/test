...
/* 90 */     Intrinsics.checkNotNullParameter(key, "key"); return (Attributes.Value)this.$delete.invoke(key, id);
/*    */   }
/*    */   
/*    */   AttributesProvider$default$11(Function2<Attributes.Key.Double, Entity, Attributes.Value.Double> $delete) {
/*    */     super(2);
/*    */   }
/*    */ }


/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\li\\utils-common-jvm-0.4.32.jar!\ai\grazi\\utils\attributes\AttributesProvider$default$11.class
