...
/*  82 */     if (this.maxLength != null) { int i = this.maxLength.intValue();
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */       
/* 290 */       String str = getFqdn(); int $i$a$-let-Attributes$Key$Text$toString$1 = 0;
/*     */       return (", maxLength=" + i == null) ? ("Text(fqdn=" + ", maxLength=" + i + "" + ")") : ("Text(fqdn=" + ", maxLength=" + i + ", maxLength=" + i + ")"); }
/*     */     
...
/*     */       return false; 
/*     */     return Intrinsics.areEqual(getFqdn(), ((Text)other).getFqdn());
/*     */   }
/*     */   
/*     */   public int hashCode() {
...
/*     */   
/*     */   @NotNull
/*     */   public final Text copy(@NotNull String fqdn, @Nullable Integer maxLength) {
/*     */     Intrinsics.checkNotNullParameter(fqdn, "fqdn");
/*     */     return new Text(fqdn, maxLength);
/*     */   }
/*     */ }


/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\li\\utils-common-jvm-0.4.32.jar!\ai\grazi\\utils\attributes\Attributes$Key$Text.class
