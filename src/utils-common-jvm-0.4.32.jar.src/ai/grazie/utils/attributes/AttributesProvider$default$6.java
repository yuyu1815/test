...
/* 73 */     Intrinsics.checkNotNullParameter(key, "key"); Intrinsics.checkNotNullParameter(ids, "ids"); return (Map<Entity, Attributes.Value>)this.$getBulk.invoke(key, ids);
/*    */   }
/*    */   
/*    */   AttributesProvider$default$6(Function2<Attributes.Key.Long, List<? extends Entity>, Map<Entity, Attributes.Value.Long>> $getBulk) {
/*    */     super(2);
/*    */   }
/*    */ }


/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\li\\utils-common-jvm-0.4.32.jar!\ai\grazi\\utils\attributes\AttributesProvider$default$6.class
