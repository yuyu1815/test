...
/*     */ final class AttributesProvider$default$26
/*     */   extends Lambda
...
/* 153 */     Intrinsics.checkNotNullParameter(key, "key"); Intrinsics.checkNotNullParameter(ids, "ids"); return (Map<Entity, Attributes.Value>)this.$getBulk.invoke(key, ids);
/*     */   }
/*     */   
/*     */   AttributesProvider$default$26(Function2<Attributes.Key.Bytes, List<? extends Entity>, Map<Entity, Attributes.Value.Bytes>> $getBulk) {
/*     */     super(2);
/*     */   }
/*     */ }


/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\li\\utils-common-jvm-0.4.32.jar!\ai\grazi\\utils\attributes\AttributesProvider$default$26.class
