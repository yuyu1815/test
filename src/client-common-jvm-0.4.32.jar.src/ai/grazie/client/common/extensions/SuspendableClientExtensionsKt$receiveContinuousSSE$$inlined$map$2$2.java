...
/*  49 */     InlineMarker.mark(4); InlineMarker.mark(5); new ContinuationImpl($completion) { int label; Object L$0; @Nullable public final Object invokeSuspend(@NotNull Object $result) { this.result = $result; this.label |= Integer.MIN_VALUE; return SuspendableClientExtensionsKt$receiveContinuousSSE$$inlined$map$2.null.this.emit(null, (Continuation)this); } }; Continuation continuation1 = $completion; Object object = value; FlowCollector $this$map_u24lambda_u245 = this.$this_unsafeFlow; int $i$a$-unsafeTransform-FlowKt__TransformKt$map$1 = 0;
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\client-common-jvm-0.4.32.jar!\ai\grazie\client\common\extensions\SuspendableClientExtensionsKt$receiveContinuousSSE$$inlined$map$2$2.class
