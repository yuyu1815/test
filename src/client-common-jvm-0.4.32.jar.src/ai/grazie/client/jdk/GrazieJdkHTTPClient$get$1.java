...
/* 52 */     HttpResponse<byte> httpResponse = GrazieJdkHTTPClient.access$getDelegate$p(GrazieJdkHTTPClient.this).send(GrazieJdkHTTPClient.access$append(GrazieJdkHTTPClient.this, HttpRequest.newBuilder(new URI(this.$url)), this.$options.getHeaders())
/* 53 */         .timeout(GrazieJdkHTTPClient.access$getTimeout$p(GrazieJdkHTTPClient.this))
/* 54 */         .GET().build(), 
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\client-common-jvm-0.4.32.jar!\ai\grazie\client\jdk\GrazieJdkHTTPClient$get$1.class
