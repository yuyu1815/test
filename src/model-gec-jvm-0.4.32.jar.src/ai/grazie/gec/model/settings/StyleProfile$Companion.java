...
/* 103 */     return (KSerializer<StyleProfile>)StyleProfile.$serializer.INSTANCE; } @NotNull
/* 104 */   public final StyleProfile empty(@NotNull String id) { Intrinsics.checkNotNullParameter(id, "id"); return new StyleProfile(id, new StyleProfile.ParamValue[0], new String[0], new String[0]); }
/*     */ 
/*     */ }


/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\model-gec-jvm-0.4.32.jar!\ai\grazie\gec\model\settings\StyleProfile$Companion.class
