...
/* 77 */     return (KSerializer<LLMChat>)LLMChat.$serializer.INSTANCE; } @NotNull
/*    */   public final LLMChat build(@NotNull Function1 body) {
/* 79 */     Intrinsics.checkNotNullParameter(body, "body"); int $i$f$build = 0; LLMChat.Builder builder = new LLMChat.Builder(null, 1, null); body.invoke(builder); return builder.build();
/*    */   }
/*    */ }


/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\model-llm-jvm-0.4.32.jar!\ai\grazie\model\llm\chat\v5\LLMChat$Companion.class
