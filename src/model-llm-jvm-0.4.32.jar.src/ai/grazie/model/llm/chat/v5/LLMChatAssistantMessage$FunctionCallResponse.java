...
/*    */   
/*    */   @NotNull
/*    */   public final FunctionCallResponse copy(@NotNull String functionName, @NotNull String content) {
/*    */     Intrinsics.checkNotNullParameter(functionName, "functionName");
/*    */     Intrinsics.checkNotNullParameter(content, "content");
/*    */     return new FunctionCallResponse(functionName, content);
/*    */   }
/*    */   
/*    */   @NotNull
/*    */   public String toString() {
/*    */     return "FunctionCallResponse(functionName=" + this.functionName + ", content=" + this.content + ")";
/*    */   }
/*    */   
/*    */   public int hashCode() {
...
/*    */       return false; 
/*    */     FunctionCallResponse functionCallResponse = (FunctionCallResponse)other;
/*    */     return !Intrinsics.areEqual(this.functionName, functionCallResponse.functionName) ? false : (!!Intrinsics.areEqual(this.content, functionCallResponse.content));
/*    */   }
/*    */ }


/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\model-llm-jvm-0.4.32.jar!\ai\grazie\model\llm\chat\v5\LLMChatAssistantMessage$FunctionCallResponse.class
