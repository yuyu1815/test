...
/*     */ final class GrazieLLMProxy$sendChat$2
...
/*  67 */     Object object = IntrinsicsKt.getCOROUTINE_SUSPENDED(); switch (this.label) { case 0: ResultKt.throwOnFailure(SYNTHETIC_LOCAL_VARIABLE_1);
/*  68 */         response = new Ref.ObjectRef();
/*  69 */         grazieLLMProxy = GrazieLLMProxy.this; matterhornChat = this.$chat; modelParameters = this.$modelParameters; function1 = this.$eventHandler; $i$f$measureTimeMillis = 0;
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */         
/* 372 */         start$iv = System.currentTimeMillis();
/* 373 */         $i$a$-measureTimeMillis-GrazieLLMProxy$sendChat$2$time$1 = 0; objectRef1 = response; this.L$0 = response; this.L$1 = objectRef1; this.J$0 = start$iv; this.label = 1; if (grazieLLMProxy.sendWithTracking(matterhornChat, modelParameters, GrazieLLMProxy.access$getPropertyProvider$p(grazieLLMProxy), new GrazieLLMProxy$sendChat$2$time$1$1(null), function1, (Continuation<? super AIAnswer>)this) == object)
/* 374 */           return object;  objectRef1.element = grazieLLMProxy.sendWithTracking(matterhornChat, modelParameters, GrazieLLMProxy.access$getPropertyProvider$p(grazieLLMProxy), new GrazieLLMProxy$sendChat$2$time$1$1(null), function1, (Continuation<? super AIAnswer>)this); time = System.currentTimeMillis() - start$iv; ((AIAnswer)response.element).setTime(time); GrazieLLMProxy.this.updateQuota(); return response.element;case 1: $i$f$measureTimeMillis = 0; $i$a$-measureTimeMillis-GrazieLLMProxy$sendChat$2$time$1 = 0; start$iv = this.J$0; objectRef1 = (Ref.ObjectRef)this.L$1; response = (Ref.ObjectRef)this.L$0; ResultKt.throwOnFailure(SYNTHETIC_LOCAL_VARIABLE_1); objectRef1.element = SYNTHETIC_LOCAL_VARIABLE_1; time = System.currentTimeMillis() - start$iv;
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\ej-243.132.63.jar!\com\intellij\ml\llm\matterhorn\core\llm\grazie\GrazieLLMProxy$sendChat$2.class
