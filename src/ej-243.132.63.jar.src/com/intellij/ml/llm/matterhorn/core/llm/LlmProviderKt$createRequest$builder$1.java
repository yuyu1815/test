...
/*     */ public final class LlmProviderKt$createRequest$builder$1
...
/*  83 */     Iterable<Pair<String, String>> $this$forEach$iv = this.$additionalHeaders; int $i$f$forEach = 0;
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */     
/* 125 */     Iterator<Pair<String, String>> iterator = $this$forEach$iv.iterator(); if (iterator.hasNext()) { Object<String, String> element$iv = (Object<String, String>)iterator.next(); Pair pair = (Pair)element$iv; int $i$a$-forEach-LlmProviderKt$createRequest$builder$1$1 = 0; String name = (String)pair.component1(), value = (String)pair.component2(); $this$request.getHeaders().append(name, value); }
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\ej-243.132.63.jar!\com\intellij\ml\llm\matterhorn\core\llm\LlmProviderKt$createRequest$builder$1.class
