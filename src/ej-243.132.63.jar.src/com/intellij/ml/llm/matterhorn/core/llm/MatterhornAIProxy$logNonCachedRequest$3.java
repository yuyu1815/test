...
/*     */ final class MatterhornAIProxy$logNonCachedRequest$3
...
/* 161 */         Intrinsics.checkNotNullExpressionValue(MatterhornAIProxy.access$getNonCachedRequests$p(MatterhornAIProxy.this).toString(), "toString(...)"); MatterhornAIProxy.access$getMatterhornCaches$p(MatterhornAIProxy.this).saveSingle(CacheType.NonCachedRequests, MatterhornAIProxy.access$getNonCachedRequests$p(MatterhornAIProxy.this).toString());
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\ej-243.132.63.jar!\com\intellij\ml\llm\matterhorn\core\llm\MatterhornAIProxy$logNonCachedRequest$3.class
