...
/*    */ 
/*    */ 
/*    */ @DebugMetadata(f = "aipLicenseFetchStep.kt", l = {98}, i = {}, s = {}, n = {}, m = "invokeSuspend", c = "com.intellij.ml.llm.matterhorn.activation.state.junie.AipLicenseFetchStepKt$aipLicenseFetchStep$trialCallable$1$1$1")
...
/* 97 */     Object object = IntrinsicsKt.getCOROUTINE_SUSPENDED(); switch (this.label) { case 0: ResultKt.throwOnFailure(SYNTHETIC_LOCAL_VARIABLE_1); $this$performLicenseRequestWithTimeout = (JunieAipLicenseRepository)this.L$0;
/* 98 */         this.label = 1; if ($this$performLicenseRequestWithTimeout.issueTrialLicense(this.$productType, (Continuation)this) == object) return object;  return $this$performLicenseRequestWithTimeout.issueTrialLicense(this.$productType, (Continuation)this);
/*    */       case 1:
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\ej-243.132.63.jar!\com\intellij\ml\llm\matterhorn\activation\state\junie\AipLicenseFetchStepKt$aipLicenseFetchStep$trialCallable$1$1$1.class
