...
/*    */ public final class MockSupportImpl<T>
/*    */   implements AiaServiceMockSupport<T>
/*    */ {
/*    */   @NotNull
...
/* 50 */     this.serviceSupport = serviceSupport;
/* 51 */     this._mockServiceStateFlow = StateFlowKt.MutableStateFlow(null); } @Nullable
/* 52 */   public T getMockService() { return (T)this._mockServiceStateFlow.getValue(); } public void setMockService(@Nullable Object <set-?>) { this._mockServiceStateFlow.setValue(<set-?>); } private static Object getMockService$delegate(MockSupportImpl <this>) { return Reflection.mutableProperty0((MutablePropertyReference0)new MutablePropertyReference0Impl(<this>._mockServiceStateFlow, MutableStateFlow.class, "value", "getValue()Ljava/lang/Object;", 0)); }
/*    */   @NotNull
/* 54 */   public KClass<? extends T> getKeyClass() { return this.serviceSupport.getKeyClass(); } private static Object getKeyClass$delegate(MockSupportImpl <this>) { return Reflection.property0((PropertyReference0)new PropertyReference0Impl(<this>.serviceSupport, AiaServiceSupport.class, "keyClass", "getKeyClass()Lkotlin/reflect/KClass;", 0)); }
/*    */    @NotNull
/*    */   public T syncInstance() {
/* 57 */     if (getMockService() == null) getMockService();  return this.serviceSupport.syncInstance();
/*    */   }
/*    */   @Nullable
/*    */   public Object instance(@NotNull Continuation<? super T> $completion) {
/* 61 */     if (getMockService() == null) { getMockService(); return this.serviceSupport.instance($completion); }  return getMockService();
/*    */   }
/*    */   
/*    */   @NotNull
/*    */   public Flow<T> instanceFlow()
/*    */   {
/* 67 */     return FlowKt.combine((Flow)this._mockServiceStateFlow, this.serviceSupport.instanceFlow(), new AiaServiceMockSupportRegistry$MockSupportImpl$instanceFlow$1(null)); } @DebugMetadata(f = "AiaServiceMockSupport.kt", l = {}, i = {}, s = {}, n = {}, m = "invokeSuspend", c = "com.intellij.ml.llm.matterhorn.activation.platform.AiaServiceMockSupportRegistry$MockSupportImpl$instanceFlow$1") @Metadata(mv = {2, 1, 0}, k = 3, xi = 48, d1 = {"\000\f\n\002\b\002\n\002\020\000\n\002\b\002\020\000\032\002H\001\"\b\b\000\020\001*\0020\0022\b\020\003\032\004\030\001H\0012\006\020\004\032\002H\001H\n"}, d2 = {"<anonymous>", "T", "", "mockInstance", "realInstance"}) static final class AiaServiceMockSupportRegistry$MockSupportImpl$instanceFlow$1 extends SuspendLambda implements Function3<T, T, Continuation<? super T>, Object> { public final Object invokeSuspend(Object $result) { Object mockInstance, realInstance; IntrinsicsKt.getCOROUTINE_SUSPENDED(); switch (this.label) { case 0: ResultKt.throwOnFailure(SYNTHETIC_LOCAL_VARIABLE_1); mockInstance = this.L$0; realInstance = this.L$1;
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\ej-243.132.63.jar!\com\intellij\ml\llm\matterhorn\activation\platform\AiaServiceMockSupportRegistry$MockSupportImpl.class
