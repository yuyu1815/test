...
/*    */   
/*    */   public Agreement(@NotNull String filename, @NotNull String version, @NotNull String url) {
/* 39 */     this.filename = filename; this.version = version; this.url = url; } @NotNull public final String getFilename() { return this.filename; } @NotNull public final String getVersion() { return this.version; } @NotNull public final String getUrl() { return this.url; }
/*    */ 
/*    */   
/*    */   @NotNull
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\ej-243.132.63.jar!\com\intellij\ml\llm\matterhorn\activation\data\model\result\GrazieHttpError$AgreementNotAccepted$Agreement.class
