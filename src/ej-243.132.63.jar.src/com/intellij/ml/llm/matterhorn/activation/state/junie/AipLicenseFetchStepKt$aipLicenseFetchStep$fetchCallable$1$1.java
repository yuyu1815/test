...
/*     */ 
/*     */ @DebugMetadata(f = "aipLicenseFetchStep.kt", l = {105, 108}, i = {}, s = {}, n = {}, m = "invokeSuspend", c = "com.intellij.ml.llm.matterhorn.activation.state.junie.AipLicenseFetchStepKt$aipLicenseFetchStep$fetchCallable$1$1")
...
/*     */ final class AipLicenseFetchStepKt$aipLicenseFetchStep$fetchCallable$1$1 extends SuspendLambda implements Function1<Continuation<? super AipLicenseResult>, Object> {
/*     */   Object L$0;
/*     */   int label;
/*     */   
/*     */   AipLicenseFetchStepKt$aipLicenseFetchStep$fetchCallable$1$1(AipLicenseProductType $productType, Function1<Continuation<? super Unit>, Object> $onAuthRejected, MutableState<List<AipLicense>> $latestTrialLicensesToAppendToResultList$delegate, Continuation $completion) {
/*     */     super(1, $completion);
/*     */   }
/*     */   
...
/*     */   }
/*     */   
/*     */   public final Continuation<Unit> create(Continuation<? super AipLicenseFetchStepKt$aipLicenseFetchStep$fetchCallable$1$1> $completion) {
/*     */     return (Continuation<Unit>)new AipLicenseFetchStepKt$aipLicenseFetchStep$fetchCallable$1$1(this.$productType, this.$onAuthRejected, this.$latestTrialLicensesToAppendToResultList$delegate, $completion);
/*     */   }
/*     */   
/*     */   public final Object invoke(Continuation<?> p1) {
/*     */     return ((AipLicenseFetchStepKt$aipLicenseFetchStep$fetchCallable$1$1)create(p1)).invokeSuspend(Unit.INSTANCE);
/*     */   }
/*     */ }


/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\ej-243.132.63.jar!\com\intellij\ml\llm\matterhorn\activation\state\junie\AipLicenseFetchStepKt$aipLicenseFetchStep$fetchCallable$1$1.class
