...
public final class null<T> implements FlowCollector {
  ...
  public final Object emit(Object value, @NotNull Continuation $completion) {
    // Byte code:
    //   0: aload_2
    //   1: instanceof com/intellij/ml/llm/matterhorn/activation/data/impl/enterprise/JunieAieProvisionRepositoryImpl$special$$inlined$map$1$2$1
    //   4: ifeq -> 36
    //   7: aload_2
    //   8: checkcast com/intellij/ml/llm/matterhorn/activation/data/impl/enterprise/JunieAieProvisionRepositoryImpl$special$$inlined$map$1$2$1
    //   11: astore_3
    //   12: aload_3
    //   13: getfield label : I
    //   16: ldc -2147483648
    ...
    //   30: putfield label : I
    //   33: goto -> 46
    //   36: new com/intellij/ml/llm/matterhorn/activation/data/impl/enterprise/JunieAieProvisionRepositoryImpl$special$$inlined$map$1$2$1
    //   39: dup
    //   40: aload_0
    //   41: aload_2
    //   42: invokespecial <init> : (Lcom/intellij/ml/llm/matterhorn/activation/data/impl/enterprise/JunieAieProvisionRepositoryImpl$special$$inlined$map$1$2;Lkotlin/coroutines/Continuation;)V
    //   45: astore_3
    //   46: aload_3
    ...
    //   111: pop
    //   112: checkcast com/intellij/platform/ide/provisioner/ProvisionedServiceConfigurationResult
    //   115: astore #10
    //   117: iconst_0
    //   118: istore #11
    //   120: aload #10
    //   122: invokestatic access$toProvisionStatus : (Lcom/intellij/platform/ide/provisioner/ProvisionedServiceConfigurationResult;)Lcom/intellij/ml/llm/matterhorn/activation/data/model/AieProvisionStatus;
    //   125: aload #9
    //   127: swap
    //   128: aload_3
    //   129: aload_3
    ...
    //   89	9	0	this	Lcom/intellij/ml/llm/matterhorn/activation/data/impl/enterprise/JunieAieProvisionRepositoryImpl$special$$inlined$map$1$2;
    ...
    //   117	8	10	configurationResult	Lcom/intellij/platform/ide/provisioner/ProvisionedServiceConfigurationResult;
    //   120	5	11	$i$a$-map-JunieAieProvisionRepositoryImpl$provisionStatusFlow$1	I
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\ej-243.132.63.jar!\com\intellij\ml\llm\matterhorn\activation\data\impl\enterprise\JunieAieProvisionRepositoryImpl$special$$inlined$map$1$2.class
