...
@DebugMetadata(f = "grazieJbaAuthStep.kt", l = {65, 66}, i = {}, s = {}, n = {}, m = "invokeSuspend", c = "com.intellij.ml.llm.matterhorn.activation.state.junie.GrazieJbaAuthStepKt$grazieJbaAuthStep$authCallable$provideAccessCallable$1$1$1")
...
final class null extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super GrazieResult<? extends GrazieAuthData>>, Object> {
  ...
  null(String $apiUrl, String $jbaIdToken, String $aipLicenseId, Function1<Continuation<? super Unit>, Object> $onAuthRejected, Function1<Continuation<? super Unit>, Object> $onLicenseRejected, Function1<Continuation<? super Unit>, Object> $onAgreementRequired, Continuation $completion) {
    super(2, $completion);
  }
  ...
  public final Continuation<Unit> create(Object value, Continuation<? super null> $completion) {
    return (Continuation<Unit>)new Object(this.$apiUrl, this.$jbaIdToken, this.$aipLicenseId, this.$onAuthRejected, this.$onLicenseRejected, this.$onAgreementRequired, $completion);
  }
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\ej-243.132.63.jar!\com\intellij\ml\llm\matterhorn\activation\state\junie\GrazieJbaAuthStepKt$grazieJbaAuthStep$authCallable$provideAccessCallable$1$1$1.class
