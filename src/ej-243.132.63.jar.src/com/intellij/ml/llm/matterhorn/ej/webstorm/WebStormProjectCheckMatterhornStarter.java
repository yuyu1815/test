...
/* 20 */     WebStormProjectCheckMatterhornStarterKt.access$getLogger$p().info("WebStormProjectCheckMatterhornStarter: " + args);
...
/* 35 */     for (Object element$iv$iv : iterable1) { String it = (String)element$iv$iv; int $i$a$-filter-WebStormProjectCheckMatterhornStarter$buildArtifactRequest$tests$1 = 0; if (StringsKt.startsWith$default(it, "test:", false, 2, null)) collection.add(element$iv$iv);  }
...
/* 39 */       String str = (String)item$iv$iv; Collection<String> collection1 = destination$iv$iv; int $i$a$-map-WebStormProjectCheckMatterhornStarter$buildArtifactRequest$tests$2 = 0; collection1.add(StringsKt.trim(StringsKt.removePrefix(str, "test:")).toString());
/* 40 */     }  List tests = (List)destination$iv$iv; ArtifactId artifactId = new ArtifactId(name, WebStormAgentArtifactTypes.INSTANCE.getProjectCheckArtifactType()); ProjectCheckInput projectCheckInput = new ProjectCheckInput(tests, tests); int $i$f$artifactRequest = 0;
/* 41 */     return new ArtifactRequest(artifactId, projectCheckInput, ProjectCheckInput.Companion.serializer());
/*    */   }
/*    */ }


/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\ej-243.132.63.jar!\com\intellij\ml\llm\matterhorn\ej\webstorm\WebStormProjectCheckMatterhornStarter.class
