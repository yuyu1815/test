...
/*     */ 
/*     */ 
/*     */ @DebugMetadata(f = "NewTaskViewModelImpl.kt", l = {115, 117}, i = {}, s = {}, n = {}, m = "invokeSuspend", c = "com.intellij.ml.llm.matterhorn.ej.ui.tasks.create.NewTaskViewModelImpl$2")
...
/* 115 */         this.label = 1; if (RecentTaskChainService.Companion.getInstance(NewTaskViewModelImpl.this.getProject()).getRecentTaskChains((Continuation)this) == object)
/*     */           return object; 
/* 117 */         this.label = 2; if (FlowKt.filterNotNull((Flow)RecentTaskChainService.Companion.getInstance(NewTaskViewModelImpl.this.getProject()).getRecentTaskChains((Continuation)this)).collect(new FlowCollector() { public final Object emit(ImmutableCollection taskChains, Continuation $completion) { // Byte code:
/*     */                 //   0: aload_2
...
/* 117 */                 //   57	329	17	$result	Ljava/lang/Object; } @DebugMetadata(f = "NewTaskViewModelImpl.kt", l = {131}, i = {0, 0}, s = {"L$0", "L$1"}, n = {"this", "sortedRecentTaskChains"}, m = "emit", c = "com.intellij.ml.llm.matterhorn.ej.ui.tasks.create.NewTaskViewModelImpl$2$1") @Metadata(mv = {2, 1, 0}, k = 3, xi = 48) static final class NewTaskViewModelImpl$2$1$emit$1 extends ContinuationImpl { Object L$0; Object L$1; int label; public final Object invokeSuspend(Object $result) { this.result = $result; this.label |= Integer.MIN_VALUE; return NewTaskViewModelImpl.null.null.this.emit((ImmutableCollection<RecentTaskChain>)null, (Continuation<? super Unit>)this); } } }(Continuation)this) == object) return object;  FlowKt.filterNotNull((Flow)RecentTaskChainService.Companion.getInstance(NewTaskViewModelImpl.this.getProject()).getRecentTaskChains((Continuation)this)).collect(new FlowCollector() { public final Object emit(ImmutableCollection taskChains, Continuation $completion) { // Byte code:
/*     */                 //   0: aload_2
/*     */                 //   1: instanceof com/intellij/ml/llm/matterhorn/ej/ui/tasks/create/NewTaskViewModelImpl$2$1$emit$1
/*     */                 //   4: ifeq -> 39
/*     */                 //   7: aload_2
...
/*     */ 
/*     */         
/* 136 */         return Unit.INSTANCE;case 1: ResultKt.throwOnFailure(SYNTHETIC_LOCAL_VARIABLE_1); this.label = 2; if (FlowKt.filterNotNull((Flow)SYNTHETIC_LOCAL_VARIABLE_1).collect(new FlowCollector() { public final Object emit(ImmutableCollection taskChains, Continuation $completion) { // Byte code:
/*     */                 //   0: aload_2
/*     */                 //   1: instanceof com/intellij/ml/llm/matterhorn/ej/ui/tasks/create/NewTaskViewModelImpl$2$1$emit$1
/*     */                 //   4: ifeq -> 39
/*     */                 //   7: aload_2
...
/*     */                 //   0	396	2	$completion	Lkotlin/coroutines/Continuation;
/*     */                 //   50	336	18	$continuation	Lkotlin/coroutines/Continuation;
/*     */                 //   57	329	17	$result	Ljava/lang/Object; } @DebugMetadata(f = "NewTaskViewModelImpl.kt", l = {131}, i = {0, 0}, s = {"L$0", "L$1"}, n = {"this", "sortedRecentTaskChains"}, m = "emit", c = "com.intellij.ml.llm.matterhorn.ej.ui.tasks.create.NewTaskViewModelImpl$2$1") @Metadata(mv = {2, 1, 0}, k = 3, xi = 48) static final class NewTaskViewModelImpl$2$1$emit$1 extends ContinuationImpl { Object L$0; Object L$1; int label; public final Object invokeSuspend(Object $result) { this.result = $result; this.label |= Integer.MIN_VALUE; return NewTaskViewModelImpl.null.null.this.emit((ImmutableCollection<RecentTaskChain>)null, (Continuation<? super Unit>)this); } } }(Continuation)this) == object) return object;  FlowKt.filterNotNull((Flow)SYNTHETIC_LOCAL_VARIABLE_1).collect(new FlowCollector() { public final Object emit(ImmutableCollection taskChains, Continuation $completion) { // Byte code:
/*     */                 //   0: aload_2
/*     */                 //   1: instanceof com/intellij/ml/llm/matterhorn/ej/ui/tasks/create/NewTaskViewModelImpl$2$1$emit$1
/*     */                 //   4: ifeq -> 39
/*     */                 //   7: aload_2
...
/*     */                 //   0	396	2	$completion	Lkotlin/coroutines/Continuation;
/*     */                 //   50	336	18	$continuation	Lkotlin/coroutines/Continuation;
/* 136 */                 //   57	329	17	$result	Ljava/lang/Object; } @DebugMetadata(f = "NewTaskViewModelImpl.kt", l = {131}, i = {0, 0}, s = {"L$0", "L$1"}, n = {"this", "sortedRecentTaskChains"}, m = "emit", c = "com.intellij.ml.llm.matterhorn.ej.ui.tasks.create.NewTaskViewModelImpl$2$1") @Metadata(mv = {2, 1, 0}, k = 3, xi = 48) static final class NewTaskViewModelImpl$2$1$emit$1 extends ContinuationImpl { Object L$0; Object L$1; int label; public final Object invokeSuspend(Object $result) { this.result = $result; this.label |= Integer.MIN_VALUE; return NewTaskViewModelImpl.null.null.this.emit((ImmutableCollection<RecentTaskChain>)null, (Continuation<? super Unit>)this); } } }(Continuation)this); return Unit.INSTANCE;case 2: ResultKt.throwOnFailure(SYNTHETIC_LOCAL_VARIABLE_1); return Unit.INSTANCE; }
/*     */     
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\ej-243.132.63.jar!\com\intellij\ml\llm\matterhorn\e\\ui\tasks\create\NewTaskViewModelImpl$2.class
