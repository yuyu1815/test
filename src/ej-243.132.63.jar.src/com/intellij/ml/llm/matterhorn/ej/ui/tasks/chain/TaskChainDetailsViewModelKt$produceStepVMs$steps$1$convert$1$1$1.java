...
/*     */ final class TaskChainDetailsViewModelKt$produceStepVMs$steps$1$convert$1$1$1
...
/* 497 */     Object object = IntrinsicsKt.getCOROUTINE_SUSPENDED(); switch (this.label) { case 0: ResultKt.throwOnFailure(SYNTHETIC_LOCAL_VARIABLE_1);
/* 498 */         this.label = 1; if (((ActionApprovalRequest)this.$humanInLoopRequest).getReaction().invoke(HumanInLoopResponse.Agree.INSTANCE, this) == object) return object;  ((ActionApprovalRequest)this.$humanInLoopRequest).getReaction().invoke(HumanInLoopResponse.Agree.INSTANCE, this);
/* 499 */         return Unit.INSTANCE;case 1: ResultKt.throwOnFailure(SYNTHETIC_LOCAL_VARIABLE_1); return Unit.INSTANCE; }
/*     */     
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\ej-243.132.63.jar!\com\intellij\ml\llm\matterhorn\e\\ui\tasks\chain\TaskChainDetailsViewModelKt$produceStepVMs$steps$1$convert$1$1$1.class
