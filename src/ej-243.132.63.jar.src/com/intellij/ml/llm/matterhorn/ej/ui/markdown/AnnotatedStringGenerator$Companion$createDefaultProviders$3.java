...
/*     */ public final class AnnotatedStringGenerator$Companion$createDefaultProviders$3
...
/* 144 */     Intrinsics.checkNotNullParameter(visitor, "visitor"); Intrinsics.checkNotNullParameter(markdownText, "markdownText"); Intrinsics.checkNotNullParameter(node, "node"); int start = visitor.getCurrentOffset();
/* 145 */     ASTNodeKt.acceptChildren(node, (Visitor)visitor);
/* 146 */     int end = visitor.getCurrentOffset();
/* 147 */     visitor.addStyle(new SpanStyle(0L, 0L, null, FontStyle.box-impl(FontStyle.Companion.getItalic-_-LCdwA()), null, null, null, 0L, null, null, null, 0L, null, null, null, null, 65527, null), start, end);
/*     */   }
/*     */ }


/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\ej-243.132.63.jar!\com\intellij\ml\llm\matterhorn\e\\ui\markdown\AnnotatedStringGenerator$Companion$createDefaultProviders$3.class
