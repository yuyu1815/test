...
/*    */ 
/*    */ @Metadata(mv = {2, 1, 0}, k = 1, xi = 48, d1 = {"\000&\n\002\030\002\n\002\030\002\n\002\b\003\n\002\020\002\n\000\n\002\030\002\n\000\n\002\030\002\n\000\n\002\030\002\n\002\b\002\030\000 \f2\0020\001:\001\fB\007¢\006\004\b\002\020\003J \020\004\032\0020\0052\006\020\006\032\0020\0072\006\020\b\032\0020\t2\006\020\n\032\0020\013H\026¨\006\r"}, d2 = {"Lcom/intellij/ml/llm/matterhorn/ej/idea/run/BuildProgressListenerRegistrar;", "Lcom/intellij/ml/llm/matterhorn/ej/idea/run/BuildListenerRegistrar;", "<init>", "()V", "register", "", "project", "Lcom/intellij/openapi/project/Project;", "disposable", "Lcom/intellij/openapi/Disposable;", "listener", "Lcom/intellij/ml/llm/matterhorn/ej/idea/run/BuildListener;", "Companion", "ej-idea"})
/*    */ @SourceDebugExtension({"SMAP\nBuildProgressListenerRegistrar.kt\nKotlin\n*S Kotlin\n*F\n+ 1 BuildProgressListenerRegistrar.kt\ncom/intellij/ml/llm/matterhorn/ej/idea/run/BuildProgressListenerRegistrar\n+ 2 logger.kt\ncom/intellij/openapi/diagnostic/LoggerKt\n*L\n1#1,72:1\n14#2:73\n*S KotlinDebug\n*F\n+ 1 BuildProgressListenerRegistrar.kt\ncom/intellij/ml/llm/matterhorn/ej/idea/run/BuildProgressListenerRegistrar\n*L\n15#1:73\n*E\n"})
/*    */ public final class BuildProgressListenerRegistrar implements BuildListenerRegistrar {
/*    */   @NotNull
/* 15 */   public static final Companion Companion = new Companion(null); @Metadata(mv = {2, 1, 0}, k = 1, xi = 48, d1 = {"\000\022\n\002\030\002\n\002\020\000\n\002\b\003\n\002\030\002\n\000\b\003\030\0002\0020\001B\t\b\002¢\006\004\b\002\020\003R\016\020\004\032\0020\005X\004¢\006\002\n\000¨\006\006"}, d2 = {"Lcom/intellij/ml/llm/matterhorn/ej/idea/run/BuildProgressListenerRegistrar$Companion;", "", "<init>", "()V", "logger", "Lcom/intellij/openapi/diagnostic/Logger;", "ej-idea"}) public static final class Companion { private Companion() {} } static { int $i$f$logger = 0;
/*    */ 
/*    */ 
/*    */ 
/*    */ 
...
/*    */ 
/*    */     
/* 73 */     Intrinsics.checkNotNullExpressionValue(Logger.getInstance(BuildProgressListenerRegistrar.class), "getInstance(...)"); } public void register(@NotNull Project project, @NotNull Disposable disposable, @NotNull BuildListener listener) { Intrinsics.checkNotNullParameter(project, "project"); Intrinsics.checkNotNullParameter(disposable, "disposable"); Intrinsics.checkNotNullParameter(listener, "listener"); BuildProgressListenerRegistrar$register$buildProgressListener$1 buildProgressListener = new BuildProgressListenerRegistrar$register$buildProgressListener$1(listener); BuildViewManager buildViewManager = (BuildViewManager)project.getService(BuildViewManager.class); buildViewManager.addListener(buildProgressListener, disposable); } @NotNull private static final Logger logger = Logger.getInstance(BuildProgressListenerRegistrar.class);
/*    */   
...
/*    */   public static final class BuildProgressListenerRegistrar$register$buildProgressListener$1 implements BuildProgressListener {
/*    */     private final Map<Object, StringBuilder> activeBuilds = Collections.synchronizedMap(new LinkedHashMap<>());
/*    */     private volatile boolean hasErrors;
/*    */     
/*    */     BuildProgressListenerRegistrar$register$buildProgressListener$1(BuildListener $listener) {}
/*    */     
/*    */     public final Map<Object, StringBuilder> getActiveBuilds() {
...
/*    */     }
/*    */     
/*    */     public final void setHasErrors(boolean <set-?>) {
/*    */       this.hasErrors = <set-?>;
/*    */     }
/*    */     
...
/*    */       return it.getMessage() + " | " + it.getMessage();
/*    */     }
/*    */   }
/*    */ }


/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\ej-243.132.63.jar!\com\intellij\ml\llm\matterhorn\ej\idea\run\BuildProgressListenerRegistrar.class
