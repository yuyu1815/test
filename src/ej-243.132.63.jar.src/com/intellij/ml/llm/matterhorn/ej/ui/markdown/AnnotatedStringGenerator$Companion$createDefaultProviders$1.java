...
/*     */ public final class AnnotatedStringGenerator$Companion$createDefaultProviders$1
...
/* 124 */     Intrinsics.checkNotNullParameter(visitor, "visitor"); Intrinsics.checkNotNullParameter(markdownText, "markdownText"); Intrinsics.checkNotNullParameter(node, "node"); if (!visitor.isEmpty()) {
/* 125 */       visitor.consumeText("\n\n");
/*     */     }
/* 127 */     ASTNodeKt.acceptChildren(node, (Visitor)visitor);
/*     */   }
/*     */ }


/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\ej-243.132.63.jar!\com\intellij\ml\llm\matterhorn\e\\ui\markdown\AnnotatedStringGenerator$Companion$createDefaultProviders$1.class
