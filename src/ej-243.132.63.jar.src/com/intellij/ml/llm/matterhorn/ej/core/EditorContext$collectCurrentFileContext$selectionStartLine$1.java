...
/*     */ final class EditorContext$collectCurrentFileContext$selectionStartLine$1
...
/* 150 */     IntrinsicsKt.getCOROUTINE_SUSPENDED(); switch (this.label) { case 0: ResultKt.throwOnFailure(SYNTHETIC_LOCAL_VARIABLE_1);
/* 151 */         return Boxing.boxInt(this.$editor.getDocument().getLineNumber(this.$editor.getSelectionModel().getSelectionStart())); }
/*     */     
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\ej-243.132.63.jar!\com\intellij\ml\llm\matterhorn\ej\core\EditorContext$collectCurrentFileContext$selectionStartLine$1.class
