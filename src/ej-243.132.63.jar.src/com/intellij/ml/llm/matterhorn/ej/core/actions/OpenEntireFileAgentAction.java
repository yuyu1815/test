...
/*    */   
/*    */   @NotNull
/* 36 */   private final String name = "open_entire_file"; @NotNull public String getName() { return this.name; }
/*    */    @NotNull
/* 38 */   private final List<Argument> arguments = CollectionsKt.listOf(
/* 39 */       new Argument(
/* 40 */         "path", 
/* 41 */         ArgumentType.STRING, 
/* 42 */         "the full path to the file to open", false, false, 24, null)); @NotNull
/*    */   public List<Argument> getArguments() {
/*    */     return this.arguments;
/*    */   } @NotNull
/* 46 */   private final String docstring = StringsKt.trim("A variant of the `open` command that attempts to show the entire file's content when possible.\nUse it only if you absolutely certain you need to see the whole file, as it can be very slow and costly for large files.\nNormally use the `get_file_structure` or `search_project` commands to locate the specific part of the code you need to explore and call `open` command with line_number parameter.").toString(); @NotNull public static final String PATH_ARGUMENT = "path"; public static final int OPEN_FULL_FILE_LIMIT = 1500; @NotNull public String getDocstring() { return this.docstring; }
/*    */ 
/*    */   
/*    */   @Nullable
...
/*    */     // Byte code:
/*    */     //   0: aload_3
/*    */     //   1: instanceof com/intellij/ml/llm/matterhorn/ej/core/actions/OpenEntireFileAgentAction$execute$1
/*    */     //   4: ifeq -> 39
/*    */     //   7: aload_3
/*    */     //   8: checkcast com/intellij/ml/llm/matterhorn/ej/core/actions/OpenEntireFileAgentAction$execute$1
/*    */     //   11: astore #9
/*    */     //   13: aload #9
/*    */     //   15: getfield label : I
/*    */     //   18: ldc -2147483648
...
/*    */     //   33: putfield label : I
/*    */     //   36: goto -> 50
/*    */     //   39: new com/intellij/ml/llm/matterhorn/ej/core/actions/OpenEntireFileAgentAction$execute$1
/*    */     //   42: dup
/*    */     //   43: aload_0
/*    */     //   44: aload_3
/*    */     //   45: invokespecial <init> : (Lcom/intellij/ml/llm/matterhorn/ej/core/actions/OpenEntireFileAgentAction;Lkotlin/coroutines/Continuation;)V
/*    */     //   48: astore #9
/*    */     //   50: aload #9
/*    */     //   52: getfield result : Ljava/lang/Object;
/*    */     //   55: astore #8
...
/*    */     //   62: aload #9
/*    */     //   64: getfield label : I
/*    */     //   67: tableswitch default -> 311, 0 -> 96, 1 -> 129, 2 -> 207, 3 -> 303
/*    */     //   96: aload #8
/*    */     //   98: invokestatic throwOnFailure : (Ljava/lang/Object;)V
/*    */     //   101: aload_0
/*    */     //   102: aload_1
...
/*    */     //   195: invokestatic smartLocateFile$default : (Ljava/lang/String;Lcom/intellij/ml/llm/matterhorn/ej/core/ExecutionAgentContext;ZLkotlin/coroutines/Continuation;ILjava/lang/Object;)Ljava/lang/Object;
/*    */     //   198: dup
/*    */     //   199: aload #10
/*    */     //   201: if_acmpne -> 223
/*    */     //   204: aload #10
/*    */     //   206: areturn
/*    */     //   207: aload #9
/*    */     //   209: getfield L$0 : Ljava/lang/Object;
/*    */     //   212: checkcast com/intellij/ml/llm/matterhorn/ej/core/ExecutionAgentContext
/*    */     //   215: astore_2
/*    */     //   216: aload #8
/*    */     //   218: invokestatic throwOnFailure : (Ljava/lang/Object;)V
/*    */     //   221: aload #8
/*    */     //   223: checkcast com/intellij/ml/llm/matterhorn/ej/core/Result
/*    */     //   226: astore #6
/*    */     //   228: aload #6
/*    */     //   230: instanceof com/intellij/ml/llm/matterhorn/ej/core/Result$Err
/*    */     //   233: ifeq -> 245
/*    */     //   236: aload #6
/*    */     //   238: checkcast com/intellij/ml/llm/matterhorn/ej/core/Result$Err
/*    */     //   241: invokevirtual getMessage : ()Ljava/lang/String;
/*    */     //   244: areturn
/*    */     //   245: aload #6
/*    */     //   247: ldc 'null cannot be cast to non-null type com.intellij.ml.llm.matterhorn.ej.core.Result.Ok<com.intellij.openapi.vfs.VirtualFile>'
/*    */     //   249: invokestatic checkNotNull : (Ljava/lang/Object;Ljava/lang/String;)V
/*    */     //   252: aload #6
/*    */     //   254: checkcast com/intellij/ml/llm/matterhorn/ej/core/Result$Ok
/*    */     //   257: pop
/*    */     //   258: aload #6
/*    */     //   260: checkcast com/intellij/ml/llm/matterhorn/ej/core/Result$Ok
/*    */     //   263: invokevirtual getValue : ()Ljava/lang/Object;
/*    */     //   266: checkcast com/intellij/openapi/vfs/VirtualFile
/*    */     //   269: astore #7
/*    */     //   271: getstatic com/intellij/ml/llm/matterhorn/ej/core/actions/OpenEntireFileAgentAction.Companion : Lcom/intellij/ml/llm/matterhorn/ej/core/actions/OpenEntireFileAgentAction$Companion;
/*    */     //   274: aload #7
/*    */     //   276: aload_2
/*    */     //   277: aload #9
/*    */     //   279: aload #9
...
/*    */     //   291: invokevirtual openEntireFile : (Lcom/intellij/openapi/vfs/VirtualFile;Lcom/intellij/ml/llm/matterhorn/ej/core/ExecutionAgentContext;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
/*    */     //   294: dup
/*    */     //   295: aload #10
/*    */     //   297: if_acmpne -> 310
/*    */     //   300: aload #10
/*    */     //   302: areturn
/*    */     //   303: aload #8
/*    */     //   305: invokestatic throwOnFailure : (Ljava/lang/Object;)V
/*    */     //   308: aload #8
/*    */     //   310: areturn
/*    */     //   311: new java/lang/IllegalStateException
/*    */     //   314: dup
/*    */     //   315: ldc 'call to 'resume' before 'invoke' with coroutine'
...
/*    */     // Local variable table:
/*    */     //   start	length	slot	name	descriptor
/*    */     //   101	19	0	this	Lcom/intellij/ml/llm/matterhorn/ej/core/actions/OpenEntireFileAgentAction;
...
/*    */     //   138	69	2	context	Lcom/intellij/ml/llm/matterhorn/ej/core/ExecutionAgentContext;
/*    */     //   216	20	2	context	Lcom/intellij/ml/llm/matterhorn/ej/core/ExecutionAgentContext;
/*    */     //   245	49	2	context	Lcom/intellij/ml/llm/matterhorn/ej/core/ExecutionAgentContext;
/*    */     //   150	15	4	params	Ljava/util/Map;
/*    */     //   175	23	5	pathStr	Ljava/lang/String;
/*    */     //   228	17	6	res	Lcom/intellij/ml/llm/matterhorn/ej/core/Result;
/*    */     //   245	26	6	res	Lcom/intellij/ml/llm/matterhorn/ej/core/Result;
/*    */     //   271	23	7	vFile	Lcom/intellij/openapi/vfs/VirtualFile;
/*    */     //   0	321	3	$completion	Lkotlin/coroutines/Continuation;
/*    */     //   50	261	9	$continuation	Lkotlin/coroutines/Continuation;
/*    */     //   57	254	8	$result	Ljava/lang/Object;
/*    */   }
/*    */   
/*    */   @DebugMetadata(f = "OpenEntireFileAgentAction.kt", l = {51, 54, 62}, i = {0, 1}, s = {"L$0", "L$0"}, n = {"context", "context"}, m = "execute", c = "com.intellij.ml.llm.matterhorn.ej.core.actions.OpenEntireFileAgentAction")
/*    */   @Metadata(mv = {2, 1, 0}, k = 3, xi = 48)
/*    */   static final class OpenEntireFileAgentAction$execute$1 extends ContinuationImpl {
/*    */     Object L$0;
/*    */     int label;
/*    */     
/*    */     OpenEntireFileAgentAction$execute$1(Continuation $completion) {
/*    */       super($completion);
/*    */     }
/*    */     
/*    */     @Nullable
...
/*    */       this.result = $result;
/*    */       this.label |= Integer.MIN_VALUE;
/*    */       return OpenEntireFileAgentAction.this.execute(null, null, (Continuation<? super String>)this);
/*    */     }
/*    */   }
/*    */ }


/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\ej-243.132.63.jar!\com\intellij\ml\llm\matterhorn\ej\core\actions\OpenEntireFileAgentAction.class
