...
/*    */ 
/*    */     
/* 37 */     if ((JBList)UIUtil.findComponentOfType($this$findComponent$iv.getContent(), JBList.class) != null) { JBList list = (JBList)UIUtil.findComponentOfType($this$findComponent$iv.getContent(), JBList.class); int $i$a$-let-JUnitTestConfigurationPopupInterceptor$shouldInterceptTestPopup$1 = 0; Intrinsics.checkNotNullExpressionValue(list.getModel(), "getModel(...)"); }
/* 38 */      determineIndicesToSelect(list.getModel()); return (null != null); } public void doInterceptTestPopup(@NotNull AbstractPopup component, @Nullable RelativePoint owner) { Intrinsics.checkNotNullParameter(component, "component"); AbstractPopup $this$findComponent$iv = component; int $i$f$findComponent = 0; if ((JBList)UIUtil.findComponentOfType($this$findComponent$iv.getContent(), JBList.class) != null) { JBList list = (JBList)UIUtil.findComponentOfType($this$findComponent$iv.getContent(), JBList.class); int $i$a$-let-JUnitTestConfigurationPopupInterceptor$doInterceptTestPopup$1 = 0; Intrinsics.checkNotNullExpressionValue(list.getModel(), "getModel(...)"); if (determineIndicesToSelect(list.getModel()) == null) {
/* 39 */         determineIndicesToSelect(list.getModel()); int arrayOfInt[] = determineIndicesToSelect(list.getModel()), $i$a$-checkNotNull-JUnitTestConfigurationPopupInterceptor$doInterceptTestPopup$1$1 = 0;
...
/*    */     arrayOfInt[0] = 0;
/*    */     return (model.getSize() > 1 && model.getElementAt(0) == null && model.getElementAt(1) instanceof com.intellij.psi.PsiClass) ? arrayOfInt : null;
/*    */   }
/*    */ }


/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\ej-243.132.63.jar!\com\intellij\ml\llm\matterhorn\ej\idea\run\tests\JUnitTestConfigurationPopupInterceptor.class
