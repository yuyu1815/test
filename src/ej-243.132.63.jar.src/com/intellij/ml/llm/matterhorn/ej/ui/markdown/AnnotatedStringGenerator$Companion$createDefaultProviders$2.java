...
/*     */ public final class AnnotatedStringGenerator$Companion$createDefaultProviders$2
...
/* 134 */     Intrinsics.checkNotNullParameter(visitor, "visitor"); Intrinsics.checkNotNullParameter(markdownText, "markdownText"); Intrinsics.checkNotNullParameter(node, "node"); int start = visitor.getCurrentOffset();
/* 135 */     ASTNodeKt.acceptChildren(node, (Visitor)visitor);
/* 136 */     int end = visitor.getCurrentOffset();
/* 137 */     visitor.addStyle(new SpanStyle(0L, 0L, FontWeight.Companion.getBold(), null, null, null, null, 0L, null, null, null, 0L, null, null, null, null, 65531, null), start, end);
/*     */   }
/*     */ }


/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\ej-243.132.63.jar!\com\intellij\ml\llm\matterhorn\e\\ui\markdown\AnnotatedStringGenerator$Companion$createDefaultProviders$2.class
