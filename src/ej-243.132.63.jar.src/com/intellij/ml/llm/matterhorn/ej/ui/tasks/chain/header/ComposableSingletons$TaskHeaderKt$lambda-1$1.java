...
/*    */ final class ComposableSingletons$TaskHeaderKt$lambda-1$1
...
/* 46 */     Intrinsics.checkNotNullParameter($this$IconButton, "$this$IconButton"); if (($changed & 0x81) != 128 || !$composer.getSkipping()) { if (ComposerKt.isTraceInProgress()) ComposerKt.traceEventStart(-2135866621, $changed, -1, "com.intellij.ml.llm.matterhorn.ej.ui.tasks.chain.header.ComposableSingletons$TaskHeaderKt.lambda-1.<anonymous> (TaskHeader.kt:45)");  IconKt.Icon-FHprtrg((IconKey)AllIconsKeys.Actions.INSTANCE.getBack(), "Back", null, null, 0L, new org.jetbrains.jewel.ui.painter.PainterHint[0], $composer, 0x30 | IntelliJIconKey.$stable, 28); if (ComposerKt.isTraceInProgress()) ComposerKt.traceEventEnd();  } else { $composer.skipToGroupEnd(); }
/*    */   
/*    */   }
/*    */ }


/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\ej-243.132.63.jar!\com\intellij\ml\llm\matterhorn\e\\ui\tasks\chain\header\ComposableSingletons$TaskHeaderKt$lambda-1$1.class
