...
/* 92 */     super(null); this.startLine = startLine; this.endLine = endLine; this.replacementText = replacementText; } public final int getStartLine() { return this.startLine; } public final int getEndLine() { return this.endLine; } @NotNull public final String getReplacementText() { return this.replacementText; }
/*    */ 
/*    */   
...
/*    */     return (this.startLine != success.startLine) ? false : ((this.endLine != success.endLine) ? false : (!!Intrinsics.areEqual(this.replacementText, success.replacementText)));
/*    */   }
/*    */ }


/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\ej-243.132.63.jar!\com\intellij\ml\llm\matterhorn\ej\core\actions\edit\EditAgentAction$ReplaceLinesParseResult$Success.class
