...
/*    */ 
/*    */ @Metadata(mv = {2, 1, 0}, k = 1, xi = 48, d1 = {"\000\036\n\002\030\002\n\002\030\002\n\002\b\003\n\002\020 \n\002\030\002\n\000\n\002\030\002\n\002\b\002\030\0002\0020\001B\007¢\006\004\b\002\020\003J\026\020\004\032\b\022\004\022\0020\0060\0052\006\020\007\032\0020\bH\026J\022\020\t\032\004\030\0010\0062\006\020\007\032\0020\bH\002¨\006\n"}, d2 = {"Lcom/intellij/ml/llm/matterhorn/ej/pycharm/PycharmJuniePrecondition;", "Lcom/intellij/ml/llm/matterhorn/ej/core/DefaultJuniePreconditionChecker;", "<init>", "()V", "canRunJunie", "", "Lcom/intellij/ml/llm/matterhorn/ej/core/JuniePreconditionChecker$JunieProblem;", "project", "Lcom/intellij/openapi/project/Project;", "checkPythonInterpreter", "ej-pycharm"})
/*    */ public final class PycharmJuniePrecondition extends DefaultJuniePreconditionChecker {
/*    */   @NotNull
/*    */   public List<JuniePreconditionChecker.JunieProblem> canRunJunie(@NotNull Project project) {
/* 13 */     Intrinsics.checkNotNullParameter(project, "project"); return CollectionsKt.plus(super.canRunJunie(project), CollectionsKt.listOfNotNull(
/* 14 */           checkPythonInterpreter(project)));
/*    */   }
/*    */   
/*    */   private final JuniePreconditionChecker.JunieProblem checkPythonInterpreter(Project project)
/*    */   {
/* 19 */     if (hasSdk(project, PycharmJuniePrecondition::checkPythonInterpreter$lambda$0)) return null;
/*    */     
/* 21 */     return new JuniePreconditionChecker.JunieProblem(
/* 22 */         "Python interpreter is not configured", 
/* 23 */         "Set Up", 
/* 24 */         new PycharmJuniePrecondition$checkPythonInterpreter$2(project, null)); } private static final boolean checkPythonInterpreter$lambda$0(Sdk it) { Intrinsics.checkNotNullParameter(it, "it"); return Intrinsics.areEqual(it.getSdkType().getName(), "Python SDK"); } @DebugMetadata(f = "PycharmJuniePrecondition.kt", l = {25}, i = {}, s = {}, n = {}, m = "invokeSuspend", c = "com.intellij.ml.llm.matterhorn.ej.pycharm.PycharmJuniePrecondition$checkPythonInterpreter$2") @Metadata(mv = {2, 1, 0}, k = 3, xi = 48, d1 = {"\000\006\n\000\n\002\020\013\020\000\032\0020\001H\n"}, d2 = {"<anonymous>", ""}) static final class PycharmJuniePrecondition$checkPythonInterpreter$2 extends SuspendLambda implements Function1<Continuation<? super Boolean>, Object> { int label; PycharmJuniePrecondition$checkPythonInterpreter$2(Project $project, Continuation $completion) { super(1, $completion); } public final Object invokeSuspend(Object $result) { Object object = IntrinsicsKt.getCOROUTINE_SUSPENDED(); switch (this.label) { case 0: ResultKt.throwOnFailure(SYNTHETIC_LOCAL_VARIABLE_1);
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\ej-243.132.63.jar!\com\intellij\ml\llm\matterhorn\ej\pycharm\PycharmJuniePrecondition.class
