...
/*     */ 
/*     */ @Metadata(mv = {2, 1, 0}, k = 1, xi = 48, d1 = {"\000$\n\002\030\002\n\002\020\000\n\000\n\002\020 \n\002\030\002\n\000\n\002\030\002\n\002\b\003\n\002\020\013\n\002\b\003\030\000 \f2\0020\001:\001\fB\037\b\002\022\f\020\002\032\b\022\004\022\0020\0040\003\022\006\020\005\032\0020\006¢\006\004\b\007\020\bJ\016\020\t\032\0020\n2\006\020\013\032\0020\006R\024\020\002\032\b\022\004\022\0020\0040\003X\004¢\006\002\n\000R\016\020\005\032\0020\006X\004¢\006\002\n\000¨\006\r"}, d2 = {"Lcom/intellij/ml/llm/matterhorn/ej/core/aiignore/IgnoreMatcher;", "", "rules", "", "Lcom/intellij/ml/llm/matterhorn/ej/core/aiignore/Rule;", "root", "Ljava/nio/file/Path;", "<init>", "(Ljava/util/List;Ljava/nio/file/Path;)V", "isIgnored", "", "path", "Companion", "ej-core"})
/*     */ public final class IgnoreMatcher {
/*     */   @NotNull
/*     */   public static final Companion Companion = new Companion(null);
/*     */   
/*     */   private IgnoreMatcher(List<Rule> rules, Path root) {
/*  15 */     this.rules = rules;
/*  16 */     this.root = root;
/*     */   } @NotNull
/*     */   private final List<Rule> rules; @NotNull
/*     */   private final Path root; public final boolean isIgnored(@NotNull Path path) {
/*  20 */     Intrinsics.checkNotNullParameter(path, "path"); Path normRoot = this.root.normalize();
/*  21 */     Path normPath = path.normalize();
/*     */     
/*  23 */     if (!normPath.startsWith(normRoot)) return false;
/*     */ 
/*     */     
/*  26 */     Intrinsics.checkNotNullExpressionValue(normRoot.relativize(normPath), "relativize(...)");
/*  27 */     String relUnix = CollectionsKt.joinToString$default(normRoot.relativize(normPath), "/", null, null, 0, null, IgnoreMatcher::isIgnored$lambda$0, 30, null);
/*     */     
/*  29 */     LinkOption[] arrayOfLinkOption = new LinkOption[1]; arrayOfLinkOption[0] = LinkOption.NOFOLLOW_LINKS; boolean isDir = Files.isDirectory(normPath, arrayOfLinkOption);
/*     */     
/*  31 */     boolean ignored = false;
/*  32 */     for (Rule rule : this.rules) {
/*     */       
/*  34 */       if ((!rule.getDirectoryOnly() || isDir || StringsKt.contains$default(relUnix, '/', false, 2, null)) && 
/*  35 */         rule.getRegex().matches(relUnix)) {
/*  36 */         ignored = !rule.getNegated();
/*     */       }
/*     */     } 
/*  39 */     return ignored;
/*     */   } private static final CharSequence isIgnored$lambda$0(Path it) { return it.toString(); } @Metadata(mv = {2, 1, 0}, k = 1, xi = 48, d1 = {"\000,\n\002\030\002\n\002\020\000\n\002\b\003\n\002\030\002\n\000\n\002\030\002\n\002\b\003\n\002\030\002\n\002\020\016\n\002\b\002\n\002\030\002\n\000\b\003\030\0002\0020\001B\t\b\002¢\006\004\b\002\020\003J\016\020\004\032\0020\0052\006\020\006\032\0020\007J\034\020\b\032\0020\0052\006\020\t\032\0020\0072\f\020\n\032\b\022\004\022\0020\f0\013J\016\020\r\032\0020\0052\006\020\016\032\0020\017¨\006\020"}, d2 = {"Lcom/intellij/ml/llm/matterhorn/ej/core/aiignore/IgnoreMatcher$Companion;", "", "<init>", "()V", "fromFile", "Lcom/intellij/ml/llm/matterhorn/ej/core/aiignore/IgnoreMatcher;", "ignoreFile", "Ljava/nio/file/Path;", "fromLines", "root", "rawLines", "Lkotlin/sequences/Sequence;", "", "fromVirtualFile", "vFile", "Lcom/intellij/openapi/vfs/VirtualFile;", "ej-core"})
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\ej-243.132.63.jar!\com\intellij\ml\llm\matterhorn\ej\core\aiignore\IgnoreMatcher.class
