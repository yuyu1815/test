...
/* 34 */     super(null); this.path = path; } @NotNull public final String getPath() { return this.path; }
/*    */ 
/*    */   
/*    */   @NotNull
...
/*    */   
/*    */   @NotNull
/*    */   public final RawPath copy(@NotNull String path) {
...
/*    */     if (this == other)
/*    */       return true; 
/*    */     if (!(other instanceof RawPath))
/*    */       return false; 
/*    */     RawPath rawPath = (RawPath)other;
/*    */     return !!Intrinsics.areEqual(this.path, rawPath.path);
/*    */   }
/*    */ }


/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\ej-243.132.63.jar!\com\intellij\ml\llm\matterhorn\ej\idea\actions\tests\ActionLocationsExtractor$Query$RawPath.class
