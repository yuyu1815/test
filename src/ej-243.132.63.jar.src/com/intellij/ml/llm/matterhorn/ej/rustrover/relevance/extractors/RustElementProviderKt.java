...
/*     */ 
/*     */ 
/*     */ @Metadata(mv = {2, 1, 0}, k = 2, xi = 48, d1 = {"\000\"\n\000\n\002\030\002\n\002\030\002\n\002\020\016\n\002\030\002\n\000\n\002\030\002\n\000\n\002\030\002\n\002\b\003\032&\020\000\032\030\022\024\022\022\022\006\022\004\030\0010\003\022\006\022\004\030\0010\0040\0020\0012\006\020\005\032\0020\006H\002\"\030\020\007\032\0020\003*\0020\b8BX\004¢\006\006\032\004\b\t\020\n¨\006\013"}, d2 = {"parameterNamesWithTypes", "Lkotlin/sequences/Sequence;", "Lkotlin/Pair;", "", "Lorg/rust/lang/core/psi/RsTypeReference;", "element", "Lorg/rust/lang/core/psi/RsFunction;", "textAsParamName", "Lorg/rust/lang/core/psi/RsSelfParameter;", "getTextAsParamName", "(Lorg/rust/lang/core/psi/RsSelfParameter;)Ljava/lang/String;", "ej-rustrover"})
/*     */ @SourceDebugExtension({"SMAP\nRustElementProvider.kt\nKotlin\n*S Kotlin\n*F\n+ 1 RustElementProvider.kt\ncom/intellij/ml/llm/matterhorn/ej/rustrover/relevance/extractors/RustElementProviderKt\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,156:1\n1#2:157\n*E\n"})
/*     */ public final class RustElementProviderKt
/*     */ {
/*     */   private static final Sequence<Pair<String, RsTypeReference>> parameterNamesWithTypes(RsFunction element) {
/* 147 */     return SequencesKt.sequence(new RustElementProviderKt$parameterNamesWithTypes$1(element, null));
/*     */   }
/*     */ 
/*     */   
/*     */   private static final String getTextAsParamName(RsSelfParameter $this$textAsParamName) {
/* 152 */     StringBuilder stringBuilder1 = new StringBuilder(), $this$_get_textAsParamName__u24lambda_u242 = stringBuilder1; int $i$a$-buildString-RustElementProviderKt$textAsParamName$1 = 0;
/* 153 */     if ($this$textAsParamName.getAnd() != null) { PsiElement it = $this$textAsParamName.getAnd();
/*     */ 
/*     */ 
/*     */       
/* 157 */       int $i$a$-let-RustElementProviderKt$textAsParamName$1$1 = 0; $this$_get_textAsParamName__u24lambda_u242.append("&"); } else { $this$textAsParamName.getAnd(); }  if ($this$textAsParamName.getMut() != null) { PsiElement it = $this$textAsParamName.getMut(); int $i$a$-let-RustElementProviderKt$textAsParamName$1$2 = 0;
/*     */       $this$_get_textAsParamName__u24lambda_u242.append("mut "); }
/*     */     else
/*     */     { $this$textAsParamName.getMut(); }
/*     */     
/*     */     $this$_get_textAsParamName__u24lambda_u242.append("self");
...
/*     */   static final class RustElementProviderKt$parameterNamesWithTypes$1 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super Pair<? extends String, ? extends RsTypeReference>>, Continuation<? super Unit>, Object> {
/*     */     int label;
/*     */     
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\ej-243.132.63.jar!\com\intellij\ml\llm\matterhorn\ej\rustrover\relevance\extractors\RustElementProviderKt.class
