...
/*     */ final class JuniorToolWindowViewModel$createTaskDetailsPage$1$1
...
/* 139 */     Object object = IntrinsicsKt.getCOROUTINE_SUSPENDED(); switch (this.label) { case 0: ResultKt.throwOnFailure(SYNTHETIC_LOCAL_VARIABLE_1);
/* 140 */         this.label = 1; if (JuniorToolWindowViewModel.this.switchToPage$ej_ui((ViewModel)this.$newTaskPage, (Continuation<? super Unit>)this) == object) return object;  JuniorToolWindowViewModel.this.switchToPage$ej_ui((ViewModel)this.$newTaskPage, (Continuation<? super Unit>)this);
/* 141 */         return Unit.INSTANCE;case 1: ResultKt.throwOnFailure(SYNTHETIC_LOCAL_VARIABLE_1); return Unit.INSTANCE; }
/*     */     
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\ej-243.132.63.jar!\com\intellij\ml\llm\matterhorn\e\\ui\toolwindow\JuniorToolWindowViewModel$createTaskDetailsPage$1$1.class
