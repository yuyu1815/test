...
/*    */ final class HumanInLoopImpl$shouldAllowAction$2
...
/* 70 */     Object object = IntrinsicsKt.getCOROUTINE_SUSPENDED(); switch (this.label) { case 0: ResultKt.throwOnFailure(SYNTHETIC_LOCAL_VARIABLE_1); response = (HumanInLoopResponse)this.L$0;
/* 71 */         this.L$0 = response; this.label = 1; if (HumanInLoopImpl.access$getUpdater$p(HumanInLoopImpl.this).updateHumanInLoopRequest(null, (Continuation<? super Unit>)this) == object) return object;  HumanInLoopImpl.access$getUpdater$p(HumanInLoopImpl.this).updateHumanInLoopRequest(null, (Continuation<? super Unit>)this);
/* 72 */         this.L$0 = response; this.label = 2; if (HumanInLoopImpl.access$getUpdater$p(HumanInLoopImpl.this).updateState(TaskChainState.Running, (Continuation<? super Unit>)this) == object) return object;  HumanInLoopImpl.access$getUpdater$p(HumanInLoopImpl.this).updateState(TaskChainState.Running, (Continuation<? super Unit>)this);
/* 73 */         HumanInLoopImpl.access$getLogger$cp().info("User responded with " + response + " for action: " + this.$action);
/*    */         
/* 75 */         this.$deferredResponse.complete(response);
/* 76 */         return Unit.INSTANCE;case 1: response = (HumanInLoopResponse)this.L$0; ResultKt.throwOnFailure(SYNTHETIC_LOCAL_VARIABLE_1); this.L$0 = response; this.label = 2; if (HumanInLoopImpl.access$getUpdater$p(HumanInLoopImpl.this).updateState(TaskChainState.Running, (Continuation<? super Unit>)this) == object) return object;  HumanInLoopImpl.access$getUpdater$p(HumanInLoopImpl.this).updateState(TaskChainState.Running, (Continuation<? super Unit>)this); HumanInLoopImpl.access$getLogger$cp().info("User responded with " + response + " for action: " + this.$action); this.$deferredResponse.complete(response); return Unit.INSTANCE;case 2: response = (HumanInLoopResponse)this.L$0; ResultKt.throwOnFailure(SYNTHETIC_LOCAL_VARIABLE_1); HumanInLoopImpl.access$getLogger$cp().info("User responded with " + response + " for action: " + this.$action); this.$deferredResponse.complete(response); return Unit.INSTANCE; }
/*    */     
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\ej-243.132.63.jar!\com\intellij\ml\llm\matterhorn\e\\ui\tasks\HumanInLoopImpl$shouldAllowAction$2.class
