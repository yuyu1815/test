...
/*    */ 
/*    */ @DebugMetadata(f = "WebStormJuniePrecondition.kt", l = {30}, i = {}, s = {}, n = {}, m = "invokeSuspend", c = "com.intellij.ml.llm.matterhorn.ej.webstorm.WebStormJuniePrecondition$checkNodeInterpreter$1")
/*    */ @Metadata(mv = {2, 1, 0}, k = 3, xi = 48, d1 = {"\000\006\n\000\n\002\020\013\020\000\032\0020\001H\n"}, d2 = {"<anonymous>", ""})
/*    */ final class WebStormJuniePrecondition$checkNodeInterpreter$1 extends SuspendLambda implements Function1<Continuation<? super Boolean>, Object> {
/*    */   int label;
/*    */   
/*    */   WebStormJuniePrecondition$checkNodeInterpreter$1(Project $project, Continuation $completion) {
/*    */     super(1, $completion);
/*    */   }
/*    */   
...
/* 33 */               public final Object invoke(CoroutineScope p1, Continuation<?> p2) { return ((null)create(p1, p2)).invokeSuspend(Unit.INSTANCE); } }(Continuation)this); return Boxing.boxBoolean(WebStormJuniePrecondition.access$hasNodeInterpreter(WebStormJuniePrecondition.this, this.$project));case 1: ResultKt.throwOnFailure(SYNTHETIC_LOCAL_VARIABLE_1); return Boxing.boxBoolean(WebStormJuniePrecondition.access$hasNodeInterpreter(WebStormJuniePrecondition.this, this.$project)); }
/*    */     
/*    */     throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
/*    */   }
/*    */   
/*    */   public final Continuation<Unit> create(Continuation<? super WebStormJuniePrecondition$checkNodeInterpreter$1> $completion) {
/*    */     return (Continuation<Unit>)new WebStormJuniePrecondition$checkNodeInterpreter$1(this.$project, $completion);
/*    */   }
/*    */   
/*    */   public final Object invoke(Continuation<?> p1) {
/*    */     return ((WebStormJuniePrecondition$checkNodeInterpreter$1)create(p1)).invokeSuspend(Unit.INSTANCE);
/*    */   }
/*    */ }


/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\ej-243.132.63.jar!\com\intellij\ml\llm\matterhorn\ej\webstorm\WebStormJuniePrecondition$checkNodeInterpreter$1.class
