...
/*    */ final class HumanInLoopImpl$shouldAllowAction$3
/*    */   extends SuspendLambda
/*    */   implements Function2<CoroutineScope, Continuation<? super HumanInLoopResponse>, Object>
/*    */ {
/*    */   int label;
/*    */   
...
/* 79 */     Object object = IntrinsicsKt.getCOROUTINE_SUSPENDED(); switch (this.label) { case 0: ResultKt.throwOnFailure(SYNTHETIC_LOCAL_VARIABLE_1);
/* 80 */         this.label = 1; if (this.$deferredResponse.await((Continuation)this) == object) return object;  return this.$deferredResponse.await((Continuation)this);
/*    */       case 1:
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\ej-243.132.63.jar!\com\intellij\ml\llm\matterhorn\e\\ui\tasks\HumanInLoopImpl$shouldAllowAction$3.class
