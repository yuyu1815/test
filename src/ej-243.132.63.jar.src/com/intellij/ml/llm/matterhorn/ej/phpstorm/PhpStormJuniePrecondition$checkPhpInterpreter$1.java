...
/*    */ 
/*    */ 
/*    */ @DebugMetadata(f = "PhpStormJuniePrecondition.kt", l = {38}, i = {}, s = {}, n = {}, m = "invokeSuspend", c = "com.intellij.ml.llm.matterhorn.ej.phpstorm.PhpStormJuniePrecondition$checkPhpInterpreter$1")
/*    */ @Metadata(mv = {2, 1, 0}, k = 3, xi = 48, d1 = {"\000\006\n\000\n\002\020\013\020\000\032\0020\001H\n"}, d2 = {"<anonymous>", ""})
/*    */ final class PhpStormJuniePrecondition$checkPhpInterpreter$1
/*    */   extends SuspendLambda
/*    */   implements Function1<Continuation<? super Boolean>, Object>
/*    */ {
/*    */   int label;
/*    */   
/*    */   PhpStormJuniePrecondition$checkPhpInterpreter$1(Project $project, Continuation $completion) {
/*    */     super(1, $completion);
/*    */   }
/*    */   
...
/*    */   }
/*    */   
/*    */   public final Continuation<Unit> create(Continuation<? super PhpStormJuniePrecondition$checkPhpInterpreter$1> $completion) {
/*    */     return (Continuation<Unit>)new PhpStormJuniePrecondition$checkPhpInterpreter$1(this.$project, $completion);
/*    */   }
/*    */   
/*    */   public final Object invoke(Continuation<?> p1) {
/*    */     return ((PhpStormJuniePrecondition$checkPhpInterpreter$1)create(p1)).invokeSuspend(Unit.INSTANCE);
/*    */   }
/*    */ }


/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\ej-243.132.63.jar!\com\intellij\ml\llm\matterhorn\ej\phpstorm\PhpStormJuniePrecondition$checkPhpInterpreter$1.class
