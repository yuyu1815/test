...
/*     */ final class TaskChainDetailsViewModel$locateFile$2
...
/*     */     VirtualFile file;
/* 353 */     IntrinsicsKt.getCOROUTINE_SUSPENDED(); switch (this.label) { case 0: ResultKt.throwOnFailure(SYNTHETIC_LOCAL_VARIABLE_1);
/*     */         
/* 355 */         Intrinsics.checkNotNull(ProjectUtil.guessProjectDir(TaskChainDetailsViewModel.this.getProject())); if (VfsUtil.findFile(ProjectUtil.guessProjectDir(TaskChainDetailsViewModel.this.getProject()).toNioPath().resolve(this.$change.getPath()), false) == null) { VfsUtil.findFile(ProjectUtil.guessProjectDir(TaskChainDetailsViewModel.this.getProject()).toNioPath().resolve(this.$change.getPath()), false); return Unit.INSTANCE; }
/* 356 */          FileEditorManager.getInstance(TaskChainDetailsViewModel.this.getProject()).openFile(file, true);
/* 357 */         return Unit.INSTANCE; }
/*     */     
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\ej-243.132.63.jar!\com\intellij\ml\llm\matterhorn\e\\ui\tasks\chain\TaskChainDetailsViewModel$locateFile$2.class
