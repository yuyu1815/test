...
/*     */ final class HeightAutoSizingTextAreaKt$HeightAutoSizingTextArea$1$Decoration$1
/*     */   implements Function2<Composer, Integer, Unit>
/*     */ {
/*     */   @Composable
/*     */   @ComposableTarget(applier = "androidx.compose.ui.UiComposable")
/*     */   public final void invoke(Composer $composer, int $changed) {
/*  87 */     if (($changed & 0x3) != 2 || !$composer.getSkipping()) { if (ComposerKt.isTraceInProgress()) ComposerKt.traceEventStart(98062701, $changed, -1, "com.intellij.ml.llm.matterhorn.ej.ui.components.HeightAutoSizingTextArea.<no name provided>.Decoration.<anonymous> (HeightAutoSizingTextArea.kt:86)");  HeightAutoSizingTextAreaKt.access$TextAreaScrollableContainer(
/*  88 */           this.$scrollState, 
/*  89 */           JewelThemeKt.getScrollbarStyle(JewelTheme.Companion, $composer, 6), 
/*  90 */           PaddingKt.padding-qDBjuR0$default(PaddingKt.padding-3ABfNKs((Modifier)Modifier.Companion, this.$style.getMetrics().getBorderWidth-D9Ej5fM()), 0.0F, 0.0F, this.$innerEndPadding, 0.0F, 11, null), 
/*  91 */           (Function2)ComposableLambdaKt.rememberComposableLambda(-1045344641, true, new Function2<Composer, Integer, Unit>(this.$contentPadding, this.$innerTextField) { @Composable @ComposableTarget(applier = "androidx.compose.ui.UiComposable")
/*  92 */               public final void invoke(Composer $composer, int $changed) { if (($changed & 0x3) != 2 || !$composer.getSkipping()) { if (ComposerKt.isTraceInProgress()) ComposerKt.traceEventStart(-1045344641, $changed, -1, "com.intellij.ml.llm.matterhorn.ej.ui.components.HeightAutoSizingTextArea.<no name provided>.Decoration.<anonymous>.<anonymous> (HeightAutoSizingTextArea.kt:91)");  Modifier modifier1 = PaddingKt.padding((Modifier)Modifier.Companion, this.$contentPadding); Function2<Composer, Integer, Unit> function2 = this.$innerTextField; int $changed$iv = 0, $i$f$Box = 0;
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\ej-243.132.63.jar!\com\intellij\ml\llm\matterhorn\e\\ui\components\HeightAutoSizingTextAreaKt$HeightAutoSizingTextArea$1$Decoration$1.class
