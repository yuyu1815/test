...
/*     */ final class CommandLineStarterProjectContext$setup$2
...
/* 102 */         CommandLineStarterProjectContext.access$clear(CommandLineStarterProjectContext.INSTANCE, this.$project);
...
/*     */ 
/*     */           
/* 381 */           int $i$a$-let-CommandLineStarterProjectContext$setup$2$1 = 0; CommandLineStarterProjectContext.access$addRecentFiles(CommandLineStarterProjectContext.INSTANCE, project1, list3); } else { this.$projectState.getRecentFiles(); }  list1 = this.$projectState.getOpenFiles(); project = this.$project; it = list1; $i$a$-let-CommandLineStarterProjectContext$setup$2$2 = 0;
/*     */         CommandLineStarterProjectContext.access$addOpenFiles(CommandLineStarterProjectContext.INSTANCE, project, it);
/*     */         this.$projectState.getOpenFiles();
/*     */         return (this.$projectState.getOpenFiles() != null) ? Unit.INSTANCE : null; }
/*     */     
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\ej-243.132.63.jar!\com\intellij\ml\llm\matterhorn\starter\CommandLineStarterProjectContext$setup$2.class
