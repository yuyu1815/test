...
/*     */ 
/*     */ @Metadata(mv = {2, 1, 0}, k = 1, xi = 48, d1 = {"\000$\n\002\030\002\n\002\030\002\n\002\030\002\n\002\b\003\n\002\020\002\n\000\n\002\030\002\n\000\n\002\030\002\n\002\b\002\030\000 \0132\0020\0012\0020\002:\001\013B\007¢\006\004\b\003\020\004J\020\020\005\032\0020\0062\006\020\007\032\0020\bH\026J\b\020\t\032\0020\nH\026¨\006\f"}, d2 = {"Lcom/intellij/ml/llm/matterhorn/starter/CollectMatterhornCachesAction;", "Lcom/intellij/openapi/actionSystem/AnAction;", "Lcom/intellij/openapi/project/DumbAware;", "<init>", "()V", "actionPerformed", "", "e", "Lcom/intellij/openapi/actionSystem/AnActionEvent;", "getActionUpdateThread", "Lcom/intellij/openapi/actionSystem/ActionUpdateThread;", "Companion", "matterhorn"})
/*     */ @SourceDebugExtension({"SMAP\nMatterhornLogsProcessor.kt\nKotlin\n*S Kotlin\n*F\n+ 1 MatterhornLogsProcessor.kt\ncom/intellij/ml/llm/matterhorn/starter/CollectMatterhornCachesAction\n+ 2 services.kt\ncom/intellij/openapi/components/ServicesKt\n+ 3 logger.kt\ncom/intellij/openapi/diagnostic/LoggerKt\n*L\n1#1,150:1\n31#2,2:151\n14#3:153\n*S KotlinDebug\n*F\n+ 1 MatterhornLogsProcessor.kt\ncom/intellij/ml/llm/matterhorn/starter/CollectMatterhornCachesAction\n*L\n44#1:151,2\n78#1:153\n*E\n"})
/*     */ public final class CollectMatterhornCachesAction extends AnAction implements DumbAware {
/*     */   @NotNull
/*     */   public static final Companion Companion = new Companion(null);
/*     */   
/*     */   public void actionPerformed(@NotNull AnActionEvent e) {
/*  43 */     Intrinsics.checkNotNullParameter(e, "e"); Project project = e.getProject();
/*  44 */     if (project != null) { ComponentManager $this$service$iv = (ComponentManager)project; int $i$f$service = 0;
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */       
/* 151 */       Class<ArtifactRequestExecutorService> serviceClass$iv = ArtifactRequestExecutorService.class;
/* 152 */       if ($this$service$iv.getService(serviceClass$iv) == null) { $this$service$iv.getService(serviceClass$iv); throw ServicesKt.serviceNotFoundError($this$service$iv, serviceClass$iv); }  if ((ArtifactRequestExecutorService)$this$service$iv.getService(serviceClass$iv) != null) { ArtifactRequestExecutorService service; boolean doNotShowDialog = PropertiesComponent.getInstance().getBoolean("matterhorn.caches.action.show.confirmation.dialog"); if (!doNotShowDialog) { String title = "Sensitive Data"; String message = "Matterhorn logs contain sensitive data."; Intrinsics.checkNotNullExpressionValue(CommonBundle.getCancelButtonText(), "getCancelButtonText(...)"); boolean confirmed = ((OkCancelDialogBuilder)((OkCancelDialogBuilder)((OkCancelDialogBuilder)((OkCancelDialogBuilder)MessageDialogBuilder.Companion.okCancel(title, message).yesText("Show in " + RevealFileAction.getFileManagerName())).noText(CommonBundle.getCancelButtonText())).icon(Messages.getWarningIcon())).doNotAsk((DoNotAskOption)new CollectMatterhornCachesAction$actionPerformed$confirmed$1())).ask(project); if (!confirmed)
/* 153 */             return;  }  try { Intrinsics.checkNotNullExpressionValue(ModalTaskOwner.project(project), "project(...)"); Path logs = (Path)TasksKt.runWithModalProgressBlocking$default(ModalTaskOwner.project(project), "Collecting Matterhorn Logs", null, new CollectMatterhornCachesAction$actionPerformed$logs$1(project, service, null), 4, null); if (RevealFileAction.isSupported()) { RevealFileAction.openFile(logs); } else { (new Notification("Collect Zipped Logs", "Log file is created: " + logs, NotificationType.INFORMATION)).notify(project); }  } catch (IOException iOException) { int $i$f$logger = 0; Intrinsics.checkNotNullExpressionValue(Logger.getInstance(CollectMatterhornCachesAction.class), "getInstance(...)"); Logger.getInstance(CollectMatterhornCachesAction.class).warn(iOException);
/*     */           String message = "Cannot create .zip file with logs: " + IoErrorText.message(iOException);
/*     */           (new Notification("Collect Zipped Logs", message, NotificationType.ERROR)).notify(project); }
/*     */         
/*     */         return; }
/*     */        }
/*     */   
...
/*     */   
/*     */   @NotNull
/*     */   private static final String CONFIRMATION_DIALOG = "matterhorn.caches.action.show.confirmation.dialog";
/*     */   @NotNull
...
/*     */   public static final class CollectMatterhornCachesAction$actionPerformed$confirmed$1 extends DoNotAskOption.Adapter {
/*     */     public void rememberChoice(boolean selected, int exitCode) {
/*     */       PropertiesComponent.getInstance().setValue("matterhorn.caches.action.show.confirmation.dialog", selected);
/*     */     }
/*     */   }
/*     */   
...
/*     */   static final class CollectMatterhornCachesAction$actionPerformed$logs$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Path>, Object> {
/*     */     int label;
/*     */     
...
/*     */           this.label = 1;
/*     */           if (CollectMatterhornCachesAction.Companion.packMatterhornLogs(this.$project, this.$service.getCaches(), (Continuation<? super Path>)this) == object)
/*     */             return object; 
/*     */           return CollectMatterhornCachesAction.Companion.packMatterhornLogs(this.$project, this.$service.getCaches(), (Continuation<? super Path>)this);
/*     */         case 1:
/*     */           ResultKt.throwOnFailure(SYNTHETIC_LOCAL_VARIABLE_1);
...
/*     */     static final class CollectMatterhornCachesAction$Companion$packMatterhornLogs$1 extends ContinuationImpl {
/*     */       int label;
/*     */       
...
/*     */     static final class CollectMatterhornCachesAction$Companion$packMatterhornLogs$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Path>, Object> {
/*     */       int label;
/*     */       
...
/*     */             try {
/*     */               Closeable closeable = (Closeable)new Compressor.Zip(this.$archive);
/*     */               MatterhornCaches matterhornCaches = this.$caches;
/*     */               Project project = this.$project;
/*     */               Throwable throwable = null;
/*     */               try {
/*     */                 Compressor.Zip zip = (Compressor.Zip)closeable;
/*     */                 int $i$a$-use-CollectMatterhornCachesAction$Companion$packMatterhornLogs$2$1 = 0;
/*     */                 JobKt.ensureActive($this$withContext.getCoroutineContext());
/*     */                 matterhornCaches.dumpToZip(zip);
/*     */                 CollectMatterhornCachesAction.Companion.packIdeaLogs(zip, project);
...
/*     */               } catch (IOException x) {
/*     */                 ExceptionsKt.addSuppressed(e, x);
/*     */               } 
/*     */               throw e;
/*     */             } 
/*     */             return this.$archive;
...
/*     */       Iterator iterator;
/*     */       if ((LogProvider)CollectionsKt.firstOrNull(LogProvider.Companion.getEP().getExtensionList()) != null) {
/*     */         LogProvider logProvider = (LogProvider)CollectionsKt.firstOrNull(LogProvider.Companion.getEP().getExtensionList());
/*     */         int $i$a$-let-CollectMatterhornCachesAction$Companion$packIdeaLogs$1 = 0;
/*     */         Iterable $this$forEach$iv = logProvider.getAdditionalLogFiles(project);
/*     */         int $i$f$forEach = 0;
/*     */         iterator = $this$forEach$iv.iterator();
/*     */       } else {
/*     */         (LogProvider)CollectionsKt.firstOrNull(LogProvider.Companion.getEP().getExtensionList());
/*     */         return;
/*     */       } 
/*     */       if (iterator.hasNext()) {
/*     */         Object element$iv = iterator.next();
/*     */         LogProvider.LogsEntry entry = (LogProvider.LogsEntry)element$iv;
/*     */         int $i$a$-forEach-CollectMatterhornCachesAction$Companion$packIdeaLogs$1$1 = 0;
/*     */         Iterator iterator1 = entry.getFiles().iterator();
/*     */       } 
/*     */     }
/*     */     
/*     */     private static final boolean packIdeaLogs$lambda$4$lambda$3$lambda$0(String param1String, Path file) {
...
/* Location:              C:\Users\yuzum\Downloads\ej-release-243.132.63.zip!\ej\lib\ej-243.132.63.jar!\com\intellij\ml\llm\matterhorn\starter\CollectMatterhornCachesAction.class
